...
func (response *HuggingFaceListModelsResponse) ToDeepIntShieldListModelsResponse(providerKey schemas.ModelProvider, inferenceProvider inferenceProvider, allowedModels []string, unfiltered bool) *schemas.DeepIntShieldListModelsResponse {
	if response == nil {
		return nil
	}
	...
	for _, model := range response.Models {
		...
		deepintshieldResponse.Data = append(deepintshieldResponse.Data, newModel)
