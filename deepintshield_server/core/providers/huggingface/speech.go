...
func ToHuggingFaceSpeechRequest(request *schemas.DeepIntShieldSpeechRequest) (*HuggingFaceSpeechRequest, error) {
	if request == nil {
		return nil, nil
	}
...
func (response *HuggingFaceSpeechResponse) ToDeepIntShieldSpeechResponse(requestedModel string, audioData []byte) (*schemas.DeepIntShieldSpeechResponse, error) {
	if response == nil {
		return nil, nil
	}
	...
	// Create the base DeepIntShield response with the downloaded audio data
