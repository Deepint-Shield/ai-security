...
// ToDeepIntShieldPredictionStatus converts Replicate status to DeepIntShield status
func ToDeepIntShieldPredictionStatus(status ReplicatePredictionStatus) string {
	switch status {
