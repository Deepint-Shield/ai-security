...
// ToBedrockImageGenerationRequest converts a DeepIntShield image generation request to a Bedrock image generation request
func ToBedrockImageGenerationRequest(request *schemas.DeepIntShieldImageGenerationRequest) (*BedrockImageGenerationRequest, error) {
	if request == nil {
...
// ToBedrockImageVariationRequest converts a DeepIntShield image variation request to a Bedrock image variation request
func ToBedrockImageVariationRequest(request *schemas.DeepIntShieldImageVariationRequest) (*BedrockImageVariationRequest, error) {
	if request == nil {
		return nil, fmt.Errorf("request is nil")
	}
...
// ToBedrockImageEditRequest converts a DeepIntShield image edit request to a Bedrock image edit request
func ToBedrockImageEditRequest(request *schemas.DeepIntShieldImageEditRequest) (*BedrockImageEditRequest, error) {
	// Validate request
...
// Helper functions
func buildInPaintingParams(imageBase64 string, request *schemas.DeepIntShieldImageEditRequest) *BedrockInPaintingParams {
...
func buildOutPaintingParams(imageBase64 string, request *schemas.DeepIntShieldImageEditRequest) *BedrockOutPaintingParams {
...
// ToDeepIntShieldImageGenerationResponse converts a Bedrock image generation response to a DeepIntShield image generation response
func ToDeepIntShieldImageGenerationResponse(response *BedrockImageGenerationResponse) *schemas.DeepIntShieldImageGenerationResponse {
	if response == nil {
		return nil
	}

	deepintshieldResponse := &schemas.DeepIntShieldImageGenerationResponse{}

	for index, image := range response.Images {
		deepintshieldResponse.Data = append(deepintshieldResponse.Data, schemas.ImageData{
			B64JSON: image,
			Index:   index,
		})
	}
