...
// ToBedrockFileUploadResponse converts a DeepIntShield file upload response to Bedrock format.
func ToBedrockFileUploadResponse(resp *schemas.DeepIntShieldFileUploadResponse) *BedrockFileUploadResponse {
	if resp == nil {
		return nil
	}
...
// ToBedrockFileListResponse converts a DeepIntShield file list response to Bedrock format.
func ToBedrockFileListResponse(resp *schemas.DeepIntShieldFileListResponse) *BedrockFileListResponse {
	if resp == nil {
		return nil
	}
...
// ToBedrockFileRetrieveResponse converts a DeepIntShield file retrieve response to Bedrock format.
func ToBedrockFileRetrieveResponse(resp *schemas.DeepIntShieldFileRetrieveResponse) *BedrockFileRetrieveResponse {
	if resp == nil {
		return nil
	}
...
// ToBedrockFileDeleteResponse converts a DeepIntShield file delete response to Bedrock format.
func ToBedrockFileDeleteResponse(resp *schemas.DeepIntShieldFileDeleteResponse) *BedrockFileDeleteResponse {
	if resp == nil {
		return nil
	}
...
// ToBedrockFileContentResponse converts a DeepIntShield file content response to Bedrock format.
func ToBedrockFileContentResponse(resp *schemas.DeepIntShieldFileContentResponse) *BedrockFileContentResponse {
	if resp == nil {
		return nil
	}
...
// ToS3ListObjectsV2XML converts a DeepIntShield file list response to S3 ListObjectsV2 XML format.
func ToS3ListObjectsV2XML(resp *schemas.DeepIntShieldFileListResponse, bucket, prefix string, maxKeys int) []byte {
	if resp == nil {
