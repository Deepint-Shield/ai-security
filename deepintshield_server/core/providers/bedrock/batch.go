...
// ToDeepIntShieldBatchStatus converts Bedrock status to DeepIntShield status.
...
// parseBatchResultsJSONL parses JSONL content from Bedrock batch output into DeepIntShield format.
...
func parseBatchResultsJSONL(content []byte, provider *BedrockProvider) ([]schemas.BatchResultItem, []schemas.BatchError) {
	...
	parseResult := providerUtils.ParseJSONL(content, func(line []byte) error {
		...
		// Convert Bedrock format to DeepIntShield format
...
// ToBedrockBatchJobResponse converts a DeepIntShield batch create response to Bedrock format.
func ToBedrockBatchJobResponse(resp *schemas.DeepIntShieldBatchCreateResponse) *BedrockBatchJobResponse {
...
// ToBedrockBatchJobListResponse converts a DeepIntShield batch list response to Bedrock format.
func ToBedrockBatchJobListResponse(resp *schemas.DeepIntShieldBatchListResponse) *BedrockBatchJobListResponse {
...
// ToBedrockBatchJobRetrieveResponse converts a DeepIntShield batch retrieve response to Bedrock format.
func ToBedrockBatchJobRetrieveResponse(resp *schemas.DeepIntShieldBatchRetrieveResponse) *BedrockBatchJobResponse {
	result := &BedrockBatchJobResponse{
		JobArn: resp.ID,
		Status: toBedrockBatchStatus(resp.Status),
	}
...
// toBedrockBatchStatus converts DeepIntShield batch status to Bedrock status.
...
// ToDeepIntShieldBatchListRequest converts a Bedrock batch list request to DeepIntShield format.
func ToDeepIntShieldBatchListRequest(req *BedrockBatchListRequest, provider schemas.ModelProvider) *schemas.DeepIntShieldBatchListRequest {
	result := &schemas.DeepIntShieldBatchListRequest{
		Provider: provider,
...
// ToDeepIntShieldBatchRetrieveRequest converts a Bedrock batch retrieve request to DeepIntShield format.
func ToDeepIntShieldBatchRetrieveRequest(req *BedrockBatchRetrieveRequest, provider schemas.ModelProvider) *schemas.DeepIntShieldBatchRetrieveRequest {
...
// ToDeepIntShieldBatchCancelRequest converts a Bedrock batch cancel request to DeepIntShield format.
func ToDeepIntShieldBatchCancelRequest(req *BedrockBatchCancelRequest, provider schemas.ModelProvider) *schemas.DeepIntShieldBatchCancelRequest {
...
// ToBedrockBatchCancelResponse converts a DeepIntShield batch cancel response to Bedrock format.
func ToBedrockBatchCancelResponse(resp *schemas.DeepIntShieldBatchCancelResponse) *BedrockBatchCancelResponse {
