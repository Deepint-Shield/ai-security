...
func TestToBedrockRerankRequest(t *testing.T) {
	...
	req, err := ToBedrockRerankRequest(&schemas.DeepIntShieldRerankRequest{
...
func TestBedrockRerankResponseToDeepIntShieldRerankResponse(t *testing.T) {
	...
	}).ToDeepIntShieldRerankResponse(nil, false)
...
func TestBedrockRerankResponseToDeepIntShieldRerankResponseReturnDocuments(t *testing.T) {
	...
	}).ToDeepIntShieldRerankResponse(requestDocs, true)
...
func TestBedrockRerankRequestToDeepIntShieldRerankRequest(t *testing.T) {
	topN := 3
	...
	result := bedrockReq.ToDeepIntShieldRerankRequest(deepintshieldCtx)
...
func TestBedrockRerankRequestToDeepIntShieldRerankRequestNil(t *testing.T) {
	var req *BedrockRerankRequest
	assert.Nil(t, req.ToDeepIntShieldRerankRequest(nil))
}
...
func TestBedrockRerankRequiresARNModelIdentifier(t *testing.T) {
	...
	response, deepintshieldErr := provider.Rerank(ctx, key, &schemas.DeepIntShieldRerankRequest{
		Model: "cohere-rerank",
		Query: "capital of france",
		Documents: []schemas.RerankDocument{
			{Text: "Paris is the capital of France."},
	...
	require.NotNil(t, deepintshieldErr)
	require.NotNil(t, deepintshieldErr.Error)
	assert.Contains(t, deepintshieldErr.Error.Message, "requires an ARN")
}
