...
func TestToVertexRankRequest(t *testing.T) {
	...
	req, err := ToVertexRankRequest(
		&schemas.DeepIntShieldRerankRequest{
...
func TestVertexRankResponseToDeepIntShieldRerankResponse(t *testing.T) {
	t.Parallel()
	...
	}).ToDeepIntShieldRerankResponse(docs, true)
	require.NoError(t, err)
...
func TestVertexRankRequestToDeepIntShieldRerankRequest(t *testing.T) {
	t.Parallel()
	...
	result := req.ToDeepIntShieldRerankRequest(deepintshieldCtx)
...
func TestVertexRankRequestToDeepIntShieldRerankRequestNil(t *testing.T) {
	t.Parallel()
...
func TestVertexRankResponseToDeepIntShieldRerankResponseInvalidID(t *testing.T) {
	t.Parallel()
	...
	}).ToDeepIntShieldRerankResponse([]schemas.RerankDocument{{Text: "doc"}}, false)
	require.Error(t, err)
