...
func (response *AzureListModelsResponse) ToDeepIntShieldListModelsResponse(allowedModels []string, deployments map[string]string, unfiltered bool) *schemas.DeepIntShieldListModelsResponse {
	if response == nil {
		return nil
	}
