...
func getRequestBodyForAnthropicResponses(ctx *schemas.DeepIntShieldContext, request *schemas.DeepIntShieldResponsesRequest, deployment string, providerName schemas.ModelProvider, isStreaming bool) ([]byte, *schemas.DeepIntShieldError) {
