...
func TestRerankToVLLMRerankRequest(t *testing.T) {
	...
	req := ToVLLMRerankRequest(&schemas.DeepIntShieldRerankRequest{
...
func TestRerankToDeepIntShieldRerankResponse(t *testing.T) {
	documents := []schemas.RerankDocument{
		{Text: "doc-0"},
		{Text: "doc-1"},
		{Text: "doc-2"},
	...
	response, err := ToDeepIntShieldRerankResponse(map[string]interface{}{
		"id":    "rerank-id",
		"model": "BAAI/bge-reranker-v2-m3",
...
func TestRerankToDeepIntShieldRerankResponseDuplicateIndices(t *testing.T) {
	documents := []schemas.RerankDocument{
		{Text: "doc-0"},
		{Text: "doc-1"},
	}

	_, err := ToDeepIntShieldRerankResponse(map[string]interface{}{
		"results": []interface{}{
			map[string]interface{}{"index": 0, "relevance_score": 0.9},
...
func TestRerankToDeepIntShieldRerankResponseOutOfRangeIndex(t *testing.T) {
	documents := []schemas.RerankDocument{
		{Text: "doc-0"},
	}
...
func TestRerankToDeepIntShieldRerankResponseEmptyResults(t *testing.T) {
	documents := []schemas.RerankDocument{
		{Text: "doc-0"},
	}
...
func TestRerankToDeepIntShieldRerankResponseZeroRelevanceScoreDoesNotFallback(t *testing.T) {
	documents := []schemas.RerankDocument{
		{Text: "doc-0"},
	}
