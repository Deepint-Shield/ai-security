...
// a DeepIntShieldTranscriptionStreamResponse. It returns (nil, false) if the payload is not
// valid vLLM format or has no content to emit.
func parseVLLMTranscriptionStreamChunk(jsonData []byte) (*schemas.DeepIntShieldTranscriptionStreamResponse, bool) {
	...
	if chunk.Usage != nil {
		return &schemas.DeepIntShieldTranscriptionStreamResponse{
