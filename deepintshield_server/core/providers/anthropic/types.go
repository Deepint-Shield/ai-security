...
type AnthropicTextRequest struct {
	...
	// DeepIntShield specific field (only parsed when converting from Provider -> DeepIntShield request)
...
// ToDeepIntShieldFileUploadResponse converts an Anthropic file response to DeepIntShield file upload response.
func (r *AnthropicFileResponse) ToDeepIntShieldFileUploadResponse(providerName schemas.ModelProvider, latency time.Duration, sendBackRawRequest bool, sendBackRawResponse bool, rawRequest interface{}, rawResponse interface{}) *schemas.DeepIntShieldFileUploadResponse {
...
// ToDeepIntShieldFileRetrieveResponse converts an Anthropic file response to DeepIntShield file retrieve response.
func (r *AnthropicFileResponse) ToDeepIntShieldFileRetrieveResponse(providerName schemas.ModelProvider, latency time.Duration, sendBackRawRequest bool, sendBackRawResponse bool, rawRequest interface{}, rawResponse interface{}) *schemas.DeepIntShieldFileRetrieveResponse {
