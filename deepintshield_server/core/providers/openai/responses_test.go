...
func TestToOpenAIResponsesRequest_ReasoningOnlyMessageSkip(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := ToOpenAIResponsesRequest(deepintshieldReq)
...
func TestToOpenAIResponsesRequest_ToolNormalization(t *testing.T) {
	...
	origParams := deepintshieldReq.Params.Tools[0].ResponsesToolFunction.Parameters
	...
	if funcTool.ResponsesToolFunction == deepintshieldReq.Params.Tools[0].ResponsesToolFunction {
