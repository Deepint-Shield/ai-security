...
var (
	...
	cohereFinishReasonToDeepIntShield = map[CohereFinishReason]string{
...
// ConvertCohereFinishReasonToDeepIntShield converts provider finish reasons to DeepIntShield format
func ConvertCohereFinishReasonToDeepIntShield(providerReason CohereFinishReason) string {
	if deepintshieldReason, ok := cohereFinishReasonToDeepIntShield[providerReason]; ok {
...
// This handles the conversion from Cohere's flexible parameter format to DeepIntShield's structured format
...
// convertCohereResponseFormatToDeepIntShield converts Cohere's typed response_format back to interface{}
func convertCohereResponseFormatToDeepIntShield(cohereFormat *CohereResponseFormat) *interface{} {
	if cohereFormat == nil {
		return nil
	}
