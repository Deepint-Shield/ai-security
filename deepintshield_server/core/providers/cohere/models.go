...
func (response *CohereListModelsResponse) ToDeepIntShieldListModelsResponse(providerKey schemas.ModelProvider, allowedModels []string, unfiltered bool) *schemas.DeepIntShieldListModelsResponse {
	if response == nil {
		return nil
	}
