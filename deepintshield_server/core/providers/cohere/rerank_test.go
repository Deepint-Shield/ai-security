...
func TestCohereRerankResponseToDeepIntShieldRerankResponse(t *testing.T) {
...
func TestCohereRerankResponseToDeepIntShieldRerankResponseReturnDocuments(t *testing.T) {
