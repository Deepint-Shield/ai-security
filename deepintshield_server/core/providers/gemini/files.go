...
// ToDeepIntShieldFileStatus converts Gemini file state to DeepIntShield status.
func ToDeepIntShieldFileStatus(state string) schemas.FileStatus {
	switch state {
	case "PROCESSING":
...
// ToGeminiFileListResponse converts a DeepIntShield file list response to Gemini format.
func ToGeminiFileListResponse(resp *schemas.DeepIntShieldFileListResponse) *GeminiFileListResponse {
...
// ToGeminiFileRetrieveResponse converts a DeepIntShield file retrieve response to Gemini format.
func ToGeminiFileRetrieveResponse(resp *schemas.DeepIntShieldFileRetrieveResponse) *GeminiFileResponse {
...
// toGeminiFileState converts DeepIntShield file status to Gemini state.
...
// ToGeminiFileUploadResponse converts a DeepIntShield file upload response to Gemini format.
func ToGeminiFileUploadResponse(resp *schemas.DeepIntShieldFileUploadResponse) map[string]interface{} {
