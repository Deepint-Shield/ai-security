...
func (response *GeminiListModelsResponse) ToDeepIntShieldListModelsResponse(providerKey schemas.ModelProvider, allowedModels []string, unfiltered bool) *schemas.DeepIntShieldListModelsResponse {
	if response == nil {
		return nil
	}
...
func ToGeminiListModelsResponse(resp *schemas.DeepIntShieldListModelsResponse) *GeminiListModelsResponse {
	if resp == nil {
		return nil
	}
