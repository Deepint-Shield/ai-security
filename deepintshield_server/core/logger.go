...
// It is used as the default logger if no logger is provided in the DeepIntShieldConfig.
type DefaultLogger struct {
	stderrLogger zerolog.Logger
	stdoutLogger zerolog.Logger
}

// toZerologLevel converts a DeepIntShield log level to a Zerolog level.
