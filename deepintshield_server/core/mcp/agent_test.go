...
// MockLLMCaller implements schemas.DeepIntShieldLLMCaller for testing
type MockLLMCaller struct {
	chatResponses      []*schemas.DeepIntShieldChatResponse
	responsesResponses []*schemas.DeepIntShieldResponsesResponse
	chatCallCount      int
	responsesCallCount int
}

func (m *MockLLMCaller) ChatCompletionRequest(ctx context.Context, req *schemas.DeepIntShieldChatRequest) (*schemas.DeepIntShieldChatResponse, *schemas.DeepIntShieldError) {
...
func (m *MockLLMCaller) ResponsesRequest(ctx context.Context, req *schemas.DeepIntShieldResponsesRequest) (*schemas.DeepIntShieldResponsesResponse, *schemas.DeepIntShieldError) {
...
func TestHasToolCallsForChatResponse(t *testing.T) {
	...
	// Test empty choices
	emptyResponse := &schemas.DeepIntShieldChatResponse{
	...
	toolCallsResponse := &schemas.DeepIntShieldChatResponse{
		Choices: []schemas.DeepIntShieldResponseChoice{
			{
	...
	responseWithToolCalls := &schemas.DeepIntShieldChatResponse{
		Choices: []schemas.DeepIntShieldResponseChoice{
			{
	...
	responseWithStopReason := &schemas.DeepIntShieldChatResponse{
		Choices: []schemas.DeepIntShieldResponseChoice{
			{
	...
	responseWithStopNoTools := &schemas.DeepIntShieldChatResponse{
		Choices: []schemas.DeepIntShieldResponseChoice{
			{
				FinishReason: schemas.Ptr("stop"),
				ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
	...
	// ToDeepIntShieldChatResponse() splits text and tool calls across separate choices when a model
	// returns both text content and tool calls (e.g. Claude via the /v1/responses endpoint).
	responseWithToolCallsInSecondChoice := &schemas.DeepIntShieldChatResponse{
		Choices: []schemas.DeepIntShieldResponseChoice{
			{
...
func TestExtractToolCalls(t *testing.T) {
	...
	responseNoTools := &schemas.DeepIntShieldChatResponse{
		Choices: []schemas.DeepIntShieldResponseChoice{
			{
				FinishReason: schemas.Ptr("stop"),
			},
	...
	responseWithTools := &schemas.DeepIntShieldChatResponse{
		Choices: []schemas.DeepIntShieldResponseChoice{
			{
				ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
					Message: &schemas.ChatMessage{
...
func TestExecuteAgentForChatRequest_WithNonAutoExecutableTools(t *testing.T) {
	...
	responseWithNonAutoTools := &schemas.DeepIntShieldChatResponse{
		Choices: []schemas.DeepIntShieldResponseChoice{
			{
				FinishReason: schemas.Ptr("tool_calls"),
				ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
...
func TestHasToolCallsForResponsesResponse(t *testing.T) {
	...
	// Test empty output
	emptyResponse := &schemas.DeepIntShieldResponsesResponse{
	...
	responseWithFunctionCall := &schemas.DeepIntShieldResponsesResponse{
		Output: []schemas.ResponsesMessage{
			{
	...
	responseWithoutToolMessage := &schemas.DeepIntShieldResponsesResponse{
		Output: []schemas.ResponsesMessage{
			{
				Type: schemas.Ptr(schemas.ResponsesMessageTypeFunctionCall),
	...
	responseWithRegularMessage := &schemas.DeepIntShieldResponsesResponse{
		Output: []schemas.ResponsesMessage{
			{
...
func TestExecuteAgentForResponsesRequest(t *testing.T) {
	...
	// Test with response that has no tool calls - should return immediately
	responseNoTools := &schemas.DeepIntShieldResponsesResponse{
		Output: []schemas.ResponsesMessage{
			{
				Type: schemas.Ptr(schemas.ResponsesMessageTypeMessage),
...
func TestExecuteAgentForResponsesRequest_WithNonAutoExecutableTools(t *testing.T) {
	...
	// Create a response with tool calls that will NOT be auto-executed
	responseWithNonAutoTools := &schemas.DeepIntShieldResponsesResponse{
		Output: []schemas.ResponsesMessage{
			{
				Type: schemas.Ptr(schemas.ResponsesMessageTypeFunctionCall),
				Role: schemas.Ptr(schemas.ResponsesInputMessageRoleAssistant),
