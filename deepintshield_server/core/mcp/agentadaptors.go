...
type agentAPIAdapter interface {
	...
	// Make LLM call
	makeLLMCall(ctx *schemas.DeepIntShieldContext, request interface{}) (interface{}, *schemas.DeepIntShieldError)
...
//     via DeepIntShieldResponsesResponse.ToDeepIntShieldChatResponse() and existing extraction logic
...
//   - createNewRequest(): Builds a new DeepIntShieldResponsesRequest from converted conversation
...
func (c *chatAPIAdapter) hasToolCalls(response interface{}) bool {
	chatResponse := response.(*schemas.DeepIntShieldChatResponse)
...
func (c *chatAPIAdapter) createNewRequest(conversation []interface{}) interface{} {
	...
	return &schemas.DeepIntShieldChatRequest{
...
func (c *chatAPIAdapter) makeLLMCall(ctx *schemas.DeepIntShieldContext, request interface{}) (interface{}, *schemas.DeepIntShieldError) {
	chatRequest := request.(*schemas.DeepIntShieldChatRequest)
...
//
// Returns:
//   - *schemas.DeepIntShieldChatResponse: A new chat response with executed results and pending tool calls
func createChatResponseWithExecutedToolsAndNonAutoExecutableCalls(
	originalResponse *schemas.DeepIntShieldChatResponse,
	executedToolResults []*schemas.ChatMessage,
	executedToolCalls []schemas.ChatAssistantMessageToolCall,
	nonAutoExecutableToolCalls []schemas.ChatAssistantMessageToolCall,
	...
	response := &schemas.DeepIntShieldChatResponse{
		...
		Choices:           make([]schemas.DeepIntShieldResponseChoice, 0),
	...
	response.Choices = append(response.Choices, schemas.DeepIntShieldResponseChoice{
		Index:        0,
...
func (r *responsesAPIAdapter) hasToolCalls(response interface{}) bool {
	responsesResponse := response.(*schemas.DeepIntShieldResponsesResponse)
...
func (r *responsesAPIAdapter) extractToolCalls(response interface{}) []schemas.ChatAssistantMessageToolCall {
	...
	chatResponse := responsesResponse.ToDeepIntShieldChatResponse()
	return extractToolCalls(chatResponse)
}
...
func (r *responsesAPIAdapter) makeLLMCall(ctx *schemas.DeepIntShieldContext, request interface{}) (interface{}, *schemas.DeepIntShieldError) {
	responsesRequest := request.(*schemas.DeepIntShieldResponsesRequest)
...
//
// Returns:
//   - *schemas.DeepIntShieldResponsesResponse: A new responses response with executed results and pending tool calls
func createResponsesResponseWithExecutedToolsAndNonAutoExecutableCalls(
	originalResponse *schemas.DeepIntShieldResponsesResponse,
	executedToolResults []*schemas.ChatMessage,
	executedToolCalls []schemas.ChatAssistantMessageToolCall,
	nonAutoExecutableToolCalls []schemas.ChatAssistantMessageToolCall,
) *schemas.DeepIntShieldResponsesResponse {
