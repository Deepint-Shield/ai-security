...
type Key struct {
	ID                   string                `json:"id"`                               // The unique identifier for the key (used by deepintshield to identify the key)
	Name                 string                `json:"name"`                             // The name of the key (used by users to identify the key, not used by deepintshield)
	...
	UseForCache          *bool                 `json:"use_for_cache,omitempty"`          // Whether this key can participate in semantic cache reads/writes (default:true)
...
type Account interface {
	...
	// The context can carry data from any source that sets values before the DeepIntShield request,
