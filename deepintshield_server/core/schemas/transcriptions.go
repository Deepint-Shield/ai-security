...
type DeepIntShieldTranscriptionRequest struct {
...
func (r *DeepIntShieldTranscriptionRequest) GetRawRequestBody() []byte {
	return r.RawRequestBody
}

type DeepIntShieldTranscriptionResponse struct {
...
// DeepIntShieldTranscriptionStreamResponse represents streaming specific fields only
type DeepIntShieldTranscriptionStreamResponse struct {
