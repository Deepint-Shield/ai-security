...
// DeepIntShieldImageGenerationRequest represents an image generation request in deepintshield format
type DeepIntShieldImageGenerationRequest struct {
...
func (b *DeepIntShieldImageGenerationRequest) GetRawRequestBody() []byte {
...
// DeepIntShieldImageGenerationResponse represents the image generation response in deepintshield format
type DeepIntShieldImageGenerationResponse struct {
	...
	*ImageGenerationResponseParameters
	...
	ExtraFields DeepIntShieldResponseExtraFields `json:"extra_fields,omitempty"`
}
...
func (r *DeepIntShieldImageGenerationResponse) BackfillParams(req *DeepIntShieldRequest) {
...
func getNumInputImagesSizeAndQualityFromRequest(req *DeepIntShieldRequest) (numInputImages int, size string, quality string) {
	if req == nil {
		return 0, "", ""
	}
...
type ImageUsage struct {
	...
	NumInputImages      int                `json:"num_input_images,omitempty"` // Number of input images from the request (populated by DeepIntShield)
}

type ImageTokenDetails struct {
	NImages     int `json:"-"` // Number of images generated (used internally for deepintshield)
	ImageTokens int `json:"image_tokens,omitempty"`
	TextTokens  int `json:"text_tokens,omitempty"`
}

// Streaming Response
type DeepIntShieldImageGenerationStreamResponse struct {
	ID                string                     `json:"id,omitempty"`
	...
	RevisedPrompt     string                     `json:"revised_prompt,omitempty"`
	Usage             *ImageUsage                `json:"usage,omitempty"`
	Error             *DeepIntShieldError              `json:"error,omitempty"`
...
// - Size on ImageGenerationResponseParameters (from request params if not in response)
// - Quality (low, medium, high, auto) only
func (r *DeepIntShieldImageGenerationStreamResponse) BackfillParams(req *DeepIntShieldRequest) {
	numInputImages, size, quality := getNumInputImagesSizeAndQualityFromRequest(req)
...
// DeepIntShieldImageEditRequest represents an image edit request in deepintshield format
type DeepIntShieldImageEditRequest struct {
	Provider       ModelProvider        `json:"provider"`
	Model          string               `json:"model"`
...
// GetRawRequestBody implements [utils.RequestBodyGetter].
func (b *DeepIntShieldImageEditRequest) GetRawRequestBody() []byte {
	return b.RawRequestBody
}
...
// DeepIntShieldImageVariationRequest represents an image variation request in deepintshield format
type DeepIntShieldImageVariationRequest struct {
	Provider       ModelProvider             `json:"provider"`
	Model          string                    `json:"model"`
...
// GetRawRequestBody implements [utils.RequestBodyGetter].
func (b *DeepIntShieldImageVariationRequest) GetRawRequestBody() []byte {
	return b.RawRequestBody
}
...
// DeepIntShieldImageVariationResponse represents the image variation response in deepintshield format
// It uses the same structure as image generation response
type DeepIntShieldImageVariationResponse = DeepIntShieldImageGenerationResponse
