...
// DeepIntShieldTextCompletionRequest is the request struct for text completion requests
type DeepIntShieldTextCompletionRequest struct {
...
func (r *DeepIntShieldTextCompletionRequest) GetRawRequestBody() []byte {
	return r.RawRequestBody
}

// ToDeepIntShieldChatRequest converts a DeepIntShield text completion request to a DeepIntShield chat completion request
// This method is discouraged to use, but is useful for litellm fallback flows
func (r *DeepIntShieldTextCompletionRequest) ToDeepIntShieldChatRequest() *DeepIntShieldChatRequest {
...
type DeepIntShieldTextCompletionResponse struct {
	ID                string                     `json:"id"`
