...
type DeepIntShieldVideoGenerationRequest struct {
...
func (b *DeepIntShieldVideoGenerationRequest) GetRawRequestBody() []byte {
	return b.RawRequestBody
}

func (b *DeepIntShieldVideoGenerationRequest) GetExtraParams() map[string]interface{} {
...
// DeepIntShieldVideoGenerationResponse represents the video generation job response in deepintshield format.
type DeepIntShieldVideoGenerationResponse struct {
...
func getSecondsFromVideoRequest(req *DeepIntShieldRequest) *string {
	if req == nil {
		return nil
	}
...
func (r *DeepIntShieldVideoGenerationResponse) BackfillParams(req *DeepIntShieldRequest) {
	if r == nil || req == nil {
		return
	}
...
type DeepIntShieldVideoRemixRequest struct {
	ID             string                `json:"id"`
	Provider       ModelProvider         `json:"provider"`
	Input          *VideoGenerationInput `json:"input"`
	ExtraParams    map[string]any        `json:"-"`
...
func (b *DeepIntShieldVideoRemixRequest) GetRawRequestBody() []byte {
	return b.RawRequestBody
}

func (b *DeepIntShieldVideoRemixRequest) GetExtraParams() map[string]interface{} {
	if b == nil {
		return nil
	}
...
type DeepIntShieldVideoListRequest struct {
	Provider ModelProvider `json:"provider"`
...
type DeepIntShieldVideoListResponse struct {
...
type DeepIntShieldVideoReferenceRequest struct {
	Provider ModelProvider `json:"provider"`
	ID       string        `json:"id"`
}

type DeepIntShieldVideoDeleteRequest = DeepIntShieldVideoReferenceRequest
type DeepIntShieldVideoRetrieveRequest = DeepIntShieldVideoReferenceRequest

type DeepIntShieldVideoDeleteResponse struct {
	ID          string                     `json:"id"`
...
type DeepIntShieldVideoDownloadRequest struct {
	Provider    ModelProvider         `json:"provider"`
	ID          string                `json:"id"`
...
type DeepIntShieldVideoDownloadResponse struct {
