...
// DeepIntShieldBatchCreateRequest represents a request to create a batch job.
type DeepIntShieldBatchCreateRequest struct {
...
func (request *DeepIntShieldBatchCreateRequest) GetRawRequestBody() []byte {
	return request.RawRequestBody
}

// DeepIntShieldBatchCreateResponse represents the response from creating a batch job.
type DeepIntShieldBatchCreateResponse struct {
	ID               string             `json:"id"`
...
// DeepIntShieldBatchListRequest represents a request to list batch jobs.
type DeepIntShieldBatchListRequest struct {
	Provider ModelProvider `json:"provider"`
...
// DeepIntShieldBatchListResponse represents the response from listing batch jobs.
type DeepIntShieldBatchListResponse struct {
	Object  string                         `json:"object,omitempty"` // "list"
	Data    []DeepIntShieldBatchRetrieveResponse `json:"data"`
...
// DeepIntShieldBatchRetrieveRequest represents a request to retrieve a batch job.
type DeepIntShieldBatchRetrieveRequest struct {
	Provider ModelProvider `json:"provider"`
	Model    *string       `json:"model"`
...
// GetRawRequestBody returns the raw request body.
func (request *DeepIntShieldBatchRetrieveRequest) GetRawRequestBody() []byte {
	return request.RawRequestBody
}

// DeepIntShieldBatchRetrieveResponse represents the response from retrieving a batch job.
type DeepIntShieldBatchRetrieveResponse struct {
	ID               string             `json:"id"`
	Object           string             `json:"object,omitempty"`
	Endpoint         string             `json:"endpoint,omitempty"`
	InputFileID      string             `json:"input_file_id,omitempty"`
...
// DeepIntShieldBatchCancelRequest represents a request to cancel a batch job.
type DeepIntShieldBatchCancelRequest struct {
	Provider ModelProvider `json:"provider"`
	Model    *string       `json:"model"`
...
// GetRawRequestBody returns the raw request body.
func (request *DeepIntShieldBatchCancelRequest) GetRawRequestBody() []byte {
	return request.RawRequestBody
}

// DeepIntShieldBatchCancelResponse represents the response from cancelling a batch job.
type DeepIntShieldBatchCancelResponse struct {
	ID            string             `json:"id"`
	Object        string             `json:"object,omitempty"`
	Status        BatchStatus        `json:"status"`
	RequestCounts BatchRequestCounts `json:"request_counts,omitempty"`
...
// DeepIntShieldBatchDeleteRequest represents a request to delete a batch job.
type DeepIntShieldBatchDeleteRequest struct {
	Provider ModelProvider `json:"provider"`
	Model    *string       `json:"model"`
...
// GetRawRequestBody returns the raw request body.
func (request *DeepIntShieldBatchDeleteRequest) GetRawRequestBody() []byte {
	return request.RawRequestBody
}

// DeepIntShieldBatchDeleteResponse represents the response from deleting a batch job.
type DeepIntShieldBatchDeleteResponse struct {
	ID            string             `json:"id"`
	Object        string             `json:"object,omitempty"`
	Status        BatchStatus        `json:"status"`
	RequestCounts BatchRequestCounts `json:"request_counts,omitempty"`
...
// DeepIntShieldBatchResultsRequest represents a request to retrieve batch results.
type DeepIntShieldBatchResultsRequest struct {
	Provider ModelProvider `json:"provider"`
	Model    *string       `json:"model"`
...
// GetRawRequestBody returns the raw request body.
func (request *DeepIntShieldBatchResultsRequest) GetRawRequestBody() []byte {
	return request.RawRequestBody
}
...
// DeepIntShieldBatchResultsResponse represents the response from retrieving batch results.
type DeepIntShieldBatchResultsResponse struct {
