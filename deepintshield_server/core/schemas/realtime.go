...
// RealtimeEventType represents the type of a DeepIntShield unified Realtime event.
type RealtimeEventType string

// Client-to-server event types (sent by the client through DeepIntShield)
const (
...
// DeepIntShieldRealtimeEvent is the unified DeepIntShield envelope for all Realtime events.
// Provider converters translate between this format and the provider-native protocol.
type DeepIntShieldRealtimeEvent struct {
...
type RealtimeProvider interface {
	...
	ToDeepIntShieldRealtimeEvent(providerEvent json.RawMessage) (*DeepIntShieldRealtimeEvent, error)
	ToProviderRealtimeEvent(deepintshieldEvent *DeepIntShieldRealtimeEvent) (json.RawMessage, error)
}
