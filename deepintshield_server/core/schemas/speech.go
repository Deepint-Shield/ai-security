...
type DeepIntShieldSpeechRequest struct {
...
func (r *DeepIntShieldSpeechRequest) GetRawRequestBody() []byte {
	return r.RawRequestBody
}

type DeepIntShieldSpeechResponse struct {
...
func (r *DeepIntShieldSpeechResponse) BackfillParams(request *DeepIntShieldSpeechRequest) {
...
type DeepIntShieldSpeechStreamResponse struct {
...
func (r *DeepIntShieldSpeechStreamResponse) BackfillParams(request *DeepIntShieldSpeechRequest) {
	if r == nil || request == nil || request.Input == nil {
		return
	}
	if r.Usage == nil {
