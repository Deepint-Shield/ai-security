...
type DeepIntShieldResponsesRequest struct {
...
func (r *DeepIntShieldResponsesRequest) GetRawRequestBody() []byte {
	return r.RawRequestBody
}

type DeepIntShieldResponsesResponse struct {
...
func (resp *DeepIntShieldResponsesResponse) WithDefaults() *DeepIntShieldResponsesResponse {
	if resp == nil {
		return nil
	}

	result := &DeepIntShieldResponsesResponse{
		ID:        resp.ID,
...
type DeepIntShieldResponsesStreamResponse struct {
	Type           ResponsesStreamResponseType `json:"type"`
	SequenceNumber int                         `json:"sequence_number"`

	Response *DeepIntShieldResponsesResponse `json:"response,omitempty"`
...
func (resp *DeepIntShieldResponsesStreamResponse) WithDefaults() *DeepIntShieldResponsesStreamResponse {
	if resp == nil {
		return nil
	}
	...
	result := &DeepIntShieldResponsesStreamResponse{
		Type:           resp.Type,
