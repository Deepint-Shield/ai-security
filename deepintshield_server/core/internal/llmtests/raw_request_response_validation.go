...
// ValidateExtraFieldsRaw validates rawRequest and rawResponse on DeepIntShieldResponseExtraFields
func ValidateExtraFieldsRaw(extraFields schemas.DeepIntShieldResponseExtraFields) []error {
	var errs []error
