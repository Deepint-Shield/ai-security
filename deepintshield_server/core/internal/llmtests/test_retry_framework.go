...
func parseRetryAfterFromError(err *schemas.DeepIntShieldError) time.Duration {
...
//     are already handled by deepintshield core, so these retries focus on content/functionality.
//
...
// DeepCopyDeepIntShieldStreamChunk creates a deep copy of a DeepIntShieldStreamChunk object to avoid pooling issues
func DeepCopyDeepIntShieldStreamChunk(original *schemas.DeepIntShieldStreamChunk) *schemas.DeepIntShieldStreamChunk {
	if original == nil {
		return nil
	}

	// Use reflection to create a deep copy
	return deepCopyReflect(original).(*schemas.DeepIntShieldStreamChunk)
}
...
// This focuses specifically on LLM behavior inconsistencies, not HTTP errors (handled by DeepIntShield core)
type TestRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
...
type ChatRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldChatResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type TextCompletionRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldTextCompletionResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type ResponsesRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldResponsesResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type SpeechRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldSpeechResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type TranscriptionRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldTranscriptionResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type EmbeddingRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldEmbeddingResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type ImageGenerationRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldImageGenerationResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type CountTokensRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldCountTokensResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type ListModelsRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldListModelsResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type BatchCreateRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldBatchCreateResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type BatchListRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldBatchListResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type BatchRetrieveRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldBatchRetrieveResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type BatchCancelRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldBatchCancelResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type BatchResultsRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldBatchResultsResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type FileUploadRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldFileUploadResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type FileListRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldFileListResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type FileRetrieveRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldFileRetrieveResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type FileDeleteRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldFileDeleteResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
type FileContentRetryCondition interface {
	ShouldRetry(response *schemas.DeepIntShieldFileContentResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string)
	GetConditionName() string
}
...
func WithChatTestRetry(
	...
	scenarioName string,
	operation func() (*schemas.DeepIntShieldChatResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldChatResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldChatResponse
	...
	for attempt := 1; attempt <= config.MaxAttempts; attempt++ {
		...
		if response != nil {
			...
			// Network errors are handled by deepintshield core, so these are content/functionality validation errors
			...
			// All retries failed validation - create a DeepIntShieldError to force test failure
			...
			// Return nil response + DeepIntShieldError so calling test fails
			statusCode := 400
			testFailureError := &schemas.DeepIntShieldError{
...
func WithResponsesTestRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldResponsesResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldResponsesResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldResponsesResponse
	var lastError *schemas.DeepIntShieldError
...
func WithStreamRetry(
	...
	context TestRetryContext,
	operation func() (chan *schemas.DeepIntShieldStreamChunk, *schemas.DeepIntShieldError),
) (chan *schemas.DeepIntShieldStreamChunk, *schemas.DeepIntShieldError) {
	var lastChannel chan *schemas.DeepIntShieldStreamChunk
	var lastError *schemas.DeepIntShieldError
		...
		if attempt < config.MaxAttempts {
			...
			if isTimeoutError(lastError) {
				...
				if shouldRetryFromConditions {
					...
					// Network errors are handled by deepintshield core, so these are likely transient
					shouldRetry = true
					errorMsg := GetErrorMessage(lastError)
					if !strings.Contains(errorMsg, "❌") {
						errorMsg = fmt.Sprintf("❌ %s", errorMsg)
...
func isTimeoutError(err *schemas.DeepIntShieldError) bool {
	if err == nil {
		return false
	}

	// Check error category first (from ParseDeepIntShieldError categorization)
...
type DualAPITestResult struct {
	ChatCompletionsResponse *schemas.DeepIntShieldChatResponse
	ChatCompletionsError    *schemas.DeepIntShieldError
	ResponsesAPIResponse    *schemas.DeepIntShieldResponsesResponse
	ResponsesAPIError       *schemas.DeepIntShieldError
	BothSucceeded           bool
}
...
// Network errors are handled by deepintshield core, so retries here focus on content/functionality validation
func WithDualAPITestRetry(
	...
	responsesOperation func() (*schemas.DeepIntShieldResponsesResponse, *schemas.DeepIntShieldError),
) DualAPITestResult {
...
func checkChatRetryConditions(response *schemas.DeepIntShieldChatResponse, err *schemas.DeepIntShieldError, context TestRetryContext, conditions []ChatRetryCondition) (bool, string) {
	for _, condition := range conditions {
...
func checkResponsesRetryConditions(response *schemas.DeepIntShieldResponsesResponse, err *schemas.DeepIntShieldError, context TestRetryContext, conditions []ResponsesRetryCondition) (bool, string) {
	for _, condition := range conditions {
		if shouldRetry, reason := condition.ShouldRetry(response, err, context); shouldRetry {
			return true, fmt.Sprintf("%s: %s", condition.GetConditionName(), reason)
		}
...
func WithTextCompletionTestRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldTextCompletionResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldTextCompletionResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldTextCompletionResponse
	var lastError *schemas.DeepIntShieldError
...
func WithSpeechTestRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldSpeechResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldSpeechResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldSpeechResponse
	var lastError *schemas.DeepIntShieldError
...
func checkTextCompletionRetryConditions(response *schemas.DeepIntShieldTextCompletionResponse, err *schemas.DeepIntShieldError, context TestRetryContext, conditions []TextCompletionRetryCondition) (bool, string) {
	for _, condition := range conditions {
		if shouldRetry, reason := condition.ShouldRetry(response, err, context); shouldRetry {
			return true, fmt.Sprintf("%s: %s", condition.GetConditionName(), reason)
		}
...
func checkSpeechRetryConditions(response *schemas.DeepIntShieldSpeechResponse, err *schemas.DeepIntShieldError, context TestRetryContext, conditions []SpeechRetryCondition) (bool, string) {
	for _, condition := range conditions {
		if shouldRetry, reason := condition.ShouldRetry(response, err, context); shouldRetry {
			return true, fmt.Sprintf("%s: %s", condition.GetConditionName(), reason)
		}
...
func WithEmbeddingTestRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldEmbeddingResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldEmbeddingResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldEmbeddingResponse
	var lastError *schemas.DeepIntShieldError
...
func WithTranscriptionTestRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldTranscriptionResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldTranscriptionResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldTranscriptionResponse
	var lastError *schemas.DeepIntShieldError
	...
	for attempt := 1; attempt <= config.MaxAttempts; attempt++ {
		...
		if err != nil && attempt < config.MaxAttempts {
			...
			// ALWAYS retry on non-structural errors (network errors are handled by deepintshield core)
...
func checkEmbeddingRetryConditions(response *schemas.DeepIntShieldEmbeddingResponse, err *schemas.DeepIntShieldError, context TestRetryContext, conditions []EmbeddingRetryCondition) (bool, string) {
	for _, condition := range conditions {
		if shouldRetry, reason := condition.ShouldRetry(response, err, context); shouldRetry {
			return true, fmt.Sprintf("%s: %s", condition.GetConditionName(), reason)
		}
...
func WithCountTokensTestRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldCountTokensResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldCountTokensResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldCountTokensResponse
	var lastError *schemas.DeepIntShieldError
...
func checkCountTokensRetryConditions(response *schemas.DeepIntShieldCountTokensResponse, err *schemas.DeepIntShieldError, context TestRetryContext, conditions []CountTokensRetryCondition) (bool, string) {
	for _, condition := range conditions {
		if shouldRetry, reason := condition.ShouldRetry(response, err, context); shouldRetry {
			return true, fmt.Sprintf("%s: %s", condition.GetConditionName(), reason)
		}
...
func checkTranscriptionRetryConditions(response *schemas.DeepIntShieldTranscriptionResponse, err *schemas.DeepIntShieldError, context TestRetryContext, conditions []TranscriptionRetryCondition) (bool, string) {
	for _, condition := range conditions {
		if shouldRetry, reason := condition.ShouldRetry(response, err, context); shouldRetry {
			return true, fmt.Sprintf("%s: %s", condition.GetConditionName(), reason)
		}
...
func WithImageGenerationRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldImageGenerationResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldImageGenerationResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldImageGenerationResponse
	var lastError *schemas.DeepIntShieldError
...
func checkImageGenerationRetryConditions(response *schemas.DeepIntShieldImageGenerationResponse, err *schemas.DeepIntShieldError, context TestRetryContext, conditions []ImageGenerationRetryCondition) (bool, string) {
	for _, condition := range conditions {
		if shouldRetry, reason := condition.ShouldRetry(response, err, context); shouldRetry {
			return true, fmt.Sprintf("%s: %s", condition.GetConditionName(), reason)
		}
...
func WithListModelsTestRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldListModelsResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldListModelsResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldListModelsResponse
	var lastError *schemas.DeepIntShieldError
	...
	for attempt := 1; attempt <= config.MaxAttempts; attempt++ {
		...
		if err != nil {
			...
			if isTimeoutError(err) {
				...
				parsed := ParseDeepIntShieldError(err)
...
func checkListModelsRetryConditions(response *schemas.DeepIntShieldListModelsResponse, err *schemas.DeepIntShieldError, context TestRetryContext, conditions []ListModelsRetryCondition) (bool, string) {
	for _, condition := range conditions {
		if shouldRetry, reason := condition.ShouldRetry(response, err, context); shouldRetry {
			return true, fmt.Sprintf("%s: %s", condition.GetConditionName(), reason)
		}
...
func WithBatchCreateTestRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldBatchCreateResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldBatchCreateResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldBatchCreateResponse
	var lastError *schemas.DeepIntShieldError
...
func WithBatchListTestRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldBatchListResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldBatchListResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldBatchListResponse
	var lastError *schemas.DeepIntShieldError
...
func WithBatchRetrieveTestRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldBatchRetrieveResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldBatchRetrieveResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldBatchRetrieveResponse
	var lastError *schemas.DeepIntShieldError
...
func WithBatchCancelTestRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldBatchCancelResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldBatchCancelResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldBatchCancelResponse
	var lastError *schemas.DeepIntShieldError
...
func WithBatchResultsTestRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldBatchResultsResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldBatchResultsResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldBatchResultsResponse
	var lastError *schemas.DeepIntShieldError
...
func WithFileUploadTestRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldFileUploadResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldFileUploadResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldFileUploadResponse
	var lastError *schemas.DeepIntShieldError
...
func WithFileListTestRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldFileListResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldFileListResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldFileListResponse
	var lastError *schemas.DeepIntShieldError
...
func WithFileRetrieveTestRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldFileRetrieveResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldFileRetrieveResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldFileRetrieveResponse
	var lastError *schemas.DeepIntShieldError
...
func WithFileDeleteTestRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldFileDeleteResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldFileDeleteResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldFileDeleteResponse
	var lastError *schemas.DeepIntShieldError
...
func WithFileContentTestRetry(
	...
	expectations ResponseExpectations,
	scenarioName string,
	operation func() (*schemas.DeepIntShieldFileContentResponse, *schemas.DeepIntShieldError),
) (*schemas.DeepIntShieldFileContentResponse, *schemas.DeepIntShieldError) {

	var lastResponse *schemas.DeepIntShieldFileContentResponse
	var lastError *schemas.DeepIntShieldError
...
func WithSpeechStreamValidationRetry(
	...
	context TestRetryContext,
	operation func() (chan *schemas.DeepIntShieldStreamChunk, *schemas.DeepIntShieldError),
	validateStream func(chan *schemas.DeepIntShieldStreamChunk) SpeechStreamValidationResult,
...
func WithResponsesStreamValidationRetry(
	...
	context TestRetryContext,
	operation func() (chan *schemas.DeepIntShieldStreamChunk, *schemas.DeepIntShieldError),
	validateStream func(chan *schemas.DeepIntShieldStreamChunk) ResponsesStreamValidationResult,
...
func WithChatStreamValidationRetry(
	...
	context TestRetryContext,
	operation func() (chan *schemas.DeepIntShieldStreamChunk, *schemas.DeepIntShieldError),
	validateStream func(chan *schemas.DeepIntShieldStreamChunk) ChatStreamValidationResult,
...
func WithImageGenerationStreamRetry(
	...
	context TestRetryContext,
	operation func() (chan *schemas.DeepIntShieldStreamChunk, *schemas.DeepIntShieldError),
	validateStream func(chan *schemas.DeepIntShieldStreamChunk) ImageGenerationStreamValidationResult) ImageGenerationStreamValidationResult {
