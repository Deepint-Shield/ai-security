...
func GetSampleChatTool(toolName SampleToolType) *schemas.ChatTool {
	...
	return &schemas.ChatTool{
		...
		Function: &schemas.ChatToolFunction{
			...
			Description: deepintshield.Ptr(description),
...
func GetSampleResponsesTool(toolName SampleToolType) *schemas.ResponsesTool {
	...
	return &schemas.ResponsesTool{
		Type:        "function",
		Name:        deepintshield.Ptr(toolDisplayName),
		Description: deepintshield.Ptr(description),
...
func CreateSpeechRequest(text, voice, format string) *schemas.DeepIntShieldSpeechRequest {
...
func CreateTranscriptionInput(audioData []byte, language, responseFormat *string) *schemas.DeepIntShieldTranscriptionRequest {
	return &schemas.DeepIntShieldTranscriptionRequest{
...
func CreateBasicChatMessage(content string) schemas.ChatMessage {
	return schemas.ChatMessage{
		...
		Content: &schemas.ChatMessageContent{
			ContentStr: deepintshield.Ptr(content),
		},
	}
}
	...
	return schemas.ChatMessage{
		...
		Content: &schemas.ChatMessageContent{
			ContentBlocks: []schemas.ChatContentBlock{
				{Type: schemas.ChatContentBlockTypeText, Text: deepintshield.Ptr(text)},
	...
	return schemas.ResponsesMessage{
		...
		Content: &schemas.ResponsesMessageContent{
			ContentBlocks: []schemas.ResponsesMessageContentBlock{
				{Type: schemas.ResponsesInputMessageContentBlockTypeText, Text: deepintshield.Ptr(text)},
				{
					Type: schemas.ResponsesInputMessageContentBlockTypeImage,
					ResponsesInputMessageContentBlockImage: &schemas.ResponsesInputMessageContentBlockImage{
						ImageURL: deepintshield.Ptr(imageURL),
					},
				},
			},
		},
...
func CreateAudioChatMessage(text, audioData string, audioFormat string) schemas.ChatMessage {
	format := deepintshield.Ptr(audioFormat)
	return schemas.ChatMessage{
		Role: schemas.ChatMessageRoleUser,
		Content: &schemas.ChatMessageContent{
			ContentBlocks: []schemas.ChatContentBlock{
...
func CreateToolChatMessage(content string, toolCallID string) schemas.ChatMessage {
	return schemas.ChatMessage{
		...
		ChatToolMessage: &schemas.ChatToolMessage{
			ToolCallID: deepintshield.Ptr(toolCallID),
		},
	}
}
...
func CreateToolResponsesMessage(content string, toolCallID string) schemas.ResponsesMessage {
	return schemas.ResponsesMessage{
		...
		ResponsesToolMessage: &schemas.ResponsesToolMessage{
			CallID: deepintshield.Ptr(toolCallID),
			// Set ResponsesFunctionToolCallOutput for OpenAI's native Responses API
			Output: &schemas.ResponsesToolMessageOutputStruct{
				ResponsesToolCallOutputStr: deepintshield.Ptr(content),
			},
		},
	}
}
...
// GetChatContent returns the string content from a DeepIntShieldChatResponse
func GetChatContent(response *schemas.DeepIntShieldChatResponse) string {
...
// GetTextCompletionContent returns the string content from a DeepIntShieldTextCompletionResponse
func GetTextCompletionContent(response *schemas.DeepIntShieldTextCompletionResponse) string {
	if response == nil || response.Choices == nil {
		return ""
	}
...
// GetResponsesContent returns the string content from a DeepIntShieldResponsesResponse
func GetResponsesContent(response *schemas.DeepIntShieldResponsesResponse) string {
...
// ExtractChatToolCalls extracts tool call information from a DeepIntShieldChatResponse
func ExtractChatToolCalls(response *schemas.DeepIntShieldChatResponse) []ToolCallInfo {
...
// ExtractResponsesToolCalls extracts tool call information from a DeepIntShieldResponsesResponse
func ExtractResponsesToolCalls(response *schemas.DeepIntShieldResponsesResponse) []ToolCallInfo {
	var toolCalls []ToolCallInfo
...
func GetResultContent(response *schemas.DeepIntShieldResponse) string {
	if response == nil {
		return ""
	}
...
func ExtractToolCalls(response *schemas.DeepIntShieldResponse) []ToolCallInfo {
	if response == nil {
		return []ToolCallInfo{}
	}
...
// getEmbeddingVector extracts the float32 vector from a DeepIntShieldEmbeddingResponse
...
func GenerateTTSAudioForTest(ctx context.Context, t *testing.T, client *deepintshield.DeepIntShield, provider schemas.ModelProvider, ttsModel string, text string, voiceType string, format string) ([]byte, string) {
	...
	req := &schemas.DeepIntShieldSpeechRequest{
		Provider: provider,
		Model:    ttsModel,
	...
	resp, err := WithSpeechTestRetry(t, speechRetryConfig, retryContext, expectations, "GenerateTTSAudioForTest", func() (*schemas.DeepIntShieldSpeechResponse, *schemas.DeepIntShieldError) {
	...
	suffix := "." + format
	f, cerr := os.CreateTemp("", "deepintshield-tts-*"+suffix)
	if cerr != nil {
...
func GetErrorMessage(err *schemas.DeepIntShieldError) string {
	if err == nil {
		return ""
	}
