...
func RunCountTokenTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("CountTokens", func(t *testing.T) {
		...
		countTokensReq := &schemas.DeepIntShieldResponsesRequest{
		...
		countTokensResp, countTokensErr := WithCountTokensTestRetry(
			...
			expectations,
			"CountTokens",
			func() (*schemas.DeepIntShieldCountTokensResponse, *schemas.DeepIntShieldError) {
