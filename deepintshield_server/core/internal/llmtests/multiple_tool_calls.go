...
func RunMultipleToolCallsTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("MultipleToolCalls", func(t *testing.T) {
		...
		validateChatMultipleToolCalls := func(response *schemas.DeepIntShieldChatResponse, apiName string) {
		...
		validateResponsesMultipleToolCalls := func(response *schemas.DeepIntShieldResponsesResponse, apiName string) {
				...
				for {
					...
					case response, ok := <-responseChannel:
						...
						if response == nil || response.DeepIntShieldChatResponse == nil {
							...
							if response != nil && response.DeepIntShieldError != nil {
								errMsg += fmt.Sprintf(" - error: %s", GetErrorMessage(response.DeepIntShieldError))
							}
