// Package llmtests provides batch API test utilities for the DeepIntShield system.
package llmtests
...
func RunBatchCreateTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("BatchCreate", func(t *testing.T) {
		...
		response, err := WithBatchCreateTestRetry(t, batchCreateRetryConfig, retryContext, expectations, "BatchCreate", func() (*schemas.DeepIntShieldBatchCreateResponse, *schemas.DeepIntShieldError) {
			request := &schemas.DeepIntShieldBatchCreateRequest{
				Provider: testConfig.Provider,
...
func RunBatchListTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("BatchList", func(t *testing.T) {
		...
		response, err := WithBatchListTestRetry(t, batchListRetryConfig, retryContext, expectations, "BatchList", func() (*schemas.DeepIntShieldBatchListResponse, *schemas.DeepIntShieldError) {
			request := &schemas.DeepIntShieldBatchListRequest{
				Provider: testConfig.Provider,
				Limit:    10,
			}
			bfCtx := schemas.NewDeepIntShieldContext(ctx, schemas.NoDeadline)
...
func RunBatchRetrieveTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("BatchRetrieve", func(t *testing.T) {
		...
		createResponse, createErr := WithBatchCreateTestRetry(t, batchCreateRetryConfig, createRetryContext, createExpectations, "BatchRetrieve_Create", func() (*schemas.DeepIntShieldBatchCreateResponse, *schemas.DeepIntShieldError) {
		...
		response, err := WithBatchRetrieveTestRetry(t, batchRetrieveRetryConfig, retrieveRetryContext, retrieveExpectations, "BatchRetrieve", func() (*schemas.DeepIntShieldBatchRetrieveResponse, *schemas.DeepIntShieldError) {
...
func RunBatchCancelTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("BatchCancel", func(t *testing.T) {
		...
		createResponse, createErr := WithBatchCreateTestRetry(t, batchCreateRetryConfig, createRetryContext, createExpectations, "BatchCancel_Create", func() (*schemas.DeepIntShieldBatchCreateResponse, *schemas.DeepIntShieldError) {
			createRequest := &schemas.DeepIntShieldBatchCreateRequest{
				Provider: testConfig.Provider,
				Model:    schemas.Ptr(testConfig.ChatModel),
				Endpoint: schemas.BatchEndpointChatCompletions,
		...
		response, err := WithBatchCancelTestRetry(t, batchCancelRetryConfig, cancelRetryContext, cancelExpectations, "BatchCancel", func() (*schemas.DeepIntShieldBatchCancelResponse, *schemas.DeepIntShieldError) {
...
func RunBatchResultsTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("BatchResults", func(t *testing.T) {
		...
		request := &schemas.DeepIntShieldBatchResultsRequest{
			Provider: testConfig.Provider,
...
func RunBatchUnsupportedTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunFileUploadTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("FileUpload", func(t *testing.T) {
		...
		response, err := WithFileUploadTestRetry(t, fileUploadRetryConfig, retryContext, expectations, "FileUpload", func() (*schemas.DeepIntShieldFileUploadResponse, *schemas.DeepIntShieldError) {
...
`)
			request := &schemas.DeepIntShieldFileUploadRequest{
				Provider:    testConfig.Provider,
				File:        fileContent,
...
func RunFileListTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("FileList", func(t *testing.T) {
		...
		response, err := WithFileListTestRetry(t, fileListRetryConfig, retryContext, expectations, "FileList", func() (*schemas.DeepIntShieldFileListResponse, *schemas.DeepIntShieldError) {
			request := &schemas.DeepIntShieldFileListRequest{
				Provider:    testConfig.Provider,
				Limit:       10,
				ExtraParams: testConfig.FileExtraParams,
			}
...
func RunFileRetrieveTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("FileRetrieve", func(t *testing.T) {
		...
		uploadResponse, uploadErr := WithFileUploadTestRetry(t, fileUploadRetryConfig, uploadRetryContext, uploadExpectations, "FileRetrieve_Upload", func() (*schemas.DeepIntShieldFileUploadResponse, *schemas.DeepIntShieldError) {
...
`)
		...
		response, err := WithFileRetrieveTestRetry(t, fileRetrieveRetryConfig, retrieveRetryContext, retrieveExpectations, "FileRetrieve", func() (*schemas.DeepIntShieldFileRetrieveResponse, *schemas.DeepIntShieldError) {
...
func RunFileDeleteTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("FileDelete", func(t *testing.T) {
		...
		uploadResponse, uploadErr := WithFileUploadTestRetry(t, fileUploadRetryConfig, uploadRetryContext, uploadExpectations, "FileDelete_Upload", func() (*schemas.DeepIntShieldFileUploadResponse, *schemas.DeepIntShieldError) {
...
`)
		...
		response, err := WithFileDeleteTestRetry(t, fileDeleteRetryConfig, deleteRetryContext, deleteExpectations, "FileDelete", func() (*schemas.DeepIntShieldFileDeleteResponse, *schemas.DeepIntShieldError) {
...
func RunFileContentTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("FileContent", func(t *testing.T) {
		...
		uploadResponse, uploadErr := WithFileUploadTestRetry(t, fileUploadRetryConfig, uploadRetryContext, uploadExpectations, "FileContent_Upload", func() (*schemas.DeepIntShieldFileUploadResponse, *schemas.DeepIntShieldError) {
...
`)
		...
		response, err := WithFileContentTestRetry(t, fileContentRetryConfig, contentRetryContext, contentExpectations, "FileContent", func() (*schemas.DeepIntShieldFileContentResponse, *schemas.DeepIntShieldError) {
...
func RunFileUnsupportedTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunFileAndBatchIntegrationTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
`)
		...
		batchRequest := &schemas.DeepIntShieldBatchCreateRequest{
			Provider:         testConfig.Provider,
			Model:            schemas.Ptr(testConfig.ChatModel),
		...
		bfCtx2 := schemas.NewDeepIntShieldContext(ctx, schemas.NoDeadline)
