...
type TestScenarioFunc func(*testing.T, *deepintshield.DeepIntShield, context.Context, ComprehensiveTestConfig)

// RunAllComprehensiveTests executes all comprehensive test scenarios for a given configuration
func RunAllComprehensiveTests(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("WithRawRequestResponse", func(t *testing.T) {
		...
		rawCtx = context.WithValue(rawCtx, schemas.DeepIntShieldContextKeySendBackRawResponse, true)
