...
func RunImageURLTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ImageURL", func(t *testing.T) {
		...
		validateChatImageProcessing := func(response *schemas.DeepIntShieldChatResponse, apiName string) {
			content := GetChatContent(response)
			validateImageProcessingContent(t, content, apiName)
		}

		validateResponsesImageProcessing := func(response *schemas.DeepIntShieldResponsesResponse, apiName string) {
