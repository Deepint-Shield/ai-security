...
func RunOpus45ReasoningTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, config OpusReasoningTestConfig) {
		...
		t.Run("ResponsesAPI", func(t *testing.T) {
			...
			responsesReq := &schemas.DeepIntShieldResponsesRequest{
				...
				Params: &schemas.ResponsesParameters{
					MaxOutputTokens: deepintshield.Ptr(4000),
			...
			response, responsesError := WithResponsesTestRetry(t, responsesRetryConfig, retryContext, expectations, "Opus45_Reasoning_Responses", func() (*schemas.DeepIntShieldResponsesResponse, *schemas.DeepIntShieldError) {
		...
		t.Run("ChatCompletionsAPI", func(t *testing.T) {
			...
			chatReq := &schemas.DeepIntShieldChatRequest{
				...
				Params: &schemas.ChatParameters{
					MaxCompletionTokens: deepintshield.Ptr(4000),
					Reasoning: &schemas.ChatReasoning{
						Effort:    deepintshield.Ptr("high"),
						MaxTokens: deepintshield.Ptr(2000), // Budget tokens for Opus 4.5
					},
				},
				Fallbacks: config.Fallbacks,
			}
			...
			response, chatError := WithChatTestRetry(t, chatRetryConfig, retryContext, expectations, "Opus45_Reasoning_Chat", func() (*schemas.DeepIntShieldChatResponse, *schemas.DeepIntShieldError) {
				bfCtx := schemas.NewDeepIntShieldContext(ctx, schemas.NoDeadline)
...
func RunOpus46ReasoningTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, config OpusReasoningTestConfig) {
			...
			t.Run("ResponsesAPI_Effort_"+effort, func(t *testing.T) {
				...
				responsesReq := &schemas.DeepIntShieldResponsesRequest{
					...
					Params: &schemas.ResponsesParameters{
						MaxOutputTokens: deepintshield.Ptr(4000),
						Reasoning: &schemas.ResponsesParametersReasoning{
							Effort: deepintshield.Ptr(effort), // Adaptive thinking uses effort parameter
						},
						Include: []string{"reasoning.encrypted_content"},
					},
					Fallbacks: config.Fallbacks,
				...
				response, responsesError := WithResponsesTestRetry(t, responsesRetryConfig, retryContext, expectations, "Opus46_Reasoning_Responses_"+effort, func() (*schemas.DeepIntShieldResponsesResponse, *schemas.DeepIntShieldError) {
					bfCtx := schemas.NewDeepIntShieldContext(ctx, schemas.NoDeadline)
					return client.ResponsesRequest(bfCtx, responsesReq)
				})
		...
		t.Run("ChatCompletionsAPI", func(t *testing.T) {
			...
			chatReq := &schemas.DeepIntShieldChatRequest{
				...
				Params: &schemas.ChatParameters{
					MaxCompletionTokens: deepintshield.Ptr(4000),
					Reasoning: &schemas.ChatReasoning{
						Effort: deepintshield.Ptr("high"), // Opus 4.6 uses adaptive thinking with effort
			...
			response, chatError := WithChatTestRetry(t, chatRetryConfig, retryContext, expectations, "Opus46_Reasoning_Chat", func() (*schemas.DeepIntShieldChatResponse, *schemas.DeepIntShieldError) {
				bfCtx := schemas.NewDeepIntShieldContext(ctx, schemas.NoDeadline)
				return client.ChatCompletionRequest(bfCtx, chatReq)
			})
...
func RunOpus46MultiTurnReasoningTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, config OpusReasoningTestConfig) {
	if config.SkipOpus46 {
	...
	t.Run("Opus46_MultiTurnReasoning", func(t *testing.T) {
		...
		firstResponse, chatError := WithChatTestRetry(t, chatRetryConfig, retryContext, expectations, "Opus46_MultiTurn_Step1", func() (*schemas.DeepIntShieldChatResponse, *schemas.DeepIntShieldError) {
			bfCtx := schemas.NewDeepIntShieldContext(ctx, schemas.NoDeadline)
			return client.ChatCompletionRequest(bfCtx, chatReq)
		})
		...
		multiTurnReq := &schemas.DeepIntShieldChatRequest{
			Provider: config.Provider,
			Model:    config.Opus46Model,
		...
		secondResponse, chatError2 := WithChatTestRetry(t, chatRetryConfig, retryContext2, expectations, "Opus46_MultiTurn_Step2", func() (*schemas.DeepIntShieldChatResponse, *schemas.DeepIntShieldError) {
			bfCtx := schemas.NewDeepIntShieldContext(ctx, schemas.NoDeadline)
...
func RunAllOpusReasoningTests(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, config OpusReasoningTestConfig) {
