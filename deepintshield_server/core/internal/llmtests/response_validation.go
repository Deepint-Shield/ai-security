...
func ValidateChatResponse(t *testing.T, response *schemas.DeepIntShieldChatResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
...
func ValidateTextCompletionResponse(t *testing.T, response *schemas.DeepIntShieldTextCompletionResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateResponsesResponse(t *testing.T, response *schemas.DeepIntShieldResponsesResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateSpeechResponse(t *testing.T, response *schemas.DeepIntShieldSpeechResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateImageGenerationResponse(t *testing.T, response *schemas.DeepIntShieldImageGenerationResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateTranscriptionResponse(t *testing.T, response *schemas.DeepIntShieldTranscriptionResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateListModelsResponse(t *testing.T, response *schemas.DeepIntShieldListModelsResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateEmbeddingResponse(t *testing.T, response *schemas.DeepIntShieldEmbeddingResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateCountTokensResponse(t *testing.T, response *schemas.DeepIntShieldCountTokensResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func validateChatBasicStructure(t *testing.T, response *schemas.DeepIntShieldChatResponse, expectations ResponseExpectations, result *ValidationResult) {
	// Check choice count
...
func validateChatContent(t *testing.T, response *schemas.DeepIntShieldChatResponse, expectations ResponseExpectations, result *ValidationResult) {
...
func validateChatToolCalls(t *testing.T, response *schemas.DeepIntShieldChatResponse, expectations ResponseExpectations, result *ValidationResult) {
	totalToolCalls := 0
...
func validateChatTechnicalFields(t *testing.T, response *schemas.DeepIntShieldChatResponse, expectations ResponseExpectations, result *ValidationResult) {
	// Check usage stats
...
func collectChatResponseMetrics(response *schemas.DeepIntShieldChatResponse, result *ValidationResult) {
...
func validateTextCompletionBasicStructure(t *testing.T, response *schemas.DeepIntShieldTextCompletionResponse, expectations ResponseExpectations, result *ValidationResult) {
	// Check choice count
	if expectations.ExpectedChoiceCount > 0 {
		actualCount := 0
		if response.Choices != nil {
...
func validateTextCompletionContent(t *testing.T, response *schemas.DeepIntShieldTextCompletionResponse, expectations ResponseExpectations, result *ValidationResult) {
	// Skip content validation for responses that don't have text content
	if !expectations.ShouldHaveContent {
		return
	}
...
func validateTextCompletionTechnicalFields(t *testing.T, response *schemas.DeepIntShieldTextCompletionResponse, expectations ResponseExpectations, result *ValidationResult) {
	// Check usage stats
	if expectations.ShouldHaveUsageStats {
		if response.Usage == nil {
			result.Warnings = append(result.Warnings, "Expected usage statistics but not present")
...
func collectTextCompletionResponseMetrics(response *schemas.DeepIntShieldTextCompletionResponse, result *ValidationResult) {
	result.MetricsCollected["choice_count"] = len(response.Choices)
	result.MetricsCollected["has_usage"] = response.Usage != nil
	result.MetricsCollected["has_model"] = response.Model != ""
...
func validateResponsesBasicStructure(response *schemas.DeepIntShieldResponsesResponse, expectations ResponseExpectations, result *ValidationResult) {
	// Check choice count
	if expectations.ExpectedChoiceCount > 0 {
		actualCount := 0
...
func validateResponsesContent(t *testing.T, response *schemas.DeepIntShieldResponsesResponse, expectations ResponseExpectations, result *ValidationResult) {
	// Skip content validation for responses that don't have text content
	if !expectations.ShouldHaveContent {
		return
	}
...
func validateResponsesToolCalls(t *testing.T, response *schemas.DeepIntShieldResponsesResponse, expectations ResponseExpectations, result *ValidationResult) {
	totalToolCalls := 0
...
func validateResponsesTechnicalFields(t *testing.T, response *schemas.DeepIntShieldResponsesResponse, expectations ResponseExpectations, result *ValidationResult) {
	// Check usage stats
	if expectations.ShouldHaveUsageStats {
		if response.Usage == nil {
			result.Warnings = append(result.Warnings, "Expected usage statistics but not present")
...
func collectResponsesResponseMetrics(response *schemas.DeepIntShieldResponsesResponse, result *ValidationResult) {
	if response.Output != nil {
...
func validateSpeechSynthesisResponse(t *testing.T, response *schemas.DeepIntShieldSpeechResponse, expectations ResponseExpectations, result *ValidationResult) {
...
func collectSpeechResponseMetrics(response *schemas.DeepIntShieldSpeechResponse, result *ValidationResult) {
...
func validateTranscriptionFields(t *testing.T, response *schemas.DeepIntShieldTranscriptionResponse, expectations ResponseExpectations, result *ValidationResult) {
...
func collectTranscriptionResponseMetrics(response *schemas.DeepIntShieldTranscriptionResponse, result *ValidationResult) {
...
func validateImageGenerationFields(t *testing.T, response *schemas.DeepIntShieldImageGenerationResponse, expectations ResponseExpectations, result *ValidationResult) {
...
func collectImageGenerationResponseMetrics(response *schemas.DeepIntShieldImageGenerationResponse, result *ValidationResult) {
...
func validateEmbeddingFields(t *testing.T, response *schemas.DeepIntShieldEmbeddingResponse, expectations ResponseExpectations, result *ValidationResult) {
...
func validateCountTokensFields(t *testing.T, response *schemas.DeepIntShieldCountTokensResponse, expectations ResponseExpectations, result *ValidationResult) {
	_ = t
...
func validateListModelsFields(t *testing.T, response *schemas.DeepIntShieldListModelsResponse, expectations ResponseExpectations, result *ValidationResult) {
...
func collectListModelsResponseMetrics(response *schemas.DeepIntShieldListModelsResponse, result *ValidationResult) {
...
func collectEmbeddingResponseMetrics(response *schemas.DeepIntShieldEmbeddingResponse, result *ValidationResult) {
...
func collectCountTokensResponseMetrics(response *schemas.DeepIntShieldCountTokensResponse, result *ValidationResult) {
...
func ValidateBatchCreateResponse(t *testing.T, response *schemas.DeepIntShieldBatchCreateResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateBatchListResponse(t *testing.T, response *schemas.DeepIntShieldBatchListResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateBatchRetrieveResponse(t *testing.T, response *schemas.DeepIntShieldBatchRetrieveResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateBatchCancelResponse(t *testing.T, response *schemas.DeepIntShieldBatchCancelResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateBatchResultsResponse(t *testing.T, response *schemas.DeepIntShieldBatchResultsResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateFileUploadResponse(t *testing.T, response *schemas.DeepIntShieldFileUploadResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateFileListResponse(t *testing.T, response *schemas.DeepIntShieldFileListResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateFileRetrieveResponse(t *testing.T, response *schemas.DeepIntShieldFileRetrieveResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateFileDeleteResponse(t *testing.T, response *schemas.DeepIntShieldFileDeleteResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateFileContentResponse(t *testing.T, response *schemas.DeepIntShieldFileContentResponse, err *schemas.DeepIntShieldError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func extractChatToolCallNames(response *schemas.DeepIntShieldChatResponse) []string {
...
func extractResponsesToolCallNames(response *schemas.DeepIntShieldResponsesResponse) []string {
	var toolNames []string
...
func validateChatSpecificToolCalls(response *schemas.DeepIntShieldChatResponse, expectedCalls []ToolCallExpectation, result *ValidationResult) {
...
func validateResponsesSpecificToolCalls(response *schemas.DeepIntShieldResponsesResponse, expectedCalls []ToolCallExpectation, result *ValidationResult) {
	for _, expected := range expectedCalls {
		found := false
