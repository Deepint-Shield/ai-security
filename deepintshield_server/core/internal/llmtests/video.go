...
func RunVideoGenerationTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunVideoRetrieveTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunVideoRemixTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("VideoRemix", func(t *testing.T) {
		...
		remixReq := &schemas.DeepIntShieldVideoRemixRequest{
...
func RunVideoDownloadTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("VideoDownload", func(t *testing.T) {
		...
		downloadReq := &schemas.DeepIntShieldVideoDownloadRequest{
			Provider: testConfig.Provider,
			ID:       created.ID,
		}
		bfCtx := schemas.NewDeepIntShieldContext(ctx, schemas.NoDeadline)
...
func RunVideoListTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("VideoList", func(t *testing.T) {
		...
		order := "desc"
		limit := 5
		req := &schemas.DeepIntShieldVideoListRequest{
			Provider: testConfig.Provider,
			Order:    deepintshield.Ptr(order),
			Limit:    deepintshield.Ptr(limit),
		}
		bfCtx := schemas.NewDeepIntShieldContext(ctx, schemas.NoDeadline)
...
func RunVideoDeleteTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("VideoDelete", func(t *testing.T) {
		...
		deleteReq := &schemas.DeepIntShieldVideoDeleteRequest{
			Provider: testConfig.Provider,
			ID:       created.ID,
		}
		bfCtx := schemas.NewDeepIntShieldContext(ctx, schemas.NoDeadline)
...
func RunVideoUnsupportedTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("VideoUnsupported", func(t *testing.T) {
		...
		_, listErr := client.VideoListRequest(bfCtx, &schemas.DeepIntShieldVideoListRequest{
			Provider: testConfig.Provider,
		})
		...
		_, deleteErr := client.VideoDeleteRequest(bfCtx, &schemas.DeepIntShieldVideoDeleteRequest{
			Provider: testConfig.Provider,
			ID:       "video_test_id",
		})
		...
		_, remixErr := client.VideoRemixRequest(bfCtx, &schemas.DeepIntShieldVideoRemixRequest{
			Provider: testConfig.Provider,
			ID:       "video_test_id",
...
func createVideoJob(client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) (*schemas.DeepIntShieldVideoGenerationResponse, *schemas.DeepIntShieldError) {
	req := &schemas.DeepIntShieldVideoGenerationRequest{
		Provider: testConfig.Provider,
...
func retrieveVideoWithRetries(client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig, videoID string) (*schemas.DeepIntShieldVideoGenerationResponse, *schemas.DeepIntShieldError) {
	var lastErr *schemas.DeepIntShieldError
	for attempt := 0; attempt < videoRetrieveMaxRetries; attempt++ {
		req := &schemas.DeepIntShieldVideoRetrieveRequest{
			Provider: testConfig.Provider,
			ID:       videoID,
		}
		bfCtx := schemas.NewDeepIntShieldContext(ctx, schemas.NoDeadline)
...
func waitForVideoCompletion(
	...
	var lastResp *schemas.DeepIntShieldVideoGenerationResponse
	var lastErr *schemas.DeepIntShieldError
...
func isUnsupportedOperationError(err *schemas.DeepIntShieldError) bool {
