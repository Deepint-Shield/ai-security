...
func RunCompleteEnd2EndTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("CompleteEnd2End", func(t *testing.T) {
		...
		chatOperation1 := func() (*schemas.DeepIntShieldChatResponse, *schemas.DeepIntShieldError) {
			...
			chatReq := &schemas.DeepIntShieldChatRequest{
				...
				Params: &schemas.ChatParameters{
					...
					ToolChoice: &schemas.ChatToolChoice{
						ChatToolChoiceStr: deepintshield.Ptr(string(schemas.ChatToolChoiceTypeRequired)),
					},
		...
		responsesOperation1 := func() (*schemas.DeepIntShieldResponsesResponse, *schemas.DeepIntShieldError) {
			bfCtx := schemas.NewDeepIntShieldContext(ctx, schemas.NoDeadline)
			responsesReq := &schemas.DeepIntShieldResponsesRequest{
				...
				Params: &schemas.ResponsesParameters{
					...
					ToolChoice: &schemas.ResponsesToolChoice{
						ResponsesToolChoiceStr: deepintshield.Ptr(string(schemas.ResponsesToolChoiceTypeRequired)),
					},
		...
		chatOperation2 := func() (*schemas.DeepIntShieldChatResponse, *schemas.DeepIntShieldError) {
			bfCtx := schemas.NewDeepIntShieldContext(ctx, schemas.NoDeadline)
			chatReq := &schemas.DeepIntShieldChatRequest{
				Provider: testConfig.Provider,
				Model:    testConfig.ChatModel,
		...
		responsesOperation2 := func() (*schemas.DeepIntShieldResponsesResponse, *schemas.DeepIntShieldError) {
			bfCtx := schemas.NewDeepIntShieldContext(ctx, schemas.NoDeadline)
			responsesReq := &schemas.DeepIntShieldResponsesRequest{
				Provider: testConfig.Provider,
				Model:    testConfig.ChatModel,
		...
		chatOperation3 := func() (*schemas.DeepIntShieldChatResponse, *schemas.DeepIntShieldError) {
			bfCtx := schemas.NewDeepIntShieldContext(ctx, schemas.NoDeadline)
			chatReq := &schemas.DeepIntShieldChatRequest{
				Provider: testConfig.Provider,
				Model:    model,
		...
		responsesOperation3 := func() (*schemas.DeepIntShieldResponsesResponse, *schemas.DeepIntShieldError) {
			bfCtx := schemas.NewDeepIntShieldContext(ctx, schemas.NoDeadline)
			responsesReq := &schemas.DeepIntShieldResponsesRequest{
				Provider: testConfig.Provider,
				Model:    model,
