...
func TestProviderWebSearchVersionSelection(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := anthropic.ToAnthropicResponsesRequest(ctx, deepintshieldReq)
...
func TestProviderAnthropicRequestPipeline(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Step 2: Convert deepintshield request → anthropic request
			deepintshieldReq := &schemas.DeepIntShieldResponsesRequest{
				Provider: tt.provider,
				Model:    model,
				Input: []schemas.ResponsesMessage{
...
// deepintshield tool → anthropic tool version → correct beta header
func TestComputerUseVersionAndBetaHeaderEndToEnd(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Step 1: Convert deepintshield tool → anthropic tool (selects version based on model)
			deepintshieldReq := &schemas.DeepIntShieldResponsesRequest{
				Provider: tt.provider,
				Model:    tt.model,
				Input: []schemas.ResponsesMessage{
