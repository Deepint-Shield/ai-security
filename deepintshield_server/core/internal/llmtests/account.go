// Package llmtests provides comprehensive test account and configuration management for the DeepIntShield system.
...
func (account *ComprehensiveTestAccount) GetKeysForProvider(ctx context.Context, providerKey schemas.ModelProvider) ([]schemas.Key, error) {
		...
		return []schemas.Key{
			{
				...
				Models:         []string{},
				Weight:         1.0,
				UseForBatchAPI: deepintshield.Ptr(true),
			},
		}, nil
	...
	case schemas.Vertex:
		//https://aiplatform.googleapis.com/v1/projects/<your-gcp-project>/locations/global/publishers/google/models/veo-3.1-generate-preview:fetchPredictOperation
