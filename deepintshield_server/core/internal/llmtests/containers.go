// Package llmtests provides container API test utilities for the DeepIntShield system.
package llmtests
...
func RunContainerCreateTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerCreate", func(t *testing.T) {
		...
		request := &schemas.DeepIntShieldContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "deepintshield-test-container",
		}
...
func RunContainerListTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerList", func(t *testing.T) {
		...
		request := &schemas.DeepIntShieldContainerListRequest{
			Provider: testConfig.Provider,
			Limit:    10,
		}
...
func RunContainerRetrieveTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerRetrieve", func(t *testing.T) {
		...
		createRequest := &schemas.DeepIntShieldContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "deepintshield-test-container-retrieve",
		}
...
func RunContainerDeleteTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerDelete", func(t *testing.T) {
		...
		createRequest := &schemas.DeepIntShieldContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "deepintshield-test-container-delete",
		}
...
func RunContainerUnsupportedTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunContainerFileCreateTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerFileCreate", func(t *testing.T) {
		...
		containerRequest := &schemas.DeepIntShieldContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "deepintshield-test-container-file-create",
		}
		...
		testContent := []byte("Hello, DeepIntShield! This is a test file for container file operations.")
		filePath := "/test-file.txt"

		fileCreateRequest := &schemas.DeepIntShieldContainerFileCreateRequest{
			Provider:    testConfig.Provider,
			ContainerID: containerID,
			File:        testContent,
			Path:        &filePath,
		...
		// Clean up file
		fileDeleteRequest := &schemas.DeepIntShieldContainerFileDeleteRequest{
			Provider:    testConfig.Provider,
			ContainerID: containerID,
			FileID:      response.ID,
		}
...
func RunContainerFileListTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerFileList", func(t *testing.T) {
		...
		containerRequest := &schemas.DeepIntShieldContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "deepintshield-test-container-file-list",
		}
...
func RunContainerFileRetrieveTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerFileRetrieve", func(t *testing.T) {
		...
		containerRequest := &schemas.DeepIntShieldContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "deepintshield-test-container-file-retrieve",
		}
...
func RunContainerFileContentTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerFileContent", func(t *testing.T) {
		...
		containerRequest := &schemas.DeepIntShieldContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "deepintshield-test-container-file-content",
		}
	...
	testContent := []byte("Hello, DeepIntShield! This is test content for file content retrieval.")
...
func RunContainerFileDeleteTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ContainerFileDelete", func(t *testing.T) {
		...
		containerRequest := &schemas.DeepIntShieldContainerCreateRequest{
			Provider: testConfig.Provider,
			Name:     "deepintshield-test-container-file-delete",
		}
...
func RunContainerFileUnsupportedTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
