...
func (c *EmptyResponseCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
...
func (c *MissingToolCallCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
...
func (c *MalformedToolArgsCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *WrongToolCalledCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *PartialToolCallCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *WrongToolSequenceCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *ImageNotProcessedCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *FileNotProcessedCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *GenericResponseCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *ContentValidationCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *StreamErrorCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
...
func (c *IncompleteStreamCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
	...
	if response.ChatResponse != nil {
		for i, choice := range response.ChatResponse.Choices {
			...
			if finishReason == "length" {
				...
				singleChoiceResponse := &schemas.DeepIntShieldResponse{
					ChatResponse: &schemas.DeepIntShieldChatResponse{
						Choices: []schemas.DeepIntShieldResponseChoice{choice},
					},
				}
...
func (c *EmptySpeechCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
...
func (c *EmptyTranscriptionCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	// If there's an error, let other conditions handle it
	if err != nil {
		return false, ""
	}
...
func (c *EmptyEmbeddingCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *InvalidEmbeddingDimensionCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
...
func (c *EmptyImageGenerationCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	// If there's an error, let other conditions handle it
	if err != nil {
		return false, ""
	}
...
func (c *EmptyCountTokensCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	// If there's an error, let other conditions handle it
	if err != nil {
		return false, ""
	}
...
func (c *InvalidCountTokensCondition) ShouldRetry(response *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *ResponsesEmptyCondition) ShouldRetry(response *schemas.DeepIntShieldResponsesResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	if err != nil {
		return false, ""
	}
	if response == nil {
...
func (c *ResponsesFileNotProcessedCondition) ShouldRetry(response *schemas.DeepIntShieldResponsesResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *ResponsesGenericResponseCondition) ShouldRetry(response *schemas.DeepIntShieldResponsesResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *ResponsesContentValidationCondition) ShouldRetry(response *schemas.DeepIntShieldResponsesResponse, err *schemas.DeepIntShieldError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
