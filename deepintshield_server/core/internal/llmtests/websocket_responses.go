...
func RunWebSocketResponsesTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("WebSocketResponses", func(t *testing.T) {
		...
		if provider == nil {
			t.Fatalf("provider %s not found in deepintshield client", testConfig.Provider)
		}
