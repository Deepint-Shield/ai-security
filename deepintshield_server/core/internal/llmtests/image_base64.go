...
func RunImageBase64Test(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ImageBase64", func(t *testing.T) {
		...
		validateChatBase64ImageProcessing := func(response *schemas.DeepIntShieldChatResponse, apiName string) {
			content := GetChatContent(response)
			validateBase64ImageContent(t, content, apiName)
		}

		validateResponsesBase64ImageProcessing := func(response *schemas.DeepIntShieldResponsesResponse, apiName string) {
