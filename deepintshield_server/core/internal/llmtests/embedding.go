...
func RunEmbeddingTest(t *testing.T, client *deepintshield.DeepIntShield, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("Embedding", func(t *testing.T) {
		...
		request := &schemas.DeepIntShieldEmbeddingRequest{
			...
			Params: &schemas.EmbeddingParameters{
				EncodingFormat: deepintshield.Ptr("float"),
			},
		...
		embeddingResponse, deepintshieldErr := WithEmbeddingTestRetry(t, embeddingRetryConfig, retryContext, expectations, "Embedding", func() (*schemas.DeepIntShieldEmbeddingResponse, *schemas.DeepIntShieldError) {
		...
		if deepintshieldErr != nil {
			t.Fatalf("❌ Embedding request failed after retries: %v", GetErrorMessage(deepintshieldErr))
		}
...
func validateEmbeddingSemantics(t *testing.T, response *schemas.DeepIntShieldEmbeddingResponse, testTexts []string) {
