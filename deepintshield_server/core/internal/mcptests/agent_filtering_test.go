...
func TestAgent_ToolNotInAutoExecuteList(t *testing.T) {
	...
	require.NotNil(t, finalMessage.ChatAssistantMessage)
	require.NotEmpty(t, finalMessage.ChatAssistantMessage.ToolCalls)
	assert.Equal(t, "deepintshieldInternal-calculator", *finalMessage.ChatAssistantMessage.ToolCalls[0].Function.Name)
}
...
func TestAgent_ComplexFiltering_Scenario2(t *testing.T) {
	...
	require.NotNil(t, finalMessage.ChatAssistantMessage)
	require.NotEmpty(t, finalMessage.ChatAssistantMessage.ToolCalls)
	assert.Equal(t, "deepintshieldInternal-get_weather", *finalMessage.ChatAssistantMessage.ToolCalls[0].Function.Name)
}
...
func TestAgent_FilteringWithMultipleClients(t *testing.T) {
			...
			CreateChatResponseWithToolCalls([]schemas.ChatAssistantMessageToolCall{
				{
					...
					Function: schemas.ChatAssistantMessageToolCallFunction{
						Name: schemas.Ptr("deepintshieldInternal-get_temperature"),
	...
	require.NotNil(t, finalMessage.ChatAssistantMessage)
	require.NotEmpty(t, finalMessage.ChatAssistantMessage.ToolCalls)
	assert.Equal(t, "deepintshieldInternal-get_temperature", *finalMessage.ChatAssistantMessage.ToolCalls[0].Function.Name)
}
...
func TestAgent_ToolConflictInAgentMode(t *testing.T) {
	...
	// When there's a tool name conflict, DeepIntShield should:
