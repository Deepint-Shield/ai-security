...
func TestContext_ParentChildRequestIDs(t *testing.T) {
	...
	ctx.SetValue(schemas.DeepIntShieldContextKeyRequestID, originalRequestID)

	toolCall := schemas.ChatAssistantMessageToolCall{
		ID:   schemas.Ptr("call-inspect"),
		Type: schemas.Ptr("function"),
		Function: schemas.ChatAssistantMessageToolCallFunction{
			Name:      schemas.Ptr("deepintshieldInternal-inspect_context"),
			Arguments: "{}",
		},
	}
...
func TestContext_CancellationPropagation(t *testing.T) {
	...
	if deepintshieldErr != nil {
		t.Logf("Cancellation propagated with error: %v", deepintshieldErr.Error)
	} else if result != nil {
...
func TestContext_DeadlineInheritance(t *testing.T) {
	...
	toolCall := schemas.ChatAssistantMessageToolCall{
		...
		Type: schemas.Ptr("function"),
		Function: schemas.ChatAssistantMessageToolCallFunction{
			Name:      schemas.Ptr("deepintshieldInternal-deadline_check"),
			Arguments: "{}",
		},
	}
...
func TestContext_ValueIsolation(t *testing.T) {
	...
	for i := 0; i < 3; i++ {
		...
		toolCalls = append(toolCalls, schemas.ChatAssistantMessageToolCall{
			...
			Type: schemas.Ptr("function"),
			Function: schemas.ChatAssistantMessageToolCallFunction{
				Name:      schemas.Ptr("deepintshieldInternal-value_tool"),
...
func TestContext_NestedToolCalls(t *testing.T) {
	...
	ctx := createTestContext()
	ctx.SetValue(schemas.DeepIntShieldContextKeyRequestID, "root_request_001")

	toolCall := schemas.ChatAssistantMessageToolCall{
		ID:   schemas.Ptr("call-outer"),
		Type: schemas.Ptr("function"),
		Function: schemas.ChatAssistantMessageToolCallFunction{
			Name:      schemas.Ptr("deepintshieldInternal-outer_tool"),
			Arguments: "{}",
		},
	}
...
func TestContext_TimeoutPropagation(t *testing.T) {
	...
	for i := range delays {
		toolCalls = append(toolCalls, schemas.ChatAssistantMessageToolCall{
			...
			Type: schemas.Ptr("function"),
			Function: schemas.ChatAssistantMessageToolCallFunction{
				Name:      schemas.Ptr(fmt.Sprintf("deepintshieldInternal-delay_tool_%d", i)),
				Arguments: "{}",
			},
		})
	}
	...
	if deepintshieldErr != nil {
		t.Logf("Timeout propagated with error: %v", deepintshieldErr.Error)
	} else {
		require.NotNil(t, result)
			...
			CreateChatResponseWithToolCalls([]schemas.ChatAssistantMessageToolCall{
				{
					...
					Type: schemas.Ptr("function"),
					Function: schemas.ChatAssistantMessageToolCallFunction{
						Name:      schemas.Ptr("deepintshieldInternal-id_tool"),
						Arguments: "{}",
					},
				},
			}),
...
func TestContext_CleanupOnCompletion(t *testing.T) {
	...
	for i := 0; i < 3; i++ {
		toolCall := schemas.ChatAssistantMessageToolCall{
			...
			Type: schemas.Ptr("function"),
			Function: schemas.ChatAssistantMessageToolCallFunction{
				Name:      schemas.Ptr("deepintshieldInternal-cleanup_tool"),
				Arguments: "{}",
			},
		}
...
func TestContext_ConcurrentAccess(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		toolCalls = append(toolCalls, schemas.ChatAssistantMessageToolCall{
			...
			Type: schemas.Ptr("function"),
			Function: schemas.ChatAssistantMessageToolCallFunction{
				Name:      schemas.Ptr("deepintshieldInternal-concurrent_tool"),
				Arguments: "{}",
			},
		})
	}
