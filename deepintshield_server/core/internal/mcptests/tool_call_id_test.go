...
func TestToolCallID_DuplicateIDsInParallelExecution(t *testing.T) {
	...
	require.Nil(t, deepintshieldErr, "should handle duplicate IDs without crashing")
	require.NotNil(t, result)
...
func TestToolCallID_MissingOrNilIDs(t *testing.T) {
	...
	t.Run("nil_tool_call_id", func(t *testing.T) {
		...
		if deepintshieldErr != nil {
			t.Logf("Nil ID handled with error: %v", deepintshieldErr.Error)
		} else if result != nil {
	...
	t.Run("empty_string_id", func(t *testing.T) {
		...
		if deepintshieldErr != nil {
			t.Logf("Empty ID handled with error: %v", deepintshieldErr.Error)
		} else if result != nil {
...
func TestToolCallID_SpecialCharactersInID(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			if deepintshieldErr != nil {
				t.Logf("Special char ID '%s' resulted in error: %v", tc.callID, deepintshieldErr.Error)
...
func TestToolCallID_LongIDs(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			require.Nil(t, deepintshieldErr, "should handle long IDs")
			require.NotNil(t, result)
...
func TestToolCallID_PreservationWithError(t *testing.T) {
	...
	if deepintshieldErr != nil {
		t.Logf("Error occurred (expected): %v", deepintshieldErr.Error)
	}
...
func TestToolCallID_ConsistencyAcrossRetries(t *testing.T) {
	...
	for i := 0; i < 3; i++ {
		...
		require.Nil(t, deepintshieldErr, "retry %d should succeed", i)
		require.NotNil(t, result)
		require.NotNil(t, result.ChatToolMessage)
		require.NotNil(t, result.ChatToolMessage.ToolCallID)
