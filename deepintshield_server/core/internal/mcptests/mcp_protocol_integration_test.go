...
func TestProtocol_BasicToolExecution(t *testing.T) {
	...
	require.Nil(t, deepintshieldErr, "Echo tool should succeed")
	...
	result, deepintshieldErr = deepintshield.ExecuteChatMCPTool(ctx, &toolCall)
	require.Nil(t, deepintshieldErr, "Calculator tool should succeed")
	require.NotNil(t, result, "Should have result")
...
func TestProtocol_ParallelExecution(t *testing.T) {
	...
	for _, tt := range testTools {
		t.Run(tt.name, func(t *testing.T) {
			...
			result, deepintshieldErr := deepintshield.ExecuteChatMCPTool(ctx, &toolCall)
			require.Nil(t, deepintshieldErr, "Tool should succeed")
			require.NotNil(t, result, "Should have result")
...
func TestProtocol_ErrorHandling(t *testing.T) {
	...
	t.Run("IntermittentFailure", func(t *testing.T) {
		...
		result, _ := deepintshield.ExecuteChatMCPTool(ctx, &toolCall)
	...
	t.Run("LargePayload", func(t *testing.T) {
		...
		result, deepintshieldErr := deepintshield.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, deepintshieldErr, "Large payload should succeed")
		require.NotNil(t, result, "Should have result")
...
func TestProtocol_EdgeCases(t *testing.T) {
	...
	t.Run("UnicodeText", func(t *testing.T) {
		...
		result, deepintshieldErr := deepintshield.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, deepintshieldErr, "Unicode tool should succeed")
		require.NotNil(t, result, "Should have result")
	...
	t.Run("DeeplyNested", func(t *testing.T) {
		...
		result, deepintshieldErr := deepintshield.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, deepintshieldErr, "Deeply nested tool should succeed")
		require.NotNil(t, result, "Should have result")
	...
	t.Run("EmptyResponse", func(t *testing.T) {
		...
		result, deepintshieldErr := deepintshield.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, deepintshieldErr, "Empty response tool should succeed")
		require.NotNil(t, result, "Should have result")
	...
	t.Run("NullFields", func(t *testing.T) {
		...
		result, deepintshieldErr := deepintshield.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, deepintshieldErr, "Null fields tool should succeed")
		require.NotNil(t, result, "Should have result")
	...
	t.Run("SpecialCharacters", func(t *testing.T) {
		...
		result, deepintshieldErr := deepintshield.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, deepintshieldErr, "Special chars tool should succeed")
		require.NotNil(t, result, "Should have result")
...
func getTestToolsServerPath(t *testing.T) string {
	...
	// Path from deepintshield root: examples/mcps/test-tools-server/dist/index.js
