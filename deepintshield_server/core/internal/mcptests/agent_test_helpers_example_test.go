...
func TestAgentHelpers_Example_SimpleInProcessAgent(t *testing.T) {
	...
	AssertAgentSuccess(t, result, deepintshieldErr)
...
func TestAgentHelpers_Example_SimpleAgentTestHelper(t *testing.T) {
	...
	SimpleAgentTest(
		...
		func(t *testing.T, response *schemas.DeepIntShieldChatResponse, deepintshieldErr *schemas.DeepIntShieldError, mocker *DynamicLLMMocker) {
...
func TestAgentHelpers_Example_MaxDepthLimit(t *testing.T) {
	...
	require.Nil(t, deepintshieldErr, "Should not error at max depth")
