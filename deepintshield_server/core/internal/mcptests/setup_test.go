...
// createTestContext creates a DeepIntShieldContext for testing
func createTestContext() *schemas.DeepIntShieldContext {
	return schemas.NewDeepIntShieldContext(context.Background(), schemas.NoDeadline)
}

// createTestContextWithTimeout creates a DeepIntShieldContext with timeout
func createTestContextWithTimeout(timeout time.Duration) (*schemas.DeepIntShieldContext, context.CancelFunc) {
	ctx, cancel := context.WithTimeout(context.Background(), timeout)
	return schemas.NewDeepIntShieldContext(ctx, schemas.NoDeadline), cancel
}
