...
func setupCodeModeWithSTDIOServers(t *testing.T, serverNames ...string) (*mcp.MCPManager, *deepintshield.DeepIntShield) {
	t.Helper()
	...
	for _, serverName := range serverNames {
		...
		switch serverName {
		case "temperature":
			config = GetTemperatureMCPClientConfig(deepintshieldRoot)
		...
		case "go-test-server":
			config = GetGoTestServerConfig(deepintshieldRoot)
		...
		case "edge-case-server":
			config = GetEdgeCaseServerConfig(deepintshieldRoot)
		...
		case "error-test-server":
			config = GetErrorTestServerConfig(deepintshieldRoot)
		...
		case "parallel-test-server":
			config = GetParallelTestServerConfig(deepintshieldRoot)
...
func TestCodeMode_STDIO_SingleServerBasicExecution(t *testing.T) {
	...
	_, deepintshield := setupCodeModeWithSTDIOServers(t, "test-tools-server")
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			require.Nil(t, deepintshieldErr, "execution should succeed")
...
func TestCodeMode_STDIO_MultipleServers(t *testing.T) {
	...
	_, deepintshield := setupCodeModeWithSTDIOServers(t, "test-tools-server", "temperature")
	ctx := createTestContext()
...
func TestCodeMode_STDIO_ServerFiltering(t *testing.T) {
	...
	manager, deepintshield := setupCodeModeWithSTDIOServers(t, "test-tools-server", "temperature")
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			if tc.shouldSucceed {
				...
				// Should fail - either deepintshield error or error in result
				errorFound := false
				if deepintshieldErr != nil {
					assert.Contains(t, deepintshieldErr.Error.Message, tc.expectedError)
					errorFound = true
...
func TestCodeMode_STDIO_ToolFiltering(t *testing.T) {
	...
	manager, deepintshield := setupCodeModeWithSTDIOServers(t, "test-tools-server")
...
func TestCodeMode_STDIO_EdgeCaseServer_Unicode(t *testing.T) {
	...
	_, deepintshield := setupCodeModeWithSTDIOServers(t, "edge-case-server")
	ctx := createTestContext()
...
func TestCodeMode_STDIO_ErrorTestServer_NetworkErrors(t *testing.T) {
	...
	_, deepintshield := setupCodeModeWithSTDIOServers(t, "error-test-server")
	ctx := createTestContext()
...
func TestCodeMode_STDIO_ParallelTestServer_Sequential(t *testing.T) {
	...
	_, deepintshield := setupCodeModeWithSTDIOServers(t, "parallel-test-server")
	ctx := createTestContext()
...
func TestCodeMode_STDIO_MultiServer_AllServers(t *testing.T) {
	...
	_, deepintshield := setupCodeModeWithSTDIOServers(t, "go-test-server", "edge-case-server", "error-test-server", "parallel-test-server")
	ctx := createTestContext()
...
func TestCodeMode_STDIO_MultiServer_FilteringAcrossServers(t *testing.T) {
	...
	_, deepintshield := setupCodeModeWithSTDIOServers(t, "go-test-server", "edge-case-server", "parallel-test-server")
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			if tc.shouldSucceed {
				...
				// Should fail - check either deepintshieldErr or error in result
				if deepintshieldErr == nil && result != nil && result.Content != nil && result.Content.ContentStr != nil {
