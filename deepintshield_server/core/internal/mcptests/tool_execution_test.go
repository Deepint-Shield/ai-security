...
func TestDirectToolExecution_ChatFormat(t *testing.T) {
	...
	require.Nil(t, deepintshieldErr, "tool execution should succeed")
...
func TestDirectToolExecution_ResponsesFormat(t *testing.T) {
	...
	result, deepintshieldErr := deepintshield.ExecuteResponsesMCPTool(ctx, &toolCall)
	require.Nil(t, deepintshieldErr, "tool execution should succeed")
	require.NotNil(t, result, "should have result")
...
func TestToolExecutionWithArguments(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			require.Nil(t, deepintshieldErr, "calculator execution should succeed")
			require.NotNil(t, result, "should have result")
...
func TestToolExecutionTimeout(t *testing.T) {
	...
	if deepintshieldErr != nil && deepintshieldErr.Error != nil {
		t.Logf("✅ Got expected timeout error: %v", deepintshieldErr.Error.Message)
	} else if result != nil {
...
func TestToolExecutionReturnsError(t *testing.T) {
	...
	if deepintshieldErr != nil && deepintshieldErr.Error != nil {
		assert.Contains(t, deepintshieldErr.Error.Message, errorMessage)
		t.Logf("✅ Error properly propagated: %v", deepintshieldErr.Error.Message)
...
func TestToolExecutionLargeResponse(t *testing.T) {
	...
	require.Nil(t, deepintshieldErr, "large response should not error")
...
func TestToolExecutionEmptyResponse(t *testing.T) {
	...
	require.Nil(t, deepintshieldErr, "empty response should not crash")
...
func TestToolExecutionStructuredResponse(t *testing.T) {
	...
	require.Nil(t, deepintshieldErr, "structured response should work")
	assert.NotNil(t, result, "should have result")
	...
	for i := 0; i < 5; i++ {
		...
		go func(id int) {
			...
			if deepintshieldErr != nil {
				errors <- fmt.Errorf("tool execution error: %v", deepintshieldErr)
			}
		}(i)
	}
...
func TestToolExecutionExtraFields(t *testing.T) {
	...
	// Note: ExtraFields are in DeepIntShieldMCPResponse, not ChatMessage
}
...
func TestToolExecutionPreservesCallID(t *testing.T) {
	...
	chatResult, chatErr := deepintshield.ExecuteChatMCPTool(ctx, &chatToolCall)
	...
	responsesResult, responsesErr := deepintshield.ExecuteResponsesMCPTool(ctx, &responsesToolCall)
...
func TestToolExecutionMultipleClients(t *testing.T) {
	...
	echoResult, echoErr := deepintshield.ExecuteChatMCPTool(ctx, &echoToolCall)
	...
	inProcessToolCall := schemas.ChatAssistantMessageToolCall{
		...
		Type: schemas.Ptr("function"),
		Function: schemas.ChatAssistantMessageToolCallFunction{
			Name:      schemas.Ptr("deepintshieldInternal-local_tool"),
			Arguments: string(argsJSON),
		},
	}
	localResult, localErr := deepintshield.ExecuteChatMCPTool(ctx, &inProcessToolCall)
...
func TestToolExecutionClientNotFound(t *testing.T) {
	...
	if deepintshieldErr != nil {
		t.Logf("Got expected error: %v", deepintshieldErr)
	} else if result != nil {
...
func TestToolExecutionMalformedRequest(t *testing.T) {
	...
	t.Run("nil_tool_call", func(t *testing.T) {
		result, deepintshieldErr := deepintshield.ExecuteChatMCPTool(ctx, nil)
...
func TestToolExecutionContextCancellation(t *testing.T) {
	...
	// Should be cancelled
	if deepintshieldErr != nil {
		t.Logf("Got cancellation error: %v", deepintshieldErr)
	} else if result != nil {
...
func TestToolExecutionContextDeadline(t *testing.T) {
	...
	// Should hit deadline
	if deepintshieldErr != nil {
		t.Logf("Got deadline error: %v", deepintshieldErr)
	} else if result != nil {
