...
type MCPLogEntry struct {
	Request   *schemas.DeepIntShieldMCPRequest
	Response  *schemas.DeepIntShieldMCPResponse
...
func (p *TestLoggingPlugin) PreMCPHook(ctx *schemas.DeepIntShieldContext, req *schemas.DeepIntShieldMCPRequest) (*schemas.DeepIntShieldMCPRequest, *schemas.MCPPluginShortCircuit, error) {
...
func (p *TestLoggingPlugin) PostMCPHook(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldMCPResponse, deepintshieldErr *schemas.DeepIntShieldError) (*schemas.DeepIntShieldMCPResponse, *schemas.DeepIntShieldError, error) {
...
// PreMCPHook implements schemas.MCPPlugin
func (p *TestGovernancePlugin) PreMCPHook(ctx *schemas.DeepIntShieldContext, req *schemas.DeepIntShieldMCPRequest) (*schemas.DeepIntShieldMCPRequest, *schemas.MCPPluginShortCircuit, error) {
	p.mu.RLock()
	defer p.mu.RUnlock()
...
// PostMCPHook implements schemas.MCPPlugin
func (p *TestGovernancePlugin) PostMCPHook(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldMCPResponse, deepintshieldErr *schemas.DeepIntShieldError) (*schemas.DeepIntShieldMCPResponse, *schemas.DeepIntShieldError, error) {
	// No post-processing needed for governance
	return resp, deepintshieldErr, nil
}

// extractToolName extracts tool name from request
func (p *TestGovernancePlugin) extractToolName(req *schemas.DeepIntShieldMCPRequest) string {
...
// PreMCPHook implements schemas.MCPPlugin
func (p *TestModifyRequestPlugin) PreMCPHook(ctx *schemas.DeepIntShieldContext, req *schemas.DeepIntShieldMCPRequest) (*schemas.DeepIntShieldMCPRequest, *schemas.MCPPluginShortCircuit, error) {
	p.mu.RLock()
	defer p.mu.RUnlock()
...
// PostMCPHook implements schemas.MCPPlugin
func (p *TestModifyRequestPlugin) PostMCPHook(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldMCPResponse, deepintshieldErr *schemas.DeepIntShieldError) (*schemas.DeepIntShieldMCPResponse, *schemas.DeepIntShieldError, error) {
	return resp, deepintshieldErr, nil
}
...
// PreMCPHook implements schemas.MCPPlugin
func (p *TestModifyResponsePlugin) PreMCPHook(ctx *schemas.DeepIntShieldContext, req *schemas.DeepIntShieldMCPRequest) (*schemas.DeepIntShieldMCPRequest, *schemas.MCPPluginShortCircuit, error) {
	return req, nil, nil
}

// PostMCPHook implements schemas.MCPPlugin
func (p *TestModifyResponsePlugin) PostMCPHook(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldMCPResponse, deepintshieldErr *schemas.DeepIntShieldError) (*schemas.DeepIntShieldMCPResponse, *schemas.DeepIntShieldError, error) {
	p.mu.RLock()
	defer p.mu.RUnlock()
...
// PreMCPHook implements schemas.MCPPlugin
func (p *TestShortCircuitPlugin) PreMCPHook(ctx *schemas.DeepIntShieldContext, req *schemas.DeepIntShieldMCPRequest) (*schemas.DeepIntShieldMCPRequest, *schemas.MCPPluginShortCircuit, error) {
	p.mu.RLock()
	defer p.mu.RUnlock()
...
// PostMCPHook implements schemas.MCPPlugin
func (p *TestShortCircuitPlugin) PostMCPHook(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldMCPResponse, deepintshieldErr *schemas.DeepIntShieldError) (*schemas.DeepIntShieldMCPResponse, *schemas.DeepIntShieldError, error) {
	return resp, deepintshieldErr, nil
}
