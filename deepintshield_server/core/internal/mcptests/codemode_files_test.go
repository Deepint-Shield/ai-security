...
func TestReadToolFile_Basic(t *testing.T) {
	...
	readResult, deepintshieldErr := deepintshield.ExecuteChatMCPTool(ctx, &readCall)
	require.Nil(t, deepintshieldErr)
...
func TestReadToolFile_NotFound(t *testing.T) {
	...
	result, deepintshieldErr := deepintshield.ExecuteChatMCPTool(ctx, &readCall)
	...
	if deepintshieldErr != nil {
		if deepintshieldErr.Error != nil {
			assert.Contains(t, deepintshieldErr.Error.Message, "not found")
		}
...
func TestCodeModeFiles_ResponsesFormat(t *testing.T) {
	...
	result, deepintshieldErr := deepintshield.ExecuteChatMCPTool(ctx, &listCall)
	require.Nil(t, deepintshieldErr, "listToolFiles should not error")
...
func TestCodeModeFiles_FullWorkflow(t *testing.T) {
	...
	listResult, deepintshieldErr := deepintshield.ExecuteChatMCPTool(ctx, &listCall)
	require.Nil(t, deepintshieldErr)
...
result = {"completed": True, "servers": ["TestCodeModeServer"], "methodCount": len(server_methods)}`
	...
	execResult, deepintshieldErr := deepintshield.ExecuteChatMCPTool(ctx, &execCall)
	require.Nil(t, deepintshieldErr)
