...
func TestAgent_MultiConnection_MixedPermissions(t *testing.T) {
	...
	assert.True(t, toolNames["deepintshieldInternal-calculator"], "calculator should be waiting for approval")
...
func TestAgent_MultiConnection_ErrorInSTDIO(t *testing.T) {
	...
	// Assertions
	require.Nil(t, deepintshieldErr, "Agent should not fail on tool error")
	require.NotNil(t, result)
...
func TestAgent_MultiConnection_LargeParallelBatch(t *testing.T) {
	...
	expectedTools := []string{
		...
		"deepintshieldInternal-calculator",
		"deepintshieldInternal-get_weather",
		"deepintshieldInternal-get_time",
