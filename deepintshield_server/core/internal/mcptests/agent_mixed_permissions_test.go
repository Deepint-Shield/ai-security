...
func TestAgent_MixedPermissions_WildcardAutoExecute(t *testing.T) {
	...
	AssertToolsExecutedInParallel(t, mocker, []string{"deepintshieldInternal-echo", "deepintshieldInternal-calculator", "GoTestServer-uuid_generate"}, 1)
...
func TestAgent_MixedPermissions_PartialExecution(t *testing.T) {
	...
	assert.True(t, toolNames["deepintshieldInternal-get_weather"], "weather should be waiting")
	assert.True(t, toolNames["ParallelTestServer-fast_operation"], "fast_operation should be waiting")
...
func TestAgent_MixedPermissions_ContextFilteringOverride(t *testing.T) {
	...
	manager, mocker, ctx := SetupAgentTest(t, AgentTestConfig{
		...
		MaxDepth:         5,
		// Context filtering: only allow InProcess client (deepintshieldInternal)
		ClientFiltering: []string{"deepintshieldInternal"},
	})
...
func TestAgent_MixedPermissions_SpecificToolNames(t *testing.T) {
	...
	assert.True(t, toolNames["deepintshieldInternal-calculator"], "calculator should be waiting")
	assert.True(t, toolNames["deepintshieldInternal-get_weather"], "weather should be waiting")
