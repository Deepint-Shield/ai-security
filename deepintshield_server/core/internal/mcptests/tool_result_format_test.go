...
func TestToolResult_ComplexNestedStructures(t *testing.T) {
	...
	require.Nil(t, deepintshieldErr, "should handle nested structures")
...
func TestToolResult_LargePayload(t *testing.T) {
	...
	for _, st := range sizeTests {
		t.Run(st.name, func(t *testing.T) {
			...
			if st.expected {
				require.Nil(t, deepintshieldErr, "should handle %dKB payload", targetSize)
				require.NotNil(t, result)
				...
				t.Logf("Payload size %dKB: %v", targetSize, deepintshieldErr)
			}
		})
	}
}
...
func TestToolResult_SpecialCharactersAndUnicode(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			require.Nil(t, deepintshieldErr, "should handle special characters: %s", tc.name)
			require.NotNil(t, result)
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			if deepintshieldErr != nil {
				t.Logf("Empty content (%s) resulted in error: %v", tc.name, deepintshieldErr.Error)
			} else {
				require.NotNil(t, result)
...
func TestToolResult_ArrayResults(t *testing.T) {
	...
	require.Nil(t, deepintshieldErr, "should handle array results")
	require.NotNil(t, result)
...
func TestToolResult_BothFormats_ComplexStructure(t *testing.T) {
	...
	t.Run("responses_format", func(t *testing.T) {
		...
		result, deepintshieldErr := deepintshield.ExecuteResponsesMCPTool(ctx, &toolMsg)
