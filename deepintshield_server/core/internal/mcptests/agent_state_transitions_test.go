...
func TestAgent_StateTransition_LargeMixedToolBatch(t *testing.T) {
	...
	for i := 0; i < 50; i++ {
		toolCalls = append(toolCalls, schemas.ChatAssistantMessageToolCall{
			...
			Function: schemas.ChatAssistantMessageToolCallFunction{
				Name:      schemas.Ptr(fmt.Sprintf("deepintshieldInternal-auto_tool_%d", i)),
				Arguments: "{}",
			},
		})
	}
	...
	for i := 0; i < 5; i++ {
		toolCalls = append(toolCalls, schemas.ChatAssistantMessageToolCall{
			...
			Type: schemas.Ptr("function"),
			Function: schemas.ChatAssistantMessageToolCallFunction{
				Name:      schemas.Ptr(fmt.Sprintf("deepintshieldInternal-manual_tool_%d", i)),
				Arguments: "{}",
			},
		})
	}
	...
	require.Nil(t, deepintshieldErr, "should handle large mixed batch")
...
func TestAgent_StateTransition_DepthCountingBasic(t *testing.T) {
	...
	responses := []*schemas.DeepIntShieldChatResponse{}
...
func TestAgent_StateTransition_AlternatingAutoNonAuto(t *testing.T) {
			...
			CreateChatResponseWithToolCalls([]schemas.ChatAssistantMessageToolCall{
				{
					...
					Type: schemas.Ptr("function"),
					Function: schemas.ChatAssistantMessageToolCallFunction{
						Name: schemas.Ptr("deepintshieldInternal-manual_tool"),
						Arguments: "{}",
					},
				},
			}),
	...
	if finalMessage.ChatAssistantMessage != nil && len(finalMessage.ChatAssistantMessage.ToolCalls) > 0 {
		assert.Equal(t, "deepintshieldInternal-manual_tool", *finalMessage.ChatAssistantMessage.ToolCalls[0].Function.Name)
	}
	...
	toolCalls := []schemas.ChatAssistantMessageToolCall{
		{
			...
			Type: schemas.Ptr("function"),
			Function: schemas.ChatAssistantMessageToolCallFunction{
				Name: schemas.Ptr("deepintshieldInternal-tool_0"),
				Arguments: "{}",
			},
		},
		{
			...
			Type: schemas.Ptr("function"),
			Function: schemas.ChatAssistantMessageToolCallFunction{
				Name: schemas.Ptr("deepintshieldInternal-tool_1"),
				Arguments: "{}",
			},
		},
	}
			...
			CreateChatResponseWithToolCalls([]schemas.ChatAssistantMessageToolCall{
				{
					...
					Type: schemas.Ptr("function"),
					Function: schemas.ChatAssistantMessageToolCallFunction{
						Name: schemas.Ptr("deepintshieldInternal-stateful_tool_0"),
						Arguments: "{}",
					},
				},
			}),
			CreateChatResponseWithToolCalls([]schemas.ChatAssistantMessageToolCall{
				{
					...
					Type: schemas.Ptr("function"),
					Function: schemas.ChatAssistantMessageToolCallFunction{
						Name: schemas.Ptr("deepintshieldInternal-stateful_tool_1"),
						Arguments: "{}",
					},
				},
			}),
