module github.com/deepint-shield/ai-security/tests/scripts/1millogs

go 1.26.1

require (
	github.com/deepint-shield/ai-security/core v1.2.37
	github.com/deepint-shield/ai-security/framework v0.0.0
