...
This test suite uses the Anthropic SDK to test against multiple AI providers through DeepIntShield.
...
class TestAnthropicIntegration:
    ...
    def test_12_error_handling_invalid_roles(self, anthropic_client, test_config):
        ...
        # deepintshield handles invalid roles internally so this test should not raise an exception
        response = anthropic_client.messages.create(
            model=get_model("anthropic", "chat"),
