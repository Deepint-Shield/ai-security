...
if (!process.env.DEEPINTSHIELD_BASE_URL) {
  process.env.DEEPINTSHIELD_BASE_URL = 'http://localhost:8080'
}

// Log test environment info
console.log('\n🧪 DeepIntShield TypeScript Integration Tests')
console.log('='.repeat(50))
console.log(`📍 DeepIntShield URL: ${process.env.DEEPINTSHIELD_BASE_URL}`)
...
export const testEnvironment = {
  deepintshieldUrl: process.env.DEEPINTSHIELD_BASE_URL,
