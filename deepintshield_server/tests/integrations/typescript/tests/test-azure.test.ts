/**
 * Azure OpenAI SDK Integration Tests - Azure Provider via DeepIntShield
 *
 * This test suite uses the AzureOpenAI SDK to test against Azure through DeepIntShield.
 ...
 *   uses the model as deployment-id in the URL path, and DeepIntShield's AzureEndpointPreHook
