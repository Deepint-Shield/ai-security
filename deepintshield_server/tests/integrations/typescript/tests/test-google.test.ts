 ...
 * through DeepIntShield. To test Google models through DeepIntShield, use the OpenAI SDK with
...
function getGoogleClient(): GoogleGenerativeAI {
  // Note: The @google/generative-ai SDK does not support custom base URL configuration.
  // Unlike OpenAI and Anthropic SDKs, requests cannot be routed through DeepIntShield directly.
  // These tests validate the Google GenAI SDK directly against Google's API.
  // To test Google models through DeepIntShield, use the OpenAI SDK with model name routing
