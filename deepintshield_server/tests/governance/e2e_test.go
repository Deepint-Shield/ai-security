...
// TestVirtualKeyHeaderFormats verifies that DeepIntShield accepts all documented VK header formats
// Reference: https://deepintshield.com/features/governance/virtual-keys
// Supported headers:
//   - x-bf-vk: Virtual key header (DeepIntShield native)
...
func TestVirtualKeyHeaderFormats(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			headerName:   "x-bf-vk",
			headerValue:  vkValue,
			description:  "DeepIntShield native VK header",
			expectedPass: true,
		},
		{
