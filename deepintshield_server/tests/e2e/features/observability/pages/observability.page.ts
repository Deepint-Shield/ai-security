...
export type ObservabilityConnector = 'otel' | 'prometheus' | 'datadog' | 'bigquery' | 'newrelic'
...
export class ObservabilityPage extends BasePage {
  ...
  async getCurrentState(): Promise<ObservabilityState> {
    ...
    const connectors: ObservabilityConnector[] = ['otel', 'prometheus', 'datadog', 'bigquery', 'newrelic']
