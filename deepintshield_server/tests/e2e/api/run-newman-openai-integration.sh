...
# DeepIntShield OpenAI Integration API Newman Test Runner
...
# Configuration
COLLECTION="deepintshield-openai-integration.postman_collection.json"
...
if [ "$ci_normalized" = "1" ] || [ "$ci_normalized" = "true" ]; then
    echo -e "${GREEN}DeepIntShield OpenAI Integration API Test Runner with retries: 10${NC}"
else
    echo -e "${GREEN}DeepIntShield OpenAI Integration API Test Runner${NC}"
fi
echo -e "${GREEN}========================================${NC}"
echo ""
