...
# DeepIntShield Composite Integrations API Newman Test Runner
...
# Configuration
COLLECTION="deepintshield-composite-integrations.postman_collection.json"
...
if [ "$ci_normalized" = "1" ] || [ "$ci_normalized" = "true" ]; then
    echo -e "${GREEN}DeepIntShield Composite Integrations API Test Runner with retries: 10${NC}"
else
    echo -e "${GREEN}DeepIntShield Composite Integrations API Test Runner${NC}"
fi
echo -e "${GREEN}========================================${NC}"
echo ""
