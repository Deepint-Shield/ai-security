...
// accumulation for plugins (logging). This eliminates storing 1M+ DeepIntShieldResponse
// objects in the old accumulator at high concurrency.
func (s *TraceStore) AppendStreamingChunk(traceID string, chunk *schemas.DeepIntShieldResponse) {
	if chunk == nil {
		return
	}
