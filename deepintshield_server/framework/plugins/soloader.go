...
func (l *SharedObjectPluginLoader) LoadPlugin(path string, config any) (schemas.BasePlugin, error) {
	...
	if dp.getName, ok = getNameSym.(func() string); !ok {
		return nil, fmt.Errorf("failed to cast GetName to func() string\nSee docs for more information: https://deepintshield.com/plugins/writing-go-plugin")
	}
	...
	if sym, err := pluginObj.Lookup("HTTPTransportPreHook"); err == nil {
		if dp.httpTransportPreHook, ok = sym.(func(ctx *schemas.DeepIntShieldContext, req *schemas.HTTPRequest) (*schemas.HTTPResponse, error)); !ok {
	...
	if sym, err := pluginObj.Lookup("HTTPTransportPostHook"); err == nil {
		if dp.httpTransportPostHook, ok = sym.(func(ctx *schemas.DeepIntShieldContext, req *schemas.HTTPRequest, resp *schemas.HTTPResponse) error); !ok {
	...
	if sym, err := pluginObj.Lookup("HTTPTransportStreamChunkHook"); err == nil {
		if dp.httpTransportStreamChunkHook, ok = sym.(func(ctx *schemas.DeepIntShieldContext, req *schemas.HTTPRequest, chunk *schemas.DeepIntShieldStreamChunk) (*schemas.DeepIntShieldStreamChunk, error)); !ok {
	...
	if sym, err := pluginObj.Lookup("PreLLMHook"); err == nil {
		if dp.preLLMHook, ok = sym.(func(ctx *schemas.DeepIntShieldContext, req *schemas.DeepIntShieldRequest) (*schemas.DeepIntShieldRequest, *schemas.LLMPluginShortCircuit, error)); !ok {
	...
	if sym, err := pluginObj.Lookup("PostLLMHook"); err == nil {
		if dp.postLLMHook, ok = sym.(func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldResponse, deepintshieldErr *schemas.DeepIntShieldError) (*schemas.DeepIntShieldResponse, *schemas.DeepIntShieldError, error)); !ok {
	...
	if sym, err := pluginObj.Lookup("PreMCPHook"); err == nil {
		if dp.preMCPHook, ok = sym.(func(ctx *schemas.DeepIntShieldContext, req *schemas.DeepIntShieldMCPRequest) (*schemas.DeepIntShieldMCPRequest, *schemas.MCPPluginShortCircuit, error)); !ok {
	...
	if sym, err := pluginObj.Lookup("PostMCPHook"); err == nil {
		if dp.postMCPHook, ok = sym.(func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldMCPResponse, deepintshieldErr *schemas.DeepIntShieldError) (*schemas.DeepIntShieldMCPResponse, *schemas.DeepIntShieldError, error)); !ok {
