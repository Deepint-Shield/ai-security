...
type TableMCPClient struct {
	...
	TenantID               string          `gorm:"column:tenant_id;type:varchar(255);index;uniqueIndex:idx_mcp_tenant_workspace_client_id;uniqueIndex:idx_mcp_tenant_workspace_name" json:"-"`
	WorkspaceID            *string         `gorm:"column:workspace_id;type:varchar(255);index;uniqueIndex:idx_mcp_tenant_workspace_client_id;uniqueIndex:idx_mcp_tenant_workspace_name" json:"workspace_id,omitempty"` // Per-workspace scoping - two workspaces under the same tenant can register the same MCP client name without colliding.
	ClientID               string          `gorm:"type:varchar(255);not null;uniqueIndex:idx_mcp_tenant_workspace_client_id" json:"client_id"`
	Name                   string          `gorm:"type:varchar(255);not null;uniqueIndex:idx_mcp_tenant_workspace_name" json:"name"`
