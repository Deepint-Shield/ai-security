...
type TableModelConfig struct {
	...
	TenantID    string  `gorm:"column:tenant_id;type:varchar(255);uniqueIndex:idx_model_tenant_provider" json:"-"`
	...
	ModelName   string  `gorm:"type:varchar(255);not null;uniqueIndex:idx_model_tenant_provider" json:"model_name"`
	Provider    *string `gorm:"type:varchar(50);uniqueIndex:idx_model_tenant_provider" json:"provider,omitempty"` // Optional provider, nullable
