...
const (
	EnableStreamingJSONParser schemas.DeepIntShieldContextKey = "enable-streaming-json-parser"
)
...
func (p *JsonParserPlugin) HTTPTransportPreHook(ctx *schemas.DeepIntShieldContext, req *schemas.HTTPRequest) (*schemas.HTTPResponse, error) {
	return nil, nil
}

// HTTPTransportPostHook is not used for this plugin
func (p *JsonParserPlugin) HTTPTransportPostHook(ctx *schemas.DeepIntShieldContext, req *schemas.HTTPRequest, resp *schemas.HTTPResponse) error {
	return nil
}

// HTTPTransportStreamChunkHook passes through streaming chunks unchanged
func (p *JsonParserPlugin) HTTPTransportStreamChunkHook(ctx *schemas.DeepIntShieldContext, req *schemas.HTTPRequest, chunk *schemas.DeepIntShieldStreamChunk) (*schemas.DeepIntShieldStreamChunk, error) {
	return chunk, nil
}
...
func (p *JsonParserPlugin) PreLLMHook(ctx *schemas.DeepIntShieldContext, req *schemas.DeepIntShieldRequest) (*schemas.DeepIntShieldRequest, *schemas.LLMPluginShortCircuit, error) {
	return req, nil, nil
}
...
//   - error: Any error that occurred during processing
func (p *JsonParserPlugin) PostLLMHook(ctx *schemas.DeepIntShieldContext, result *schemas.DeepIntShieldResponse, err *schemas.DeepIntShieldError) (*schemas.DeepIntShieldResponse, *schemas.DeepIntShieldError, error) {
	...
	resultCopy := p.deepCopyDeepIntShieldResponse(result)
						...
						if !p.isValidJSON(fixedContent) {
							err = &schemas.DeepIntShieldError{
								...
								StreamControl: &schemas.StreamControl{
									SkipStream: deepintshield.Ptr(true),
								},
							}
	...
	if streamEndIndicatorValue := ctx.Value(schemas.DeepIntShieldContextKeyStreamEndIndicator); streamEndIndicatorValue != nil {
