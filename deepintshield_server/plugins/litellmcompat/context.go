...
// TransformContextKey is the key used to store TransformContext in DeepIntShieldContext
const TransformContextKey schemas.DeepIntShieldContextKey = "litellmcompat-transform-context"
