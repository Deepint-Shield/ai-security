...
// convertTraceToResourceSpan converts a DeepIntShield trace to OTEL ResourceSpan
...
// convertSpanToOTELSpan converts a single DeepIntShield span to OTEL format
...
func (p *OtelPlugin) getResourceAttributes() []*KeyValue {
	attrs := []*KeyValue{
		...
		kvStr("service.version", p.deepintshieldVersion),
		kvStr("telemetry.sdk.name", "deepintshield"),
...
func (p *OtelPlugin) getInstrumentationScope() *commonpb.InstrumentationScope {
	return &commonpb.InstrumentationScope{
		Name:    p.serviceName,
		Version: p.deepintshieldVersion,
	}
}
...
// convertSpanKind maps DeepIntShield SpanKind to OTEL SpanKind
...
// convertSpanStatus maps DeepIntShield SpanStatus to OTEL Status
...
// convertSpanEvents converts DeepIntShield span events to OTEL events
