//! Type definitions for DeepIntShield WASM plugins.
...
mod nullable {
    ...
    /// Deserialize a DeepIntShieldContext that may be null, converting null to default.
    pub fn context<'de, D>(deserializer: D) -> Result<super::DeepIntShieldContext, D::Error>
    where
        D: Deserializer<'de>,
    {
        Option::<super::DeepIntShieldContext>::deserialize(deserializer).map(|opt| opt.unwrap_or_default())
    }
}
...
/// DeepIntShieldContext holds request-scoped values passed between hooks.
...
#[serde(transparent)]
pub struct DeepIntShieldContext(pub HashMap<String, serde_json::Value>);

impl DeepIntShieldContext {
    pub fn new() -> Self {
        Self(HashMap::new())
    }
...
pub struct HTTPInterceptInput {
    ...
    pub context: DeepIntShieldContext,
...
// =============================================================================
// Chat Completion Structures (DeepIntShieldRequest)
// =============================================================================
...
/// DeepIntShieldChatRequest represents a chat completion request.
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct DeepIntShieldChatRequest {
    #[serde(default)]
    pub provider: String,
...
/// DeepIntShieldRequest is the unified request structure.
/// Only one of the request types should be present.
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct DeepIntShieldRequest {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub chat_request: Option<DeepIntShieldChatRequest>,
...
// =============================================================================
// Response Structures (DeepIntShieldResponse)
// =============================================================================
...
/// DeepIntShieldChatResponse represents a chat completion response.
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct DeepIntShieldChatResponse {
    #[serde(default)]
    pub id: String,
...
/// DeepIntShieldResponse is the unified response structure.
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct DeepIntShieldResponse {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub chat_response: Option<DeepIntShieldChatResponse>,
...
/// DeepIntShieldError represents an error response.
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct DeepIntShieldError {
    #[serde(default)]
...
pub struct LLMPluginShortCircuit {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub response: Option<DeepIntShieldResponse>,

    #[serde(skip_serializing_if = "Option::is_none")]
    pub error: Option<DeepIntShieldError>,
}
...
impl PreHookInput {
    /// Parse the request as a DeepIntShieldRequest
    pub fn parse_request(&self) -> Option<DeepIntShieldRequest> {
...
impl PostHookInput {
    /// Parse the response as a DeepIntShieldResponse
    pub fn parse_response(&self) -> Option<DeepIntShieldResponse> {
        serde_json::from_value(self.response.clone()).ok()
    }

    /// Parse the error as a DeepIntShieldError
    pub fn parse_error(&self) -> Option<DeepIntShieldError> {
        if self.has_error {
...
pub struct HTTPStreamChunkHookInput {
    ...
    #[serde(default)]
    pub chunk: serde_json::Value, // DeepIntShieldStreamChunk as JSON
}
...
pub struct HTTPStreamChunkHookOutput {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub chunk: Option<serde_json::Value>, // DeepIntShieldStreamChunk as JSON, None to skip
...
mod tests {
    ...
    fn test_context_serialization() {
        let mut ctx = DeepIntShieldContext::new();
    ...
    fn test_context_deserialization() {
        ...
        let ctx: DeepIntShieldContext = serde_json::from_str(json).unwrap();
    ...
    #[test]
    fn test_deepintshield_error() {
        let error = DeepIntShieldError::new("Test error")
            .with_type("test_type")
            .with_code("500")
            .with_status(500);
