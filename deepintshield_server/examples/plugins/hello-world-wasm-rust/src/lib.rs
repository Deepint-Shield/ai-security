//! DeepIntShield WASM Plugin for Rust
//!
...
/// Called at the HTTP layer before request enters DeepIntShield core.
...
#[allow(dead_code)]
fn should_rate_limit(_context: &DeepIntShieldContext) -> bool {
