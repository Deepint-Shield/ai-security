...
- **HTTPTransportPreHook**: Intercepts HTTP requests before they enter DeepIntShield core
...
- **HTTPTransportPostHook**: Intercepts HTTP responses after DeepIntShield core processing
...
Add to your DeepIntShield config:
...
- Works only when using deepintshield-http, not when using DeepIntShield as a Go SDK
