  ...
  if (!isVisible) {
    return (
      <button
        ...
        className="fixed right-4 bottom-4 z-50 flex h-10 w-10 items-center justify-center rounded-full bg-zinc-900 text-foreground shadow-lg transition-all hover:bg-zinc-800"
