...
export const SdkIcons = {
	DeepIntShield: (props: IconProps) => (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="24" height="24" fill="none" {...props}>
			<rect x="5" y="5" width="54" height="54" rx="18" fill="url(#deepintshield-icon-bg)" />
			<path d="M18 17H31.5C39.232 17 45.5 23.268 45.5 31C45.5 38.732 39.232 45 31.5 45H18V17Z" fill="currentColor" fillOpacity="0.94" />
			<path d="M24.5 24H33.5C37.09 24 40 26.91 40 30.5C40 34.09 37.09 37 33.5 37H24.5V24Z" fill="#0C111C" />
			<path d="M19 24H28V31H19V24Z" fill="#0C111C" />
			<path d="M19 33H30V40H19V33Z" fill="#0C111C" />
			<path d="M35.5 19L47 30.5L35.5 42" stroke="#A7F3D0" strokeWidth="4.5" strokeLinecap="round" strokeLinejoin="round" />
			<defs>
				<linearGradient id="deepintshield-icon-bg" x1="9" y1="8" x2="55" y2="58" gradientUnits="userSpaceOnUse">
					<stop stopColor="#17353F" />
