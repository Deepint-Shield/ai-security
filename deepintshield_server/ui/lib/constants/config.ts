...
export const ModelPlaceholders = {
	...
	fireworks: "e.g. accounts/fireworks/models/llama-v3p1-70b-instruct, accounts/fireworks/models/qwen3-235b-a22b",
	"opencode-go": "e.g. claude-sonnet-4, claude-haiku-4, grok-code. Leave blank for all models.",
	"opencode-zen": "e.g. claude-sonnet-4, claude-haiku-4, grok-code. Leave blank for all models.",
};
