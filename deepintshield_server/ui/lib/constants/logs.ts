...
export const RequestTypes = [
	// Agentic activity (PDP tool/agent decisions surfaced in AI Logs).
	"agentic.tool",
	"agentic.agent",
	"list_models",
	"text_completion",
...
export const RequestTypeColors = {
	// Agentic activity (PDP tool/agent decisions surfaced in AI Logs).
	"agentic.tool": "bg-violet-100 text-violet-800",
	"agentic.agent": "bg-indigo-100 text-indigo-800",
...
export const GuardrailStatusLabels: Record<string, string> = {
	allow: "Allow",
	deny: "Deny",
