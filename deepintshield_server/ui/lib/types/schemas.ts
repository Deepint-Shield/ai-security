...
export const modelProviderKeySchema = z
	.object({
		...
		use_for_cache: z.boolean().optional(),
	})
	.refine(
		(data) => {
...
export const cacheConfigSchema = z.object({
	...
	conversation_history_threshold: z.number().min(0).optional(),
	exclude_system_prompt: z.boolean().optional(),
	cache_by_model: z.boolean().default(false),
	cache_by_provider: z.boolean().default(false),
	auto_scope_enabled: z.boolean().optional(),
	auto_scope_mode: z.enum(["conservative", "balanced", "aggressive"]).optional(),
	shared_vk_policy: z.enum(["exact_only_when_unscoped", "allow_semantic_when_unscoped"]).optional(),
	scope_signal_order: z.array(z.string()).optional(),
	metadata_scope_keys: z.array(z.string()).optional(),
...
export const coreConfigSchema = z.object({
	...
	mcp_cache_enabled: z.boolean().default(true),
	mcp_cache_ttl_seconds: z.number().min(0).default(300),
});

// DeepIntShield config schema
export const deepintshieldConfigSchema = z.object({
...
export const prometheusConfigSchema = z
	.object({
		...
		job_name: z.string().default("deepintshield"),
