...
export function ProviderUsageTab({
	...
	const providerCostTotals = useMemo(
		() => getProviderCostHistogramTotals(providerCostData, providerCostProvider),
				...
				headerActions={
					<div className={COST_CHART_HEADER_ACTIONS_CLASS}>
						...
						<div className={COST_CHART_HEADER_SUMMARY_ROW_CLASS}>
							...
							<CostHeaderSummary
								totalCost={providerCostTotals.totalCost}
								totalSavings={providerCostTotals.totalSavings}
								testIdPrefix="dashboard-provider-cost-summary"
								className="ml-auto"
							/>
						</div>
					</div>
