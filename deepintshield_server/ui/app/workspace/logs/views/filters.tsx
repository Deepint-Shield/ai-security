...
export function LogFilters({ filters, onFiltersChange, liveEnabled, onLiveToggle, fetchLogs, fetchStats }: LogFiltersProps) {
	...
	return (
		<div className="flex items-center justify-between space-x-2">
			...
			<div className="border-border bg-slate-50 dark:bg-zinc-900 flex h-7.5 flex-1 items-center gap-2 rounded-sm border">
				<Search className="mr-0.5 ml-2 size-4 text-black/70 dark:text-foreground/70" />
				<Input
					type="text"
					className="!h-7 rounded-tl-none rounded-tr-sm rounded-br-sm rounded-bl-none border-none bg-slate-50 text-black placeholder:text-black/60 caret-black shadow-none outline-none focus-visible:ring-0 dark:bg-zinc-900 dark:text-foreground dark:placeholder:text-foreground/60 dark:caret-white"
