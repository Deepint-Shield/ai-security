...
import {
	DeepIntShieldVideoDownloadOutput,
	DeepIntShieldVideoGenerationOutput,
	DeepIntShieldVideoListOutput,
} from "@/lib/types/logs";
...
type VideoOutput = DeepIntShieldVideoGenerationOutput | DeepIntShieldVideoDownloadOutput;

interface VideoViewProps {
	videoInput?: VideoGenerationInput;
	videoOutput?: VideoOutput;
	videoListOutput?: DeepIntShieldVideoListOutput;
	requestType?: string;
}
...
export default function VideoView({ videoInput, videoOutput, videoListOutput, requestType }: VideoViewProps) {
	...
	const downloadOutput =
		isDownload && videoOutput ? (videoOutput as DeepIntShieldVideoDownloadOutput) : null;
	const generationOutput =
		!isDownload && videoOutput ? (videoOutput as DeepIntShieldVideoGenerationOutput) : null;
