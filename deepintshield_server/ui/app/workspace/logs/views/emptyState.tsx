...
client = openai.OpenAI(
    ...
    api_key="dummy-api-key" # Handled by DeepIntShield
)
...
const openai = new OpenAI({
  ...
  apiKey: "dummy-api-key", // Handled by DeepIntShield
});
...
const genAI = new GoogleGenerativeAI("dummy-api-key", { // Handled by DeepIntShield
...
# Initialize ChatOpenAI with DeepIntShield
llm = ChatOpenAI(
    model="gpt-4o-mini",
    api_key="dummy-api-key",  # Handled by DeepIntShield
...
const llm = new ChatOpenAI({
  model: "gpt-4o-mini",
  openAIApiKey: "dummy-api-key", // Handled by DeepIntShield
  clientOptions: {
...
const result = await chain.invoke({ input: "What is LangChain?" });`,
	...
	return (
		<div className="flex w-full flex-col items-center justify-center space-y-8 bg-transparent">
			{error && (
				<Alert>
