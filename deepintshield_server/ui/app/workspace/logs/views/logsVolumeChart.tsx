	...
	return (
		<ResponsiveContainer width="100%" height="100%">
			...
			>
				...
				<XAxis dataKey="name" tick={{ fontSize: 13, fill: "var(--chart-axis)", dy: 5 }} tickLine={false} axisLine={false} />
				<YAxis tick={{ fontSize: 13, fill: "var(--chart-axis)" }} tickLine={false} axisLine={false} width={40} domain={[0, 1]} />
			</BarChart>
		</ResponsiveContainer>
	);
}
		...
		<div className="dashboard-chart-tooltip">
			...
			<div className="space-y-1 text-sm">
				<div className="mt-2 flex items-center justify-between gap-4">
					...
					<span className="dashboard-chart-tooltip-value">{data.count.toLocaleString()}</span>
				</div>
