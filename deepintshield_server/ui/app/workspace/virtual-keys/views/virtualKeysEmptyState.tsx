...
const VIRTUAL_KEYS_DOCS_URL = "https://deepintshield.com";
		...
		>
			...
			<div className="flex flex-col gap-1">
				...
				<div className="text-muted-foreground mx-auto mt-2 max-w-[600px] text-sm font-normal">
					Create virtual keys to assign permissions, spending limits, and usage quotas to teams, members, or API clients.
				</div>
				<div className="mx-auto mt-6 flex flex-row flex-wrap items-center justify-center gap-2">
					<Button
						...
						onClick={() => {
							window.open(`${VIRTUAL_KEYS_DOCS_URL}?utm_source=deepintshield_ui`, "_blank", "noopener,noreferrer");
						}}
					>
