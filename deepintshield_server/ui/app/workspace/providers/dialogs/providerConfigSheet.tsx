				...
				<div className="w-full rounded-sm border">
					<Tabs defaultValue={tabs[0]?.id} value={selectedTab} onValueChange={setSelectedTab} className="space-y-6">
						<div className="custom-scrollbar mb-4 w-full overflow-x-auto">
							<TabsList
								className="grid h-auto min-w-[720px] w-full rounded-tl-sm rounded-tr-sm rounded-br-none rounded-bl-none"
							...
							>
								{tabs.map((tab) => (
									<TabsTrigger
										...
										className="w-full px-3 text-center whitespace-normal"
									>
										{tab.label}
									</TabsTrigger>
								))}
