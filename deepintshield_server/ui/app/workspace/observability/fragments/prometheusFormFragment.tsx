	...
	const form = useForm<PrometheusFormSchema, any, PrometheusFormSchema>({
		...
		defaultValues: {
			...
			prometheus_config: {
				...
				job_name: initialConfig?.job_name ?? "deepintshield",
					...
					<div className="bg-muted/50 rounded-md p-4">
						<div className="flex items-center justify-between">
							<div className="flex flex-col gap-1">
								...
								<code className="text-muted-foreground text-xs">{metricsEndpoint || "http://<deepintshield-host>:<port>/metrics"}</code>
							</div>
							{metricsEndpoint && (
						...
						<p className="text-muted-foreground mt-2 text-xs">
							Configure your Prometheus server to scrape this endpoint. This is always available when DeepIntShield is running.
						</p>
					</div>
				</div>
				...
				<div className="space-y-4 border-t pt-4">
					...
					<Alert variant="info">
						...
						<AlertDescription className="text-xs">
							If you are running multiple DeepIntShield nodes, use push gateway for accurate metrics. Pull-based /metrics scraping may miss
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Input placeholder="deepintshield" disabled={!hasPrometheusAccess} {...field} />
										</FormControl>
											...
											<Tooltip>
												...
												<TooltipContent>
													<p className="max-w-xs text-xs">
														Used to identify this DeepIntShield instance in metrics. If not set, hostname is used automatically.
													</p>
												</TooltipContent>
											</Tooltip>
										</TooltipProvider>
