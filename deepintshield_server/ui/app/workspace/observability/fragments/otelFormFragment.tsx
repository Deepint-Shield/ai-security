...
export function OtelFormFragment({
	...
	const form = useForm<OtelFormSchema, any, OtelFormSchema>({
		...
		defaultValues: {
			...
			otel_config: {
				service_name: initialConfig?.service_name ?? "deepintshield",
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem className="w-full">
									...
									<FormDescription>If kept empty, the service name will be set to "deepintshield"</FormDescription>
									<FormControl>
										<Input placeholder="deepintshield" disabled={!hasOtelAccess} {...field} />
									</FormControl>
									<FormMessage />
								</FormItem>
							)}
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem className="w-full">
											...
											<FormDescription>
												File path to the CA certificate on the DeepIntShield runtime. Leave empty to use system root CAs.
											</FormDescription>
											<FormControl>
