...
This file contains comprehensive tests for the DeepIntShield configuration system,
...
type MockConfigStore struct {
	// Embed the interface so newly-added ConfigStore methods (e.g. the agentic
	// analytics/cache batch) don't break the mock build. The explicit methods
	// below override anything the tests actually exercise; unexercised methods
	// fall through to the (nil) embed and are never called.
	...
	scimProviderConfig  *tables.TableSCIMProviderConfig
	scimProviderConfigs map[string]*tables.TableSCIMProviderConfig
	scimLoginStates     map[string]*tables.TableSCIMLoginState
	users               map[string]*tables.TableAuthUser
	userIDs             map[string]*tables.TableAuthUser
	userInvitations     map[string]*tables.TableUserInvitation
	verificationTokens  map[string]*tables.TableEmailVerificationToken
...
func NewMockConfigStore() *MockConfigStore {
	return &MockConfigStore{
		...
		scimProviderConfigs: make(map[string]*tables.TableSCIMProviderConfig),
		scimLoginStates:     make(map[string]*tables.TableSCIMLoginState),
		users:               make(map[string]*tables.TableAuthUser),
		userIDs:             make(map[string]*tables.TableAuthUser),
		userInvitations:     make(map[string]*tables.TableUserInvitation),
		verificationTokens:  make(map[string]*tables.TableEmailVerificationToken),
...
func (m *MockConfigStore) CreateUserInvitation(ctx context.Context, invitation *tables.TableUserInvitation) error {
	m.userInvitations[invitation.ID] = invitation
	return nil
}
...
func (m *MockConfigStore) GetTeamMembers(ctx context.Context, teamID string) ([]tables.TableAuthUser, error) {
	return nil, nil
}

func (m *MockConfigStore) ReplaceTeamMembers(ctx context.Context, teamID string, userIDs []string, tx ...*gorm.DB) error {
	return nil
}

func (m *MockConfigStore) ReplaceTeamCustomerMembers(ctx context.Context, teamID string, customerIDs []string, tx ...*gorm.DB) error {
	return nil
}

func (m *MockConfigStore) DeleteTeamMembersByUserID(ctx context.Context, userID string, tx ...*gorm.DB) error {
	return nil
}
...
func (m *MockConfigStore) ReplaceVirtualKeyGuardrailPolicies(ctx context.Context, virtualKeyID string, policyIDs []string, tx ...*gorm.DB) error {
	return nil
}
...
// Auth config
// Organization CRUD
func (m *MockConfigStore) CreateOrganization(ctx context.Context, org *tables.TableOrganization) error {
	return nil
}
func (m *MockConfigStore) GetOrganizationByID(ctx context.Context, id string) (*tables.TableOrganization, error) {
	return nil, nil
}
func (m *MockConfigStore) GetOrganizationBySlug(ctx context.Context, slug string) (*tables.TableOrganization, error) {
	return nil, nil
}
func (m *MockConfigStore) GetOrganizationsByOwnerID(ctx context.Context, ownerID string) ([]tables.TableOrganization, error) {
	return nil, nil
}
func (m *MockConfigStore) UpdateOrganization(ctx context.Context, org *tables.TableOrganization) error {
	return nil
}
func (m *MockConfigStore) DeleteOrganization(ctx context.Context, id string) error { return nil }
func (m *MockConfigStore) ListOrganizations(ctx context.Context) ([]tables.TableOrganization, error) {
	return nil, nil
}

// Governance org (top of the 3-tier hierarchy) - stub methods so the
// mock satisfies the ConfigStore interface. Tests in this package don't
// exercise governance-org code paths; these return zero values.
func (m *MockConfigStore) CreateGovernanceOrg(ctx context.Context, org *tables.TableGovernanceOrg) error {
	return nil
}
func (m *MockConfigStore) GetGovernanceOrgByID(ctx context.Context, id string) (*tables.TableGovernanceOrg, error) {
	return nil, nil
}
func (m *MockConfigStore) GetGovernanceOrgBySlug(ctx context.Context, slug string) (*tables.TableGovernanceOrg, error) {
	return nil, nil
}
func (m *MockConfigStore) ListGovernanceOrgsByMember(ctx context.Context, userID string) ([]tables.TableGovernanceOrg, error) {
	return nil, nil
}
func (m *MockConfigStore) ListTenantsByGovernanceOrg(ctx context.Context, orgID string) ([]tables.TableOrganization, error) {
	return nil, nil
}
func (m *MockConfigStore) CreateGovernanceOrgMembership(ctx context.Context, mb *tables.TableGovernanceOrgMembership) error {
	return nil
}
func (m *MockConfigStore) GetGovernanceOrgMembership(ctx context.Context, orgID, userID string) (*tables.TableGovernanceOrgMembership, error) {
	return nil, nil
}

func (m *MockConfigStore) CreateWorkspace(ctx context.Context, ws *tables.TableWorkspace) error {
	return nil
}
func (m *MockConfigStore) GetWorkspaceByID(ctx context.Context, id string) (*tables.TableWorkspace, error) {
	return nil, nil
}
func (m *MockConfigStore) GetWorkspaceBySlug(ctx context.Context, orgID, slug string) (*tables.TableWorkspace, error) {
	return nil, nil
}
func (m *MockConfigStore) GetDefaultWorkspaceForOrg(ctx context.Context, orgID string) (*tables.TableWorkspace, error) {
	return nil, nil
}
func (m *MockConfigStore) ListWorkspacesByOrg(ctx context.Context, orgID string) ([]tables.TableWorkspace, error) {
	return nil, nil
}
func (m *MockConfigStore) ListWorkspacesByUser(ctx context.Context, userID string) ([]tables.TableWorkspace, error) {
	return nil, nil
}
func (m *MockConfigStore) UpdateWorkspace(ctx context.Context, ws *tables.TableWorkspace) error {
	return nil
}
func (m *MockConfigStore) DeleteWorkspace(ctx context.Context, id string) error { return nil }

func (m *MockConfigStore) CreateOrgMembership(ctx context.Context, mem *tables.TableOrgMembership) error {
	return nil
}
func (m *MockConfigStore) GetOrgMembership(ctx context.Context, orgID, userID string) (*tables.TableOrgMembership, error) {
	return nil, nil
}
func (m *MockConfigStore) ListOrgMembershipsByOrg(ctx context.Context, orgID string) ([]tables.TableOrgMembership, error) {
	return nil, nil
}
func (m *MockConfigStore) ListOrgMembershipsByUser(ctx context.Context, userID string) ([]tables.TableOrgMembership, error) {
	return nil, nil
}
func (m *MockConfigStore) UpdateOrgMembershipRole(ctx context.Context, orgID, userID, role string) error {
	return nil
}
func (m *MockConfigStore) DeleteOrgMembership(ctx context.Context, orgID, userID string) error {
	return nil
}

func (m *MockConfigStore) CreateWorkspaceMembership(ctx context.Context, mem *tables.TableWorkspaceMembership) error {
	return nil
}
func (m *MockConfigStore) GetWorkspaceMembership(ctx context.Context, workspaceID, userID string) (*tables.TableWorkspaceMembership, error) {
	return nil, nil
}
func (m *MockConfigStore) ListWorkspaceMembershipsByWorkspace(ctx context.Context, workspaceID string) ([]tables.TableWorkspaceMembership, error) {
	return nil, nil
}
func (m *MockConfigStore) ListWorkspaceMembershipsByUser(ctx context.Context, userID string) ([]tables.TableWorkspaceMembership, error) {
	return nil, nil
}
func (m *MockConfigStore) UpdateWorkspaceMembershipRole(ctx context.Context, workspaceID, userID, role string) error {
	return nil
}
func (m *MockConfigStore) DeleteWorkspaceMembership(ctx context.Context, workspaceID, userID string) error {
	return nil
}

func (m *MockConfigStore) EnsureWorkspaceBackfill(ctx context.Context) error { return nil }

func (m *MockConfigStore) CreateWorkspaceAPIKey(ctx context.Context, key *tables.TableWorkspaceAPIKey) error {
	return nil
}
func (m *MockConfigStore) GetWorkspaceAPIKeyByHash(ctx context.Context, keyHash string) (*tables.TableWorkspaceAPIKey, error) {
	return nil, nil
}
func (m *MockConfigStore) GetWorkspaceAPIKeyByID(ctx context.Context, id string) (*tables.TableWorkspaceAPIKey, error) {
	return nil, nil
}
func (m *MockConfigStore) ListWorkspaceAPIKeys(ctx context.Context, workspaceID string) ([]tables.TableWorkspaceAPIKey, error) {
	return nil, nil
}
func (m *MockConfigStore) RevokeWorkspaceAPIKey(ctx context.Context, id string) error { return nil }
func (m *MockConfigStore) TouchWorkspaceAPIKeyLastUsed(ctx context.Context, id string, at time.Time) error {
	return nil
}
...
func (m *MockConfigStore) CountUsers(ctx context.Context) (int64, error) {
	return int64(len(m.users)), nil
}

func (m *MockConfigStore) GetUserByID(ctx context.Context, id string) (*tables.TableAuthUser, error) {
	return m.userIDs[id], nil
}

func (m *MockConfigStore) GetUserByEmail(ctx context.Context, email string) (*tables.TableAuthUser, error) {
	return m.users[strings.ToLower(strings.TrimSpace(email))], nil
}

func (m *MockConfigStore) GetUserByPendingEmail(ctx context.Context, email string) (*tables.TableAuthUser, error) {
	normalizedEmail := strings.ToLower(strings.TrimSpace(email))
	for _, user := range m.users {
		if user.PendingEmail != nil && strings.EqualFold(strings.TrimSpace(*user.PendingEmail), normalizedEmail) {
			return user, nil
		}
	}
	return nil, nil
...
func (m *MockConfigStore) GetUserByGoogleSubject(ctx context.Context, subject string) (*tables.TableAuthUser, error) {
	for _, user := range m.users {
		if user.GoogleSubject != nil && *user.GoogleSubject == subject {
			return user, nil
		}
	}
	return nil, nil
...
func (m *MockConfigStore) GetUserByEntraIdentityKey(ctx context.Context, identityKey string) (*tables.TableAuthUser, error) {
	for _, user := range m.users {
		if user.EntraIdentityKey != nil && *user.EntraIdentityKey == strings.TrimSpace(identityKey) {
			return user, nil
		}
	}
	return nil, nil
...
func (m *MockConfigStore) GetUsersPaginated(ctx context.Context, params configstore.UsersQueryParams) ([]tables.TableAuthUser, int64, error) {
	users := make([]tables.TableAuthUser, 0, len(m.userIDs))
	for _, user := range m.userIDs {
		users = append(users, *user)
	}
	return users, int64(len(users)), nil
}

func (m *MockConfigStore) CreateUser(ctx context.Context, user *tables.TableAuthUser) error {
	for email, existingUser := range m.users {
		if existingUser.ID == user.ID {
			delete(m.users, email)
		}
	}
	m.users[strings.ToLower(strings.TrimSpace(user.Email))] = user
	m.userIDs[user.ID] = user
	return nil
}

func (m *MockConfigStore) UpdateUser(ctx context.Context, user *tables.TableAuthUser) error {
	for email, existingUser := range m.users {
		if existingUser.ID == user.ID {
			delete(m.users, email)
		}
...
func (m *MockConfigStore) DeleteUser(ctx context.Context, userID string) error {
	if user, ok := m.userIDs[userID]; ok && user != nil {
		delete(m.users, strings.ToLower(strings.TrimSpace(user.Email)))
		delete(m.userIDs, userID)
	}
	return nil
}

func (m *MockConfigStore) CreateEmailVerificationToken(ctx context.Context, token *tables.TableEmailVerificationToken) error {
	m.verificationTokens[token.TokenHash] = token
	return nil
}

func (m *MockConfigStore) GetEmailVerificationTokenByHash(ctx context.Context, tokenHash string) (*tables.TableEmailVerificationToken, error) {
	return m.verificationTokens[tokenHash], nil
}

func (m *MockConfigStore) MarkEmailVerificationTokenUsed(ctx context.Context, id string, usedAt time.Time) error {
	for _, token := range m.verificationTokens {
		if token.ID == id {
			token.UsedAt = &usedAt
...
func (m *MockConfigStore) DeleteEmailVerificationTokensForUser(ctx context.Context, userID string) error {
	for tokenHash, token := range m.verificationTokens {
		if token.UserID == userID {
			delete(m.verificationTokens, tokenHash)
		}
	}
	return nil
}

func (m *MockConfigStore) GetUserInvitationByID(ctx context.Context, id string) (*tables.TableUserInvitation, error) {
	return m.userInvitations[id], nil
}

func (m *MockConfigStore) GetUserInvitationByEmail(ctx context.Context, email string) (*tables.TableUserInvitation, error) {
	normalizedEmail := strings.ToLower(strings.TrimSpace(email))
	for _, invitation := range m.userInvitations {
		if invitation != nil && strings.EqualFold(strings.TrimSpace(invitation.Email), normalizedEmail) {
...
func (m *MockConfigStore) GetUserInvitationByHash(ctx context.Context, tokenHash string) (*tables.TableUserInvitation, error) {
	for _, invitation := range m.userInvitations {
		if invitation != nil && invitation.TokenHash == tokenHash {
			return invitation, nil
		}
	}
	return nil, nil
...
func (m *MockConfigStore) GetUserInvitations(ctx context.Context, params configstore.UsersQueryParams) ([]tables.TableUserInvitation, int64, error) {
	invitations := make([]tables.TableUserInvitation, 0, len(m.userInvitations))
	for _, invitation := range m.userInvitations {
		if invitation != nil {
			invitations = append(invitations, *invitation)
		}
	}
	return invitations, int64(len(invitations)), nil
}

func (m *MockConfigStore) UpdateUserInvitation(ctx context.Context, invitation *tables.TableUserInvitation) error {
	m.userInvitations[invitation.ID] = invitation
	return nil
}

func (m *MockConfigStore) DeleteUserInvitation(ctx context.Context, invitationID string) error {
	delete(m.userInvitations, invitationID)
	return nil
}

func (m *MockConfigStore) CreateLegalConsent(ctx context.Context, consent *tables.TableLegalConsent) error {
	return nil
}

func (m *MockConfigStore) GetLegalConsentsForUser(ctx context.Context, userID string) ([]tables.TableLegalConsent, error) {
	return nil, nil
}

func (m *MockConfigStore) ListLegalConsents(ctx context.Context, params configstore.LegalConsentQuery) ([]tables.TableLegalConsent, int64, error) {
	return nil, 0, nil
}
...
func (m *MockConfigStore) GetSCIMProviderConfig(ctx context.Context, provider string) (*tables.TableSCIMProviderConfig, error) {
	if m.scimProviderConfig != nil && strings.EqualFold(m.scimProviderConfig.Provider, provider) {
		return m.scimProviderConfig, nil
	}
	for _, config := range m.scimProviderConfigs {
...
func (m *MockConfigStore) GetSCIMProviderConfigByID(ctx context.Context, id string) (*tables.TableSCIMProviderConfig, error) {
	if config, ok := m.scimProviderConfigs[strings.TrimSpace(id)]; ok {
		return config, nil
	}
	if m.scimProviderConfig != nil && m.scimProviderConfig.ID == strings.TrimSpace(id) {
		return m.scimProviderConfig, nil
	}
	return nil, nil
}

func (m *MockConfigStore) ListSCIMProviderConfigs(ctx context.Context, provider string) ([]tables.TableSCIMProviderConfig, error) {
	var configs []tables.TableSCIMProviderConfig
	for _, config := range m.scimProviderConfigs {
		if provider == "" || strings.EqualFold(config.Provider, provider) {
			configs = append(configs, *config)
		}
	}
	if len(configs) == 0 && m.scimProviderConfig != nil && (provider == "" || strings.EqualFold(m.scimProviderConfig.Provider, provider)) {
		configs = append(configs, *m.scimProviderConfig)
	}
	return configs, nil
}

func (m *MockConfigStore) CreateSCIMProviderConfig(ctx context.Context, config *tables.TableSCIMProviderConfig) error {
	if config == nil {
		return nil
	}
	copy := *config
	m.scimProviderConfig = &copy
	m.scimProviderConfigs[copy.ID] = &copy
	return nil
}

func (m *MockConfigStore) UpsertSCIMProviderConfig(ctx context.Context, config *tables.TableSCIMProviderConfig) error {
	if config == nil {
		m.scimProviderConfig = nil
		return nil
	}
	copy := *config
	m.scimProviderConfig = &copy
...
func (m *MockConfigStore) UpdateSCIMProviderConfig(ctx context.Context, config *tables.TableSCIMProviderConfig) error {
	return m.UpsertSCIMProviderConfig(ctx, config)
}

func (m *MockConfigStore) DeleteSCIMProviderConfig(ctx context.Context, id string) error {
	delete(m.scimProviderConfigs, strings.TrimSpace(id))
	if m.scimProviderConfig != nil && m.scimProviderConfig.ID == strings.TrimSpace(id) {
		m.scimProviderConfig = nil
	}
	return nil
...
func (m *MockConfigStore) ResolveSCIMProviderConfig(ctx context.Context, provider, connectionID, email string) (*tables.TableSCIMProviderConfig, error) {
	if strings.TrimSpace(connectionID) != "" {
		return m.GetSCIMProviderConfigByID(ctx, connectionID)
	}
	return m.GetSCIMProviderConfig(ctx, provider)
}

func (m *MockConfigStore) CreateSCIMLoginState(ctx context.Context, state *tables.TableSCIMLoginState) error {
	if state == nil {
		return nil
	}
	copy := *state
	m.scimLoginStates[copy.State] = &copy
	return nil
}

func (m *MockConfigStore) GetSCIMLoginStateByState(ctx context.Context, state string) (*tables.TableSCIMLoginState, error) {
	if record, ok := m.scimLoginStates[strings.TrimSpace(state)]; ok {
		return record, nil
	}
	return nil, nil
}

func (m *MockConfigStore) DeleteSCIMLoginState(ctx context.Context, id string) error {
	for state, record := range m.scimLoginStates {
		if record.ID == strings.TrimSpace(id) {
			delete(m.scimLoginStates, state)
		}
	}
	return nil
}

// SCIM 2.0 bearer-token authentication + cross-provider SSO identity
// lookup (Phase C/D of SSO_IMPLEMENTATION_PLAN.md). The mocks are
// stubs - tests that exercise these paths construct the right state
// directly; the interface methods exist so MockConfigStore continues
// to satisfy the ConfigStore interface.

func (m *MockConfigStore) GetSCIMConnectionByBearerHash(ctx context.Context, bearerHash string) (*tables.TableSCIMProviderConfig, error) {
	return nil, nil
}

func (m *MockConfigStore) GetUserBySSOIdentityKey(ctx context.Context, identityKey string) (*tables.TableAuthUser, error) {
	return nil, nil
}

// SAML provider config CRUD - stubs paralleling the SCIM mock methods.

func (m *MockConfigStore) GetSAMLProviderConfigByID(ctx context.Context, id string) (*tables.TableSAMLProviderConfig, error) {
	return nil, nil
}

func (m *MockConfigStore) ListSAMLProviderConfigs(ctx context.Context) ([]tables.TableSAMLProviderConfig, error) {
	return nil, nil
}

func (m *MockConfigStore) CreateSAMLProviderConfig(ctx context.Context, config *tables.TableSAMLProviderConfig) error {
	return nil
}

func (m *MockConfigStore) UpdateSAMLProviderConfig(ctx context.Context, config *tables.TableSAMLProviderConfig) error {
	return nil
}

func (m *MockConfigStore) DeleteSAMLProviderConfig(ctx context.Context, id string) error {
	return nil
}

func (m *MockConfigStore) ResolveSAMLProviderConfig(ctx context.Context, connectionID, email string) (*tables.TableSAMLProviderConfig, error) {
	return nil, nil
}
...
func (m *MockConfigStore) GetPluginsForRuntimeBootstrap(ctx context.Context) ([]*tables.TablePlugin, error) {
	return m.plugins, nil
}

func (m *MockConfigStore) GetAllPluginsForRuntimeBootstrap(ctx context.Context) ([]*tables.TablePlugin, error) {
	return m.plugins, nil
}
...
func (m *MockConfigStore) UpdateSessionsEmailByUserID(ctx context.Context, userID, email string) error {
	normalizedEmail := strings.ToLower(strings.TrimSpace(email))
...
func (m *MockConfigStore) DeleteSessionsByUserID(ctx context.Context, userID string) error {
...
func (m *MockConfigStore) GetPromptsScoped(ctx context.Context, folderID *string, workspaceID string) ([]tables.TablePrompt, error) {
	return nil, nil
}
...
func (m *MockConfigStore) ListGuardrailProviders(ctx context.Context) ([]tables.TableGuardrailProvider, error) {
	return nil, nil
}
...
func (m *MockConfigStore) CreateGuardrailProvider(ctx context.Context, provider *tables.TableGuardrailProvider) error {
	return nil
}

func (m *MockConfigStore) UpdateGuardrailProvider(ctx context.Context, provider *tables.TableGuardrailProvider) error {
	return nil
}

func (m *MockConfigStore) DeleteGuardrailProvider(ctx context.Context, id string) error { return nil }

func (m *MockConfigStore) ListGuardrailPolicies(ctx context.Context) ([]tables.TableGuardrailPolicy, error) {
	return nil, nil
}

func (m *MockConfigStore) GetGuardrailPolicy(ctx context.Context, id string) (*tables.TableGuardrailPolicy, error) {
	return nil, configstore.ErrNotFound
}

func (m *MockConfigStore) CreateGuardrailPolicy(ctx context.Context, policy *tables.TableGuardrailPolicy) error {
	return nil
}

func (m *MockConfigStore) UpdateGuardrailPolicy(ctx context.Context, policy *tables.TableGuardrailPolicy) error {
	return nil
}

func (m *MockConfigStore) SetDefaultGuardrailPolicy(ctx context.Context, id string) error {
	return nil
}

func (m *MockConfigStore) DeleteGuardrailPolicy(ctx context.Context, id string) error { return nil }

func (m *MockConfigStore) ListGuardrailPolicyVersions(ctx context.Context, policyID string) ([]tables.TableGuardrailPolicyVersion, error) {
	return nil, nil
}

func (m *MockConfigStore) GetGuardrailPolicyVersion(ctx context.Context, id string) (*tables.TableGuardrailPolicyVersion, error) {
	return nil, configstore.ErrNotFound
}

func (m *MockConfigStore) CreateGuardrailPolicyVersion(ctx context.Context, version *tables.TableGuardrailPolicyVersion) error {
	return nil
}

func (m *MockConfigStore) UpdateGuardrailPolicyVersion(ctx context.Context, version *tables.TableGuardrailPolicyVersion) error {
	return nil
}

func (m *MockConfigStore) PublishGuardrailPolicyVersion(ctx context.Context, policyID, versionID, publishedBy string) error {
	return nil
}

func (m *MockConfigStore) ListGuardrailDomainPacks(ctx context.Context) ([]tables.TableGuardrailDomainPack, error) {
	return nil, nil
}

func (m *MockConfigStore) GetGuardrailDomainPack(ctx context.Context, id string) (*tables.TableGuardrailDomainPack, error) {
	return nil, configstore.ErrNotFound
}

func (m *MockConfigStore) CreateGuardrailDomainPack(ctx context.Context, pack *tables.TableGuardrailDomainPack) error {
	return nil
}

func (m *MockConfigStore) UpdateGuardrailDomainPack(ctx context.Context, pack *tables.TableGuardrailDomainPack) error {
	return nil
}

func (m *MockConfigStore) DeleteGuardrailDomainPack(ctx context.Context, id string) error { return nil }

func (m *MockConfigStore) ListGuardrailPolicyProviderBindings(ctx context.Context, policyID string) ([]tables.TableGuardrailPolicyProviderBinding, error) {
	return nil, nil
}

func (m *MockConfigStore) ReplaceGuardrailPolicyProviderBindings(ctx context.Context, policyID string, bindings []tables.TableGuardrailPolicyProviderBinding) error {
	return nil
}

func (m *MockConfigStore) ListGuardrailMCPToolPolicies(ctx context.Context, policyID string) ([]tables.TableGuardrailMCPToolPolicy, error) {
	return nil, nil
}

func (m *MockConfigStore) ReplaceGuardrailMCPToolPolicies(ctx context.Context, policyID string, policies []tables.TableGuardrailMCPToolPolicy) error {
	return nil
}

func (m *MockConfigStore) GetGuardrailRAGSettings(ctx context.Context) (*tables.TableGuardrailRAGSettings, error) {
	return nil, configstore.ErrNotFound
}

func (m *MockConfigStore) UpsertGuardrailRAGSettings(ctx context.Context, settings *tables.TableGuardrailRAGSettings) error {
	return nil
}

func (m *MockConfigStore) ListGuardrailRAGSources(ctx context.Context) ([]tables.TableGuardrailRAGSource, error) {
	return nil, nil
}

func (m *MockConfigStore) GetGuardrailRAGSource(ctx context.Context, id string) (*tables.TableGuardrailRAGSource, error) {
	return nil, configstore.ErrNotFound
}

func (m *MockConfigStore) CreateGuardrailRAGSource(ctx context.Context, source *tables.TableGuardrailRAGSource) error {
	return nil
}

func (m *MockConfigStore) UpdateGuardrailRAGSource(ctx context.Context, source *tables.TableGuardrailRAGSource) error {
	return nil
}
...
func createTempDir(t *testing.T) string {
	t.Helper()
	dir, err := os.MkdirTemp("", "deepintshield-test-*")
	if err != nil {
...
func makeEnvReferencedValue(envRef string) schemas.EnvVar {
...
// TestSQLite_Key_DashboardAddedKey_PreservedWhenFileProviderChanges verifies that
// dashboard-added keys survive a rebuild even when the file-backed provider config
// changes and triggers provider hash reconciliation.
func TestSQLite_Key_DashboardAddedKey_PreservedWhenFileProviderChanges(t *testing.T) {
	initTestLogger()
	tempDir := createTempDir(t)

	fileKeyID := uuid.NewString()
	providers := map[string]configstore.ProviderConfig{
		"openai": {
			Keys: []schemas.Key{
				{ID: fileKeyID, Name: "file-key", Value: *schemas.NewEnvVar("sk-file-123"), Weight: 1},
			},
			NetworkConfig: &schemas.NetworkConfig{BaseURL: "https://api.openai.com"},
		},
	}
	createConfigFile(t, tempDir, makeConfigDataWithProvidersAndDir(providers, tempDir))
	...
	dbProviders1[schemas.OpenAI] = openaiConfig
	if err := config1.ConfigStore.UpdateProvidersConfig(ctx, dbProviders1); err != nil {
		t.Fatalf("Failed to add dashboard key: %v", err)
	}
	config1.Close(ctx)

	updatedProviders := map[string]configstore.ProviderConfig{
		"openai": {
			Keys: []schemas.Key{
				{ID: fileKeyID, Name: "file-key", Value: *schemas.NewEnvVar("sk-file-123"), Weight: 1},
			},
			NetworkConfig: &schemas.NetworkConfig{BaseURL: "https://api.openai.com/v2"},
		},
	}
	createConfigFile(t, tempDir, makeConfigDataWithProvidersAndDir(updatedProviders, tempDir))
	...
	dbProviders2, _ := config2.ConfigStore.GetProvidersConfig(ctx)
	openaiConfig2 := dbProviders2[schemas.OpenAI]
	if len(openaiConfig2.Keys) != 2 {
		t.Fatalf("Expected 2 keys after file-backed provider update, got %d", len(openaiConfig2.Keys))
	}

	keyNames := make(map[string]bool)
	for _, key := range openaiConfig2.Keys {
		keyNames[key.Name] = true
	}
	if !keyNames["file-key"] {
		t.Error("Expected file-key to remain present")
	}
	if !keyNames["dashboard-key"] {
		t.Error("Expected dashboard-key to be preserved after provider hash change")
	}
	if openaiConfig2.NetworkConfig == nil || openaiConfig2.NetworkConfig.BaseURL != "https://api.openai.com/v2" {
		t.Fatalf("Expected updated provider config from file, got %+v", openaiConfig2.NetworkConfig)
	}
}

func TestSQLite_Key_UnresolvedEnvBackedFileKey_IsNotPersisted(t *testing.T) {
	initTestLogger()
	tempDir := createTempDir(t)
	...
	providers := map[string]configstore.ProviderConfig{
		"openai": {
			Keys: []schemas.Key{
				{ID: uuid.NewString(), Name: "OpenAI API Key", Value: makeEnvReferencedValue("env.OPENAI_API_KEY"), Weight: 1},
			},
		},
	}
	createConfigFile(t, tempDir, makeConfigDataWithProvidersAndDir(providers, tempDir))
	...
	dbProviders, err := config.ConfigStore.GetProvidersConfig(ctx)
	if err != nil {
		t.Fatalf("GetProvidersConfig failed: %v", err)
	}

	openAIConfig, exists := dbProviders[schemas.OpenAI]
	if !exists {
		t.Fatalf("Expected openai provider to exist")
	}
	if len(openAIConfig.Keys) != 0 {
		t.Fatalf("Expected unresolved env-backed file key to be skipped, got %d keys", len(openAIConfig.Keys))
	}
}

func TestSQLite_Key_UnresolvedEnvBackedFileKey_PrunesStaleBootstrapKey(t *testing.T) {
	initTestLogger()
	tempDir := createTempDir(t)
	t.Setenv("OPENAI_API_KEY", "sk-bootstrap-123")
	...
	dbProviders1, err := config1.ConfigStore.GetProvidersConfig(ctx)
	if err != nil {
		t.Fatalf("GetProvidersConfig after first load failed: %v", err)
	}
	openAIConfig1 := dbProviders1[schemas.OpenAI]
	openAIConfig1.Keys = append(openAIConfig1.Keys, schemas.Key{
		ID:     uuid.NewString(),
		Name:   "openai_key",
		Value:  *schemas.NewEnvVar("sk-dashboard-456"),
		Weight: 1,
	})
	dbProviders1[schemas.OpenAI] = openAIConfig1
	if err := config1.ConfigStore.UpdateProvidersConfig(ctx, dbProviders1); err != nil {
		t.Fatalf("Failed to add dashboard key: %v", err)
	}
	config1.Close(ctx)
	...
	dbProviders2, err := config2.ConfigStore.GetProvidersConfig(ctx)
	if err != nil {
		t.Fatalf("GetProvidersConfig after second load failed: %v", err)
	}

	openAIConfig2 := dbProviders2[schemas.OpenAI]
	if len(openAIConfig2.Keys) != 1 {
		t.Fatalf("Expected only the dashboard key to remain, got %d keys", len(openAIConfig2.Keys))
	}
	if openAIConfig2.Keys[0].Name != "openai_key" {
		t.Fatalf("Expected dashboard key to remain, got %s", openAIConfig2.Keys[0].Name)
	}
}
...
func (p *mockLLMPlugin) PreLLMHook(ctx *schemas.DeepIntShieldContext, req *schemas.DeepIntShieldRequest) (*schemas.DeepIntShieldRequest, *schemas.LLMPluginShortCircuit, error) {
	return req, nil, nil
}
func (p *mockLLMPlugin) PostLLMHook(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldResponse, deepintshieldErr *schemas.DeepIntShieldError) (*schemas.DeepIntShieldResponse, *schemas.DeepIntShieldError, error) {
...
func TestGenerateClientConfigHash_RuntimeVsMigrationParity(t *testing.T) {
	...
	t.Run("PrometheusLabels_GORMRoundTrip", func(t *testing.T) {
		...
		ccToSave := tables.TableClientConfig{
			TenantID:               "tenant-prometheus-labels",
			DropExcessRequests:     true,
			InitialPoolSize:        300,
	...
	t.Run("AllowedOrigins_GORMRoundTrip", func(t *testing.T) {
		...
		ccToSave := tables.TableClientConfig{
			TenantID:             "tenant-allowed-origins",
			DropExcessRequests:   true,
			InitialPoolSize:      300,
...
// TestGenerateKeyHash_UseForCacheField verifies that the UseForCache field affects hash generation.
// Different UseForCache values should produce different hashes while nil matches the default true behavior.
func TestGenerateKeyHash_UseForCacheField(t *testing.T) {
	cacheTrue := true
	cacheFalse := false
	...
	tests := []struct {
		...
		{
			name: "cache_true_vs_false_different_hash",
			key1: schemas.Key{
				Name:        "test-key",
				Value:       *schemas.NewEnvVar("sk-123"),
				Weight:      1,
				UseForCache: &cacheTrue,
			},
			key2: schemas.Key{
				Name:        "test-key",
				Value:       *schemas.NewEnvVar("sk-123"),
				Weight:      1,
				UseForCache: &cacheFalse,
			},
			expectEqual: false,
		},
		{
			name: "cache_nil_vs_false_different_hash",
			key1: schemas.Key{
				Name:        "test-key",
				Value:       *schemas.NewEnvVar("sk-123"),
				Weight:      1,
		...
		{
			name: "cache_nil_vs_true_same_hash",
			key1: schemas.Key{
				Name:        "test-key",
				Value:       *schemas.NewEnvVar("sk-123"),
				Weight:      1,
		...
		{
			name: "same_cache_false_same_hash",
			key1: schemas.Key{
				Name:        "test-key",
				Value:       *schemas.NewEnvVar("sk-123"),
				Weight:      1,
...
// TestSQLite_Key_UseForCacheChange_Detected verifies that changes to the UseForCache field
// are detected during config reconciliation and properly synced.
func TestSQLite_Key_UseForCacheChange_Detected(t *testing.T) {
	initTestLogger()
	tempDir := createTempDir(t)
	...
	openaiConfig1 := config1.Providers[schemas.OpenAI]
	if openaiConfig1.Keys[0].UseForCache == nil || !*openaiConfig1.Keys[0].UseForCache {
		t.Fatal("Expected UseForCache=true after first load")
	}
	...
	openaiConfig2 := config2.Providers[schemas.OpenAI]
	if openaiConfig2.Keys[0].UseForCache == nil || *openaiConfig2.Keys[0].UseForCache {
		t.Error("Expected UseForCache=false after second load, but got true or nil")
	}
}
...
var excludedGoFields = map[string]map[string]bool{
	...
	"tables.TableTeam": {
		...
		"virtual_keys":     true, // GORM relation
		"members":          true, // GORM relation
		"member_customers": true, // GORM relation
	},
	"tables.TableVirtualKey": {
		...
		"customer":           true, // GORM relation
		"guardrail_policies": true, // GORM relation
		// Agent VK attributes + rotation metadata - managed via the
		// governance / agentic-security API, not the static config file.
		"agent_capabilities":      true,
		"agent_namespace":         true,
		"agent_risk_level":        true,
		"agent_scopes":            true,
		"bound_identity_provider": true,
		"identity_provider_id":    true,
		"rotation_notice_days":    true,
		"rotation_notified_at":    true,
	},
	...
	"modelcatalog.Config": {
		// Pricing fallback knobs - not surfaced in config.schema.json (move to
		// the schema if they should be config-file settable).
		"pricing_fallback_url":             true,
		"pricing_stale_fallback_threshold": true,
	},
...
func TestRemoveProvider_SkipDBUpdate(t *testing.T) {
	...
	ctx := context.WithValue(context.Background(), schemas.DeepIntShieldContextKeySkipDBUpdate, true)
