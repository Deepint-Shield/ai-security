...
func IsDevMode() bool {
	return lib.GetenvCompat("DEEPINTSHIELD_UI_DEV", "DEEPINTSHIELD_UI_DEV") == "true"
}
...
func (h *DevPprofHandler) RegisterRoutes(r *router.Router, middlewares ...schemas.DeepIntShieldHTTPMiddleware) {
