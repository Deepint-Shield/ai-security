...
const (
	s3ContextKeyBucket  = schemas.DeepIntShieldContextKey("s3_bucket")
	s3ContextKeyPrefix  = schemas.DeepIntShieldContextKey("s3_prefix")
	s3ContextKeyMaxKeys = schemas.DeepIntShieldContextKey("s3_max_keys")
)
	...
	return RouteConfig{
		...
		RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
			if bedrockReq, ok := req.(*bedrock.BedrockConverseRequest); ok {
				deepintshieldReq, err := bedrockReq.ToDeepIntShieldResponsesRequest(ctx)
				if err != nil {
		...
		RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
			if invokeReq, ok := req.(*bedrock.BedrockInvokeRequest); ok {
				...
				if invokeReq.IsMessagesRequest() {
					...
					responsesReq, err := converseReq.ToDeepIntShieldResponsesRequest(ctx)
					if err != nil {
						return nil, fmt.Errorf("failed to convert invoke messages stream request: %w", err)
					}
					return &schemas.DeepIntShieldRequest{ResponsesRequest: responsesReq}, nil
				}
				// Prompt-based → Text Completion path (streaming)
				return &schemas.DeepIntShieldRequest{
					TextCompletionRequest: invokeReq.ToDeepIntShieldTextCompletionRequest(ctx),
				}, nil
			}
			return nil, errors.New("invalid request type")
		},
	...
	return RouteConfig{
		...
		RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
			if bedrockReq, ok := req.(*bedrock.BedrockRerankRequest); ok {
				return &schemas.DeepIntShieldRequest{
					RerankRequest: bedrockReq.ToDeepIntShieldRerankRequest(ctx),
				}, nil
			}
	...
	return RouteConfig{
		...
		RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
			if countTokensReq, ok := req.(*bedrock.BedrockCountTokensRequest); ok {
				...
				deepintshieldReq, err := countTokensReq.Input.Converse.ToDeepIntShieldResponsesRequest(ctx)
				if err != nil {
	...
	routes = append(routes, RouteConfig{
		...
		BatchRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*BatchRequest, error) {
			if bedrockReq, ok := req.(*bedrock.BedrockBatchJobRequest); ok {
				...
				// Convert Bedrock batch request to DeepIntShield format
				// For Bedrock: use S3 URIs directly
				// For other providers: S3 URIs are not applicable, use file_id from tags
				createReq := &schemas.DeepIntShieldBatchCreateRequest{
					Provider: provider,
		...
		PreCallback: func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
			...
			if provider != "" {
				...
				deepintshieldCtx.SetValue(deepintshieldContextKeyProvider, schemas.Bedrock)
			}
			return bedrockBatchPreCallback(handlerStore)(ctx, deepintshieldCtx, req)
		},
	})
	...
	routes = append(routes, RouteConfig{
		...
		BatchRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*BatchRequest, error) {
			if bedrockReq, ok := req.(*bedrock.BedrockBatchListRequest); ok {
				provider := ctx.Value(deepintshieldContextKeyProvider).(schemas.ModelProvider)
				deepintshieldReq := bedrock.ToDeepIntShieldBatchListRequest(bedrockReq, provider)
				return &BatchRequest{
					Type:        schemas.BatchListRequest,
					ListRequest: deepintshieldReq,
				}, nil
			}
		...
		PreCallback: func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
			...
			return extractBedrockBatchListQueryParams(handlerStore)(ctx, deepintshieldCtx, req)
		},
	})
	...
	routes = append(routes, RouteConfig{
		...
		BatchRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*BatchRequest, error) {
			if bedrockReq, ok := req.(*bedrock.BedrockBatchRetrieveRequest); ok {
				provider := ctx.Value(deepintshieldContextKeyProvider).(schemas.ModelProvider)
				deepintshieldReq := bedrock.ToDeepIntShieldBatchRetrieveRequest(bedrockReq, provider)
				return &BatchRequest{
					Type:            schemas.BatchRetrieveRequest,
					RetrieveRequest: deepintshieldReq,
				}, nil
			}
		...
		PreCallback: func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
			...
			return extractBedrockJobArnFromPath(handlerStore)(ctx, deepintshieldCtx, req)
		},
	})
	...
	routes = append(routes, RouteConfig{
		...
		BatchRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*BatchRequest, error) {
			if bedrockReq, ok := req.(*bedrock.BedrockBatchCancelRequest); ok {
				provider := ctx.Value(deepintshieldContextKeyProvider).(schemas.ModelProvider)
				deepintshieldReq := bedrock.ToDeepIntShieldBatchCancelRequest(bedrockReq, provider)
				return &BatchRequest{
					Type:          schemas.BatchCancelRequest,
					CancelRequest: deepintshieldReq,
				}, nil
			}
...
func bedrockBatchPreCallback(handlerStore lib.HandlerStore) func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
...
func extractBedrockBatchListQueryParams(handlerStore lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
		...
		if err := bedrockBatchPreCallback(handlerStore)(ctx, deepintshieldCtx, req); err != nil {
			return err
		}
...
func extractBedrockJobArnFromPath(handlerStore lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
		...
		if (*deepintshieldCtx).Value(deepintshieldContextKeyProvider).(schemas.ModelProvider) != schemas.Bedrock {
...
// NewBedrockRouter creates a new BedrockRouter with the given deepintshield client
func NewBedrockRouter(client *deepintshield.DeepIntShield, handlerStore lib.HandlerStore, logger schemas.Logger) *BedrockRouter {
...
// This allows boto3's S3 client to work directly against DeepIntShield using endpoint_url.
...
func createBedrockFilesRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	routes = append(routes, RouteConfig{
		...
		FileContentResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldFileContentResponse) (interface{}, error) {
			// Return raw content
	...
	routes = append(routes, RouteConfig{
		...
		PreCallback: func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
			...
			return extractS3BucketKeyFromPath(handlerStore, "retrieve")(ctx, deepintshieldCtx, req)
		},
	...
	routes = append(routes, RouteConfig{
		...
		PreCallback: func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
			...
			return extractS3BucketKeyFromPath(handlerStore, "delete")(ctx, deepintshieldCtx, req)
		},
	...
	routes = append(routes, RouteConfig{
		...
		FileListResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldFileListResponse) (interface{}, error) {
			...
			// Fallback: reconstruct XML from DeepIntShield response
			bucket := ""
			prefix := ""
			maxKeys := 1000
		...
		PreCallback: func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
			...
			return extractS3ListObjectsV2Params(handlerStore)(ctx, deepintshieldCtx, req)
		},
...
func extractS3ListObjectsV2Params(handlerStore lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
		...
		deepintshieldCtx.SetValue(s3ContextKeyBucket, bucketStr)
		deepintshieldCtx.SetValue(s3ContextKeyPrefix, prefix)
		deepintshieldCtx.SetValue(s3ContextKeyMaxKeys, maxKeys)
...
func s3PutObjectPostCallback(ctx *fasthttp.RequestCtx, req interface{}, resp interface{}) error {
	...
	ctx.Response.Header.Set("x-amz-request-id", "deepintshield")
	if uploadResp, ok := resp.(*schemas.DeepIntShieldFileUploadResponse); ok && uploadResp != nil {
...
func s3GetObjectPostCallback(ctx *fasthttp.RequestCtx, req interface{}, resp interface{}) error {
	if contentResp, ok := resp.(*schemas.DeepIntShieldFileContentResponse); ok && contentResp != nil {
...
func s3HeadObjectPostCallback(ctx *fasthttp.RequestCtx, req interface{}, resp interface{}) error {
	if retrieveResp, ok := resp.(*schemas.DeepIntShieldFileRetrieveResponse); ok && retrieveResp != nil {
...
func bedrockPreCallback(handlerStore lib.HandlerStore) func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
	return func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
