...
func normalizeOpenAICompatibleSDKRawResponse(raw interface{}) interface{} {
	var data []byte
	...
	fillMissingTierSensitiveUsageInts := hasTierSensitiveServiceTier(normalized)
	normalized = normalizeNullOrMissingUsageIntegerField(normalized, "usage.prompt_tokens_details.cached_tokens", fillMissingTierSensitiveUsageInts)
	normalized = normalizeNullUsageIntegerField(normalized, "usage.completion_tokens_details.audio_tokens")
	normalized = normalizeNullOrMissingUsageIntegerField(normalized, "usage.completion_tokens_details.reasoning_tokens", fillMissingTierSensitiveUsageInts)
	normalized = normalizeNullOrMissingUsageIntegerField(normalized, "usage.input_tokens_details.cached_tokens", fillMissingTierSensitiveUsageInts)
	normalized = normalizeNullUsageIntegerField(normalized, "usage.output_tokens_details.audio_tokens")
	normalized = normalizeNullOrMissingUsageIntegerField(normalized, "usage.output_tokens_details.reasoning_tokens", fillMissingTierSensitiveUsageInts)
	normalized = normalizeEmptyStringField(normalized, "service_tier")

	return json.RawMessage(normalized)
}

func normalizeNullUsageIntegerField(data []byte, path string) []byte {
	if providerUtils.GetJSONField(data, path).Raw != "null" {
		return data
	}
	normalized, err := providerUtils.SetJSONField(data, path, 0)
	if err != nil {
		return data
	}
	return normalized
...
func normalizeNullOrMissingUsageIntegerField(data []byte, path string, fillMissing bool) []byte {
	if strings.HasPrefix(path, "usage.") && !providerUtils.JSONFieldExists(data, "usage") {
		return data
	}

	field := providerUtils.GetJSONField(data, path)
	if field.Exists() && field.Raw != "null" {
		return data
	}
	if !field.Exists() && !fillMissing {
		return data
	}
...
func normalizeEmptyStringField(data []byte, path string) []byte {
	if providerUtils.GetJSONField(data, path).Raw != `""` {
		return data
	}
	normalized, err := providerUtils.DeleteJSONField(data, path)
	if err != nil {
		return data
	}
	return normalized
...
func hasTierSensitiveServiceTier(data []byte) bool {
	switch providerUtils.GetJSONField(data, "service_tier").String() {
	case "priority", "flex":
		return true
	default:
		return false
...
func hydrateOpenAIRequestFromLargePayloadMetadata(deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) {
...
func openAILargePayloadPreHook(_ *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
	hydrateOpenAIRequestFromLargePayloadMetadata(deepintshieldCtx, req)
	return nil
}

func AzureEndpointPreHook(handlerStore lib.HandlerStore) func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
	return func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
		hydrateOpenAIRequestFromLargePayloadMetadata(deepintshieldCtx, req)
		...
		case *schemas.DeepIntShieldListModelsRequest:
			if deploymentProviderStr != "" {
...
func CreateOpenAIRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	routes = append(routes, RouteConfig{
		...
		GetRequestTypeInstance: func(ctx context.Context) interface{} {
			if requestType, ok := ctx.Value(schemas.DeepIntShieldContextKeyHTTPRequestType).(schemas.RequestType); ok {
				switch requestType {
		...
		RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
			if openaiReq, ok := req.(*openai.OpenAIChatRequest); ok {
				return &schemas.DeepIntShieldRequest{
					ChatRequest: openaiReq.ToDeepIntShieldChatRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAITextCompletionRequest); ok {
				return &schemas.DeepIntShieldRequest{
					TextCompletionRequest: openaiReq.ToDeepIntShieldTextCompletionRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAIEmbeddingRequest); ok {
				return &schemas.DeepIntShieldRequest{
					EmbeddingRequest: openaiReq.ToDeepIntShieldEmbeddingRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAISpeechRequest); ok {
				return &schemas.DeepIntShieldRequest{
					SpeechRequest: openaiReq.ToDeepIntShieldSpeechRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAITranscriptionRequest); ok {
				return &schemas.DeepIntShieldRequest{
					TranscriptionRequest: openaiReq.ToDeepIntShieldTranscriptionRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAIImageGenerationRequest); ok {
				return &schemas.DeepIntShieldRequest{
					ImageGenerationRequest: openaiReq.ToDeepIntShieldImageGenerationRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAIImageEditRequest); ok {
				return &schemas.DeepIntShieldRequest{
					ImageEditRequest: openaiReq.ToDeepIntShieldImageEditRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAIImageVariationRequest); ok {
				return &schemas.DeepIntShieldRequest{
					ImageVariationRequest: openaiReq.ToDeepIntShieldImageVariationRequest(ctx),
				}, nil
			}
		...
		ChatResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldChatResponse) (interface{}, error) {
			if resp.ExtraFields.RawResponse != nil {
				return normalizeOpenAICompatibleSDKRawResponse(resp.ExtraFields.RawResponse), nil
			}
			return resp, nil
		},
		TextResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldTextCompletionResponse) (interface{}, error) {
			if resp.ExtraFields.RawResponse != nil {
				return normalizeOpenAICompatibleSDKRawResponse(resp.ExtraFields.RawResponse), nil
			}
			return resp, nil
		...
		SpeechResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldSpeechResponse) (interface{}, error) {
		...
		TranscriptionResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldTranscriptionResponse) (interface{}, error) {
			if resp.ExtraFields.Provider == schemas.OpenAI {
				if resp.ExtraFields.RawResponse != nil {
					return resp.ExtraFields.RawResponse, nil
				}
		...
		ImageGenerationResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldImageGenerationResponse) (interface{}, error) {
			if resp.ExtraFields.Provider == schemas.OpenAI {
				if resp.ExtraFields.RawResponse != nil {
					return resp.ExtraFields.RawResponse, nil
				}
		...
		StreamConfig: &StreamConfig{
			...
			TextStreamResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldTextCompletionResponse) (string, interface{}, error) {
				if resp.ExtraFields.RawResponse != nil {
					return "", normalizeOpenAICompatibleSDKRawResponse(resp.ExtraFields.RawResponse), nil
				}
				return "", resp, nil
			},
			SpeechStreamResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldSpeechStreamResponse) (string, interface{}, error) {
				if resp.ExtraFields.Provider == schemas.OpenAI {
					if resp.ExtraFields.RawResponse != nil {
						return "", resp.ExtraFields.RawResponse, nil
					}
			...
			TranscriptionStreamResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldTranscriptionStreamResponse) (string, interface{}, error) {
				if resp.ExtraFields.Provider == schemas.OpenAI {
					if resp.ExtraFields.RawResponse != nil {
						return "", resp.ExtraFields.RawResponse, nil
					}
			...
			ImageGenerationStreamResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldImageGenerationStreamResponse) (string, interface{}, error) {
				if resp.ExtraFields.Provider == schemas.OpenAI {
					if resp.ExtraFields.RawResponse != nil {
						return "", resp.ExtraFields.RawResponse, nil
					}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
				if openaiReq, ok := req.(*openai.OpenAIResponsesRequest); ok {
					return &schemas.DeepIntShieldRequest{
						ResponsesRequest: openaiReq.ToDeepIntShieldResponsesRequest(ctx),
					}, nil

				}
				return nil, errors.New("invalid request type")
			},
			ResponsesResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldResponsesResponse) (interface{}, error) {
				if resp.ExtraFields.RawResponse != nil {
					return normalizeOpenAICompatibleSDKRawResponse(resp.ExtraFields.RawResponse), nil
				}
				return resp.WithDefaults(), nil
			},
			AsyncResponsesResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.AsyncJobResponse, responsesResponseConverter ResponsesResponseConverter) (interface{}, map[string]string, error) {
				deepintshieldResponse := &schemas.DeepIntShieldResponsesResponse{
					ID:     &resp.ID,
					Status: deepintshield.Ptr(string(resp.Status)),
				}
				if resp.Status == schemas.AsyncJobStatusCompleted {
					responsesResp, ok := resp.Result.(*schemas.DeepIntShieldResponsesResponse)
					if !ok {
						return nil, nil, errors.New("invalid responses response type")
					}
					deepintshieldResponse = responsesResp
				}
				response, err := responsesResponseConverter(ctx, deepintshieldResponse)
				if err != nil {
					return nil, nil, err
				}
			...
			StreamConfig: &StreamConfig{
				ResponsesStreamResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldResponsesStreamResponse) (string, interface{}, error) {
					if resp.ExtraFields.RawResponse != nil {
						return string(resp.Type), normalizeOpenAICompatibleSDKRawResponse(resp.ExtraFields.RawResponse), nil
					}
			...
			PreCallback: func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
				hydrateOpenAIRequestFromLargePayloadMetadata(deepintshieldCtx, req)
				if isAzureSDKRequest(ctx) {
					deepintshieldCtx.SetValue(schemas.DeepIntShieldContextKeyIsAzureUserAgent, true)
				}
				return nil
			},
		})
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
				if openaiReq, ok := req.(*openai.OpenAIResponsesRequest); ok {
					return &schemas.DeepIntShieldRequest{
						CountTokensRequest: openaiReq.ToDeepIntShieldResponsesRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
				if embeddingReq, ok := req.(*openai.OpenAIEmbeddingRequest); ok {
					return &schemas.DeepIntShieldRequest{
						EmbeddingRequest: embeddingReq.ToDeepIntShieldEmbeddingRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
				if speechReq, ok := req.(*openai.OpenAISpeechRequest); ok {
					return &schemas.DeepIntShieldRequest{
						SpeechRequest: speechReq.ToDeepIntShieldSpeechRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
				if transcriptionReq, ok := req.(*openai.OpenAITranscriptionRequest); ok {
					return &schemas.DeepIntShieldRequest{
						TranscriptionRequest: transcriptionReq.ToDeepIntShieldTranscriptionRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
				if imageGenReq, ok := req.(*openai.OpenAIImageGenerationRequest); ok {
					return &schemas.DeepIntShieldRequest{
						ImageGenerationRequest: imageGenReq.ToDeepIntShieldImageGenerationRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
				if imageEditReq, ok := req.(*openai.OpenAIImageEditRequest); ok {
					return &schemas.DeepIntShieldRequest{
						ImageEditRequest: imageEditReq.ToDeepIntShieldImageEditRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
				if imageVariationReq, ok := req.(*openai.OpenAIImageVariationRequest); ok {
					return &schemas.DeepIntShieldRequest{
						ImageVariationRequest: imageVariationReq.ToDeepIntShieldImageVariationRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
				if videoGenerationReq, ok := req.(*openai.OpenAIVideoGenerationRequest); ok {
					return &schemas.DeepIntShieldRequest{
						VideoGenerationRequest: videoGenerationReq.ToDeepIntShieldVideoGenerationRequest(ctx),
					}, nil
				}
				return nil, errors.New("invalid video generation request type")
			},
			VideoGenerationResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldVideoGenerationResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.DeepIntShieldContext, err *schemas.DeepIntShieldError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldVideoRetrieveRequest{}
			},
			RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
				if videoRetrieveReq, ok := req.(*schemas.DeepIntShieldVideoRetrieveRequest); ok {
					return &schemas.DeepIntShieldRequest{
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldVideoDownloadRequest{}
			},
			RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
				if videoDownloadReq, ok := req.(*schemas.DeepIntShieldVideoDownloadRequest); ok {
					return &schemas.DeepIntShieldRequest{
			...
			VideoDownloadResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldVideoDownloadResponse) (interface{}, error) {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldVideoDeleteRequest{}
			},
			RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
				if videoDeleteReq, ok := req.(*schemas.DeepIntShieldVideoDeleteRequest); ok {
					return &schemas.DeepIntShieldRequest{
			...
			VideoDeleteResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldVideoDeleteResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.DeepIntShieldContext, err *schemas.DeepIntShieldError) interface{} {
				return err
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
				if videoRemixReq, ok := req.(*openai.OpenAIVideoRemixRequest); ok {
					return &schemas.DeepIntShieldRequest{
						VideoRemixRequest: openai.ToDeepIntShieldVideoRemixRequest(videoRemixReq),
					}, nil
				}
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldVideoListRequest{}
			},
			RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
				if videoListReq, ok := req.(*schemas.DeepIntShieldVideoListRequest); ok {
					return &schemas.DeepIntShieldRequest{
			...
			VideoListResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldVideoListResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.DeepIntShieldContext, err *schemas.DeepIntShieldError) interface{} {
				return err
...
func CreateOpenAIListModelsRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldListModelsRequest{}
			},
			RequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*schemas.DeepIntShieldRequest, error) {
				if listModelsReq, ok := req.(*schemas.DeepIntShieldListModelsRequest); ok {
					return &schemas.DeepIntShieldRequest{
			...
			ListModelsResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldListModelsResponse) (interface{}, error) {
...
func CreateOpenAIBatchRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldBatchCreateRequest{}
			},
			BatchRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*BatchRequest, error) {
				if openaiReq, ok := req.(*schemas.DeepIntShieldBatchCreateRequest); ok {
			...
			BatchCreateResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldBatchCreateResponse) (interface{}, error) {
			...
			PreCallback: func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
				...
				if createReq, ok := req.(*schemas.DeepIntShieldBatchCreateRequest); ok {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldBatchListRequest{}
			},
			BatchRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*BatchRequest, error) {
				if listReq, ok := req.(*schemas.DeepIntShieldBatchListRequest); ok {
					if listReq.Provider == "" {
			...
			BatchListResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldBatchListResponse) (interface{}, error) {
				switch resp.ExtraFields.Provider {
				case schemas.Gemini:
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldBatchRetrieveRequest{}
			},
			BatchRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*BatchRequest, error) {
				if retrieveReq, ok := req.(*schemas.DeepIntShieldBatchRetrieveRequest); ok {
			...
			BatchRetrieveResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldBatchRetrieveResponse) (interface{}, error) {
				switch resp.ExtraFields.Provider {
				case schemas.Gemini:
					resp.ID = strings.Replace(resp.ID, "batches/", "batches-", 1)
					resp.InputFileID = strings.Replace(resp.InputFileID, "files/", "files-", 1)
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldBatchCancelRequest{}
			},
			BatchRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*BatchRequest, error) {
				if cancelReq, ok := req.(*schemas.DeepIntShieldBatchCancelRequest); ok {
			...
			BatchCancelResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldBatchCancelResponse) (interface{}, error) {
				switch resp.ExtraFields.Provider {
				case schemas.Gemini:
					resp.ID = strings.Replace(resp.ID, "batches/", "batches-", 1)
				case schemas.Bedrock:
...
func CreateOpenAIFileRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldFileUploadRequest{}
			},
			RequestParser: parseOpenAIFileUploadMultipartRequest,
			FileRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*FileRequest, error) {
				if uploadReq, ok := req.(*schemas.DeepIntShieldFileUploadRequest); ok {
					return &FileRequest{
			...
			FileUploadResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldFileUploadResponse) (interface{}, error) {
			...
			PreCallback: func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
				...
				if deepintshieldReq, ok := req.(*schemas.DeepIntShieldFileUploadRequest); ok {
					if deepintshieldReq.Provider == "" {
						if isAzureSDKRequest(ctx) {
							deepintshieldReq.Provider = schemas.Azure
						} else {
							deepintshieldReq.Provider = schemas.OpenAI
						}
					}
				}
				return nil
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldFileListRequest{}
			},
			FileRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*FileRequest, error) {
				if listReq, ok := req.(*schemas.DeepIntShieldFileListRequest); ok {
					if listReq.Provider == "" {
						listReq.Provider = schemas.OpenAI
					}
					return &FileRequest{
			...
			FileListResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldFileListResponse) (interface{}, error) {
				if resp.ExtraFields.RawResponse != nil && resp.ExtraFields.Provider == schemas.OpenAI {
					return resp.ExtraFields.RawResponse, nil
				}
				switch resp.ExtraFields.Provider {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldFileRetrieveRequest{}
			},
			FileRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*FileRequest, error) {
				if retrieveReq, ok := req.(*schemas.DeepIntShieldFileRetrieveRequest); ok {
					if retrieveReq.Provider == "" {
						retrieveReq.Provider = schemas.OpenAI
					}
			...
			FileRetrieveResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldFileRetrieveResponse) (interface{}, error) {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldFileDeleteRequest{}
			},
			FileRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*FileRequest, error) {
				if deleteReq, ok := req.(*schemas.DeepIntShieldFileDeleteRequest); ok {
			...
			FileDeleteResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldFileDeleteResponse) (interface{}, error) {
				if resp.ExtraFields.RawResponse != nil && resp.ExtraFields.Provider == schemas.OpenAI {
					return resp.ExtraFields.RawResponse, nil
				}
				switch resp.ExtraFields.Provider {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldFileContentRequest{}
			},
			FileRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*FileRequest, error) {
				if contentReq, ok := req.(*schemas.DeepIntShieldFileContentRequest); ok {
...
func extractBatchIDFromPath(_ lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
		...
		switch r := req.(type) {
		case *schemas.DeepIntShieldBatchRetrieveRequest:
			r.BatchID = batchIDStr
			r.Provider = provider
		case *schemas.DeepIntShieldBatchCancelRequest:
			r.BatchID = batchIDStr
			// For POST cancel, provider comes from body, only set if empty
			if r.Provider == "" {
				r.Provider = provider
			}
		case *schemas.DeepIntShieldBatchResultsRequest:
			r.BatchID = batchIDStr
			r.Provider = provider
		}
...
func extractVideoIDFromPath(_ lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
		...
		switch r := req.(type) {
		case *schemas.DeepIntShieldVideoReferenceRequest:
			r.Provider = providerName
			r.ID = rawVideoID
		case *schemas.DeepIntShieldVideoDownloadRequest:
			r.Provider = providerName
			r.ID = rawVideoID
...
func extractFileIDFromPath(_ lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
		...
		switch r := req.(type) {
		case *schemas.DeepIntShieldFileRetrieveRequest:
			r.FileID = fileIDStr
			r.Provider = provider
			if storageConfig != nil {
				r.StorageConfig = storageConfig
			}
		case *schemas.DeepIntShieldFileDeleteRequest:
			r.FileID = fileIDStr
			r.Provider = provider
			if storageConfig != nil {
				r.StorageConfig = storageConfig
			}
		case *schemas.DeepIntShieldFileContentRequest:
			r.FileID = fileIDStr
			r.Provider = provider
			if storageConfig != nil {
				r.StorageConfig = storageConfig
...
func parseOpenAIFileUploadMultipartRequest(ctx *fasthttp.RequestCtx, req interface{}) error {
	uploadReq, ok := req.(*schemas.DeepIntShieldFileUploadRequest)
	if !ok {
...
func CreateOpenAIContainerRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldContainerCreateRequest{}
			},
			ContainerRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*ContainerRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if createReq, ok := req.(*schemas.DeepIntShieldContainerCreateRequest); ok {
			...
			ContainerCreateResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldContainerCreateResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.DeepIntShieldContext, err *schemas.DeepIntShieldError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldContainerListRequest{}
			},
			ContainerRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*ContainerRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if listReq, ok := req.(*schemas.DeepIntShieldContainerListRequest); ok {
					if listReq.Provider == "" {
						listReq.Provider = schemas.OpenAI
					}
					return &ContainerRequest{
			...
			ContainerListResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldContainerListResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.DeepIntShieldContext, err *schemas.DeepIntShieldError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldContainerRetrieveRequest{}
			},
			ContainerRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*ContainerRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if retrieveReq, ok := req.(*schemas.DeepIntShieldContainerRetrieveRequest); ok {
					if retrieveReq.Provider == "" {
						retrieveReq.Provider = schemas.OpenAI
					}
					return &ContainerRequest{
			...
			ContainerRetrieveResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldContainerRetrieveResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.DeepIntShieldContext, err *schemas.DeepIntShieldError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldContainerDeleteRequest{}
			},
			ContainerRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*ContainerRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if deleteReq, ok := req.(*schemas.DeepIntShieldContainerDeleteRequest); ok {
					if deleteReq.Provider == "" {
						deleteReq.Provider = schemas.OpenAI
					}
					return &ContainerRequest{
			...
			ContainerDeleteResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldContainerDeleteResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.DeepIntShieldContext, err *schemas.DeepIntShieldError) interface{} {
				return err
...
func extractContainerIDFromPath(_ lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
		...
		switch r := req.(type) {
		case *schemas.DeepIntShieldContainerRetrieveRequest:
			r.ContainerID = containerIDStr
			r.Provider = provider
		case *schemas.DeepIntShieldContainerDeleteRequest:
			r.ContainerID = containerIDStr
			r.Provider = provider
		}
...
func CreateOpenAIContainerFileRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldContainerFileCreateRequest{}
			},
			RequestParser: parseContainerFileCreateMultipartRequest,
			ContainerFileRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*ContainerFileRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if createReq, ok := req.(*schemas.DeepIntShieldContainerFileCreateRequest); ok {
			...
			ContainerFileCreateResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldContainerFileCreateResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.DeepIntShieldContext, err *schemas.DeepIntShieldError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldContainerFileListRequest{}
			},
			ContainerFileRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*ContainerFileRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if listReq, ok := req.(*schemas.DeepIntShieldContainerFileListRequest); ok {
					return &ContainerFileRequest{
			...
			ContainerFileListResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldContainerFileListResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.DeepIntShieldContext, err *schemas.DeepIntShieldError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldContainerFileRetrieveRequest{}
			},
			ContainerFileRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*ContainerFileRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if retrieveReq, ok := req.(*schemas.DeepIntShieldContainerFileRetrieveRequest); ok {
					return &ContainerFileRequest{
			...
			ContainerFileRetrieveResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldContainerFileRetrieveResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.DeepIntShieldContext, err *schemas.DeepIntShieldError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldContainerFileContentRequest{}
			},
			ContainerFileRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*ContainerFileRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if contentReq, ok := req.(*schemas.DeepIntShieldContainerFileContentRequest); ok {
					return &ContainerFileRequest{
			...
			ContainerFileContentResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldContainerFileContentResponse) (interface{}, error) {
				return resp.Content, nil
			},
			ErrorConverter: func(ctx *schemas.DeepIntShieldContext, err *schemas.DeepIntShieldError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.DeepIntShieldContainerFileDeleteRequest{}
			},
			ContainerFileRequestConverter: func(ctx *schemas.DeepIntShieldContext, req interface{}) (*ContainerFileRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if deleteReq, ok := req.(*schemas.DeepIntShieldContainerFileDeleteRequest); ok {
					return &ContainerFileRequest{
			...
			ContainerFileDeleteResponseConverter: func(ctx *schemas.DeepIntShieldContext, resp *schemas.DeepIntShieldContainerFileDeleteResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.DeepIntShieldContext, err *schemas.DeepIntShieldError) interface{} {
				return err
...
func extractContainerAndFileIDFromPath(handlerStore lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, deepintshieldCtx *schemas.DeepIntShieldContext, req interface{}) error {
		...
		switch r := req.(type) {
		case *schemas.DeepIntShieldContainerFileRetrieveRequest:
			r.ContainerID = containerIDStr
			r.FileID = fileIDStr
			r.Provider = provider
		case *schemas.DeepIntShieldContainerFileContentRequest:
			r.ContainerID = containerIDStr
			r.FileID = fileIDStr
			r.Provider = provider
		case *schemas.DeepIntShieldContainerFileDeleteRequest:
			r.ContainerID = containerIDStr
			r.FileID = fileIDStr
			r.Provider = provider
		}
...
// NewOpenAIRouter creates a new OpenAIRouter with the given deepintshield client.
func NewOpenAIRouter(client *deepintshield.DeepIntShield, handlerStore lib.HandlerStore, logger schemas.Logger) *OpenAIRouter {
...
func parseContainerFileCreateMultipartRequest(ctx *fasthttp.RequestCtx, req interface{}) error {
	createReq, ok := req.(*schemas.DeepIntShieldContainerFileCreateRequest)
	if !ok {
