...
// NewLangChainRouter creates a new LangChainRouter with the given deepintshield client.
func NewLangChainRouter(client *deepintshield.DeepIntShield, handlerStore lib.HandlerStore, logger schemas.Logger) *LangChainRouter {
	routes := []RouteConfig{}
