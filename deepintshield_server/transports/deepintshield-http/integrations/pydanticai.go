...
// NewPydanticAIRouter creates a new PydanticAIRouter with the given deepintshield client.
func NewPydanticAIRouter(client *deepintshield.DeepIntShield, handlerStore lib.HandlerStore, logger schemas.Logger) *PydanticAIRouter {
	routes := []RouteConfig{}
