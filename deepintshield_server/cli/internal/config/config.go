...
const (
	defaultDirName  = ".deepintshield"
	defaultFileName = "config.json"
	stateFileName   = "state.json"
)

// FileConfig represents the on-disk deepintshield configuration file (~/.deepintshield/config.json).
...
// Profile represents a named DeepIntShield connection profile with a base URL.
type Profile struct {
	ID      string `json:"id"`
...
// DefaultConfigPath returns the default path to the deepintshield config file (~/.deepintshield/config.json).
...
// DefaultStatePath returns the default path to the deepintshield state file (~/.deepintshield/state.json).
