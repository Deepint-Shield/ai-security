...
import (
	...
	"github.com/deepint-shield/ai-security/cli/internal/config"
	"github.com/deepint-shield/ai-security/cli/internal/harness"
	"github.com/deepint-shield/ai-security/cli/internal/installer"
	"github.com/deepint-shield/ai-security/cli/internal/mcp"
	"github.com/deepint-shield/ai-security/cli/internal/runtime"
	"github.com/deepint-shield/ai-security/cli/internal/secrets"
	"github.com/deepint-shield/ai-security/cli/internal/ui/logo"
	"github.com/deepint-shield/ai-security/cli/internal/ui/tui"
	"github.com/deepint-shield/ai-security/cli/internal/update"
	"golang.org/x/term"
)
...
// App is the main DeepIntShield CLI application. It manages configuration, state,
...
func (a *App) Run(ctx context.Context) error {
	...
	if errors.Is(err, runtime.ErrUpdateRequested) {
		...
		if err != nil {
			fmt.Fprintf(a.out, "Updated successfully. Please restart deepintshield.\n")
			return nil
		}
...
// getOrCreateProfile fetches or creates a new DeepIntShield CLI profile
