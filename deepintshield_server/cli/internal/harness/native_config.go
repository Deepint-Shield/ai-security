...
// launched inside DeepIntShield's tab multiplexer. This avoids Claude-specific
...
// claudeWriteNativeConfig writes the deepintshield endpoint, API key, and model
