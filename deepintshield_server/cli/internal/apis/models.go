...
// NewClient creates a DeepIntShield API client with a default HTTP timeout.
...
// ListModels fetches available model IDs from the DeepIntShield /v1/models endpoint,
