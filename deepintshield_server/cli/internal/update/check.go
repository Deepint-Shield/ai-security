...
const (
	baseURL        = "https://github.com/deepint-shield/ai-security/releases/download"
	versionURL     = baseURL + "/deepintshield-cli/latest/version.txt"
...
func doCheck(currentVersion, statePath string) *CheckResult {
	...
	if envSet("DEEPINTSHIELD_NO_UPDATE_CHECK") {
		return nil
	}
